...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.95.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.95.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TW2YvcSJkc8gnMI4nYVTstFcF42i4x5VlJ42Ycdtnu0iO5I+V9o9MGSb5bujm1Ro
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.95.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.95.0/index.min.mjs": "sha384-TW2YvcSJkc8gnMI4nYVTstFcF42i4x5VlJ42Ycdtnu0iO5I+V9o9MGSb5bujm1Ro"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.95.0/LICENSE
```
