...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.478.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.478.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c7SmRQkEzIXTMfw7+tYRzg4oGjqVsS3WZAivvHMdcCrv8UpQuwUwjtDHYm6SlwxK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.478.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.478.0/index.min.mjs": "sha384-c7SmRQkEzIXTMfw7+tYRzg4oGjqVsS3WZAivvHMdcCrv8UpQuwUwjtDHYm6SlwxK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.478.0/LICENSE
```
