...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.918.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.918.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TwQOei0OUjgIL+o/dFah9yBqt+OSr9FyYqDJ1V/EN4dqA2bdSe4M6NK6NDnTD4oD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.918.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.918.0/index.min.mjs": "sha384-TwQOei0OUjgIL+o/dFah9yBqt+OSr9FyYqDJ1V/EN4dqA2bdSe4M6NK6NDnTD4oD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.918.0/LICENSE
```
