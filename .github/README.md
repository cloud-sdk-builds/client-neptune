...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.310.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.310.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yEqXG/RdALwW8xxqa8fTAfNqWp2+egqTP3qYWH2lEubYW0OzQpgSgd1N3AL4rM8l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.310.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.310.0/index.min.mjs": "sha384-yEqXG/RdALwW8xxqa8fTAfNqWp2+egqTP3qYWH2lEubYW0OzQpgSgd1N3AL4rM8l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.310.0/LICENSE
```
