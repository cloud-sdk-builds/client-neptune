...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.162.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.162.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fbRvfgqm3BBWJHfgJXDvlfKI2mCUUeOmKZQhmY1UG9FFV4Nj9GBIr2infPjBsFkU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.162.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.162.0/index.min.mjs": "sha384-fbRvfgqm3BBWJHfgJXDvlfKI2mCUUeOmKZQhmY1UG9FFV4Nj9GBIr2infPjBsFkU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.162.0/LICENSE
```
