...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.295.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.295.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tQ5XemUmYdVuKcLhmG6eg16FUhZWs7kmisgD+n1scP0GiPXeiUtPFrTJWq6KYqeH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.295.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.295.0/index.min.mjs": "sha384-tQ5XemUmYdVuKcLhmG6eg16FUhZWs7kmisgD+n1scP0GiPXeiUtPFrTJWq6KYqeH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.295.0/LICENSE
```
