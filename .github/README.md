...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.569.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.569.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3Yj0phjLGbKCB8dBeaM53cvchyIk9iApzdGf44gG8SFuuIiipzSGhJIyzU+A74dl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.569.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.569.0/index.min.mjs": "sha384-3Yj0phjLGbKCB8dBeaM53cvchyIk9iApzdGf44gG8SFuuIiipzSGhJIyzU+A74dl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.569.0/LICENSE
```
