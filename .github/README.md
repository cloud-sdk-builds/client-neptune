...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.238.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.238.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OKxTqFH2mKdh2tsmU5SynpO3NbyXDRcTeouWzbM/nsR+fKt+n6mBA3NQfrVwTFSf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.238.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.238.0/index.min.mjs": "sha384-OKxTqFH2mKdh2tsmU5SynpO3NbyXDRcTeouWzbM/nsR+fKt+n6mBA3NQfrVwTFSf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.238.0/LICENSE
```
