...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.477.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.477.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yQeaHePG2LQvtr9owAcd1NjISFDkDSZfxf8sCyzYScleS7Ca0xkFoizUeib7GbWM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.477.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.477.0/index.min.mjs": "sha384-yQeaHePG2LQvtr9owAcd1NjISFDkDSZfxf8sCyzYScleS7Ca0xkFoizUeib7GbWM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.477.0/LICENSE
```
