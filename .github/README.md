...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.620.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.620.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-kZ7h5xtkSoV0vujK2rw7rdVDxlciC+rkFckmrMzldHxdXKpWcbB2PW2FXY/bZRWV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.620.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.620.1/index.min.mjs": "sha384-kZ7h5xtkSoV0vujK2rw7rdVDxlciC+rkFckmrMzldHxdXKpWcbB2PW2FXY/bZRWV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.620.1/LICENSE
```
