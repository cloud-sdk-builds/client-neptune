...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.678.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.678.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SlvFYUp9w7PM8r3MvBSRuou8zhaii4UTuuCDeJ3Sb+9PtF5B49SNiMTBVai1jdez
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.678.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.678.0/index.min.mjs": "sha384-SlvFYUp9w7PM8r3MvBSRuou8zhaii4UTuuCDeJ3Sb+9PtF5B49SNiMTBVai1jdez"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.678.0/LICENSE
```
