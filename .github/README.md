...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.521.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.521.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-or7no6V2RriateDtwvKIXQkvpp0Eiv4791uytzr1EPpO9S7JVhM5+NbsZHK3bfdt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.521.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.521.0/index.min.mjs": "sha384-or7no6V2RriateDtwvKIXQkvpp0Eiv4791uytzr1EPpO9S7JVhM5+NbsZHK3bfdt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.521.0/LICENSE
```
