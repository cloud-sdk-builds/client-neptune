...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.154.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.154.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UKeZK7j0XWPLqTUh2kY+TDwtbK4stympUk+Tj9Vc6S/jhlU8ftcgEHSom3WsUoLf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.154.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.154.0/index.min.mjs": "sha384-UKeZK7j0XWPLqTUh2kY+TDwtbK4stympUk+Tj9Vc6S/jhlU8ftcgEHSom3WsUoLf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.154.0/LICENSE
```
