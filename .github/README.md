...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.840.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.840.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rxKVkNU19JtHYQMnRtbLzC8Q+E9jiYC1S/kL9tLtRWDQ7/6aL8/I3dtga2isGBAO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.840.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.840.0/index.min.mjs": "sha384-rxKVkNU19JtHYQMnRtbLzC8Q+E9jiYC1S/kL9tLtRWDQ7/6aL8/I3dtga2isGBAO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.840.0/LICENSE
```
