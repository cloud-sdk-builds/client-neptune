...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BSHcDhpv7JK2mM2ROsPIyEt68zutIxjspTJB08ZN/mVGiuNJH1Gkg50wpOwZjduu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.948.0/index.min.mjs": "sha384-BSHcDhpv7JK2mM2ROsPIyEt68zutIxjspTJB08ZN/mVGiuNJH1Gkg50wpOwZjduu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.948.0/LICENSE
```
