...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.699.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.699.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d1kQAIfDEKum5FgeszAIzZbAC2wesxyRkr0EB8Ncxt6FE5+Y2VRtCvHpw/Gvepm8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.699.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.699.0/index.min.mjs": "sha384-d1kQAIfDEKum5FgeszAIzZbAC2wesxyRkr0EB8Ncxt6FE5+Y2VRtCvHpw/Gvepm8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.699.0/LICENSE
```
