...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.32.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.32.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XvhiwMCIdg1Na63HS+QCOGqRkvrk5n+12+ouTu13rvk+1N6myr/ybuLfb96PFkKb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.32.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.32.0/index.min.mjs": "sha384-XvhiwMCIdg1Na63HS+QCOGqRkvrk5n+12+ouTu13rvk+1N6myr/ybuLfb96PFkKb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.32.0/LICENSE
```
