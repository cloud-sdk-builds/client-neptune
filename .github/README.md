...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.332.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.332.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YpyaA/etEafPSjlYBbWaPSre9ZvS5U50JhRUIlPAwwf1YRh5s8v8RB7pC/g9xLdB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.332.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.332.0/index.min.mjs": "sha384-YpyaA/etEafPSjlYBbWaPSre9ZvS5U50JhRUIlPAwwf1YRh5s8v8RB7pC/g9xLdB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.332.0/LICENSE
```
