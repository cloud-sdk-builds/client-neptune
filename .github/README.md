...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.461.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.461.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nK54pQvLKiaq1iiUNMb/EzaCfMnSDPRC200dlGRShGmr+vyHYYS4qurU3dJ+PXNK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.461.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.461.0/index.min.mjs": "sha384-nK54pQvLKiaq1iiUNMb/EzaCfMnSDPRC200dlGRShGmr+vyHYYS4qurU3dJ+PXNK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.461.0/LICENSE
```
