...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1030.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1030.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oCCBrzu93HIttDHw80vQSLQXALLJFhGrpFxY3xPhUZIhLh7nJGZNNgSK876DyqMp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1030.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1030.0/index.min.mjs": "sha384-oCCBrzu93HIttDHw80vQSLQXALLJFhGrpFxY3xPhUZIhLh7nJGZNNgSK876DyqMp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1030.0/LICENSE
```
