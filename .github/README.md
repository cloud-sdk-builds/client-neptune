...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.775.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.775.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a8oKb9O9Eh/XcbN2qABvyIabTHqRqDME1zgdbeX+MtesTrworxbav22M/8zAWwY7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.775.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.775.0/index.min.mjs": "sha384-a8oKb9O9Eh/XcbN2qABvyIabTHqRqDME1zgdbeX+MtesTrworxbav22M/8zAWwY7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.775.0/LICENSE
```
