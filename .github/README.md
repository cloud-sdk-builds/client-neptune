...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.956.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.956.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-smZ0JSPU5NXcIN5KhES9P1S4IkE207sUKHY4Jt7+owucvuTfnQ2LXaMcz/721P/j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.956.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.956.0/index.min.mjs": "sha384-smZ0JSPU5NXcIN5KhES9P1S4IkE207sUKHY4Jt7+owucvuTfnQ2LXaMcz/721P/j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.956.0/LICENSE
```
