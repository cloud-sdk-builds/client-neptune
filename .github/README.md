...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.958.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.958.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0w1B5TsXHj7rvYOK/AUF9p+whNh5uyhASambvck5UVfCXO+BWd8vwbw/WWZxikQe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.958.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.958.0/index.min.mjs": "sha384-0w1B5TsXHj7rvYOK/AUF9p+whNh5uyhASambvck5UVfCXO+BWd8vwbw/WWZxikQe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.958.0/LICENSE
```
