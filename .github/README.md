...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.245.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.245.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ningKC9PtHy1BJApUCItaCTb3La6QHwue2av7D1j3AJ2GMPoUdBFamDzrH05xq4N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.245.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.245.0/index.min.mjs": "sha384-ningKC9PtHy1BJApUCItaCTb3La6QHwue2av7D1j3AJ2GMPoUdBFamDzrH05xq4N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.245.0/LICENSE
```
