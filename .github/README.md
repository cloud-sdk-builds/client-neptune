...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.931.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.931.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wFnjh3UHldotCWVHZ+K7EDnuB7jjhVzvPjSaE42KqU8fj5Ws6j3Wm2dXBGMlubgC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.931.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.931.0/index.min.mjs": "sha384-wFnjh3UHldotCWVHZ+K7EDnuB7jjhVzvPjSaE42KqU8fj5Ws6j3Wm2dXBGMlubgC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.931.0/LICENSE
```
