...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.714.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.714.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-52Ekvpre0LAdGzO+1xFTjEX8WXDZnf0mo/VSiO4FgALnA+gTohlG9qoIxI6mXFuv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.714.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.714.0/index.min.mjs": "sha384-52Ekvpre0LAdGzO+1xFTjEX8WXDZnf0mo/VSiO4FgALnA+gTohlG9qoIxI6mXFuv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.714.0/LICENSE
```
