...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.391.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.391.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/87SunHHldowF/0V21a3ZRwpPzrbO3Hxneo2nTYbsUr39eIIyJKDe7/L8i/9IIC+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.391.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.391.0/index.min.mjs": "sha384-/87SunHHldowF/0V21a3ZRwpPzrbO3Hxneo2nTYbsUr39eIIyJKDe7/L8i/9IIC+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.391.0/LICENSE
```
