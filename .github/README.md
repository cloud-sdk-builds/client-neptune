...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1033.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1033.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l9G1gQ089aozFihbWxSdtLi8s6GFJln1Tm7sl5Bb2TQdV9PGhJMhfDLhfr3hxIOz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1033.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1033.0/index.min.mjs": "sha384-l9G1gQ089aozFihbWxSdtLi8s6GFJln1Tm7sl5Bb2TQdV9PGhJMhfDLhfr3hxIOz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1033.0/LICENSE
```
