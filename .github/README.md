...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.211.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.211.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pHDQcW5j5bTQDysETG1A6mYmhhdgHDPoVQz5WGFcsHr7zDrlT2t+kD5O6BJFouLj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.211.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.211.0/index.min.mjs": "sha384-pHDQcW5j5bTQDysETG1A6mYmhhdgHDPoVQz5WGFcsHr7zDrlT2t+kD5O6BJFouLj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.211.0/LICENSE
```
