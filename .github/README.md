...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.21.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.21.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+g0ZQqGYS5uQBh5YWpEQPYSCvsJGDBVC8nLX9NbS2kn9MrU/70SqVpMcvl1SuL3K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.21.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.21.0/index.min.mjs": "sha384-+g0ZQqGYS5uQBh5YWpEQPYSCvsJGDBVC8nLX9NbS2kn9MrU/70SqVpMcvl1SuL3K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.21.0/LICENSE
```
