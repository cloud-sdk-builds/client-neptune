...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.629.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.629.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PDf63c0qDYvH5XtUGLmpJS7QmdNHeeOT4mrd1sJCle1otiHilk9fiuJKRgKsAAI1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.629.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.629.0/index.min.mjs": "sha384-PDf63c0qDYvH5XtUGLmpJS7QmdNHeeOT4mrd1sJCle1otiHilk9fiuJKRgKsAAI1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.629.0/LICENSE
```
