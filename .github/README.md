...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HEFPHmfG/hrhMM3lb+mC9U+0HgS6oGIqrJ544BFhcxarJU82z9jl9ZRCj0mo9PkY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.908.0/index.min.mjs": "sha384-HEFPHmfG/hrhMM3lb+mC9U+0HgS6oGIqrJ544BFhcxarJU82z9jl9ZRCj0mo9PkY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.908.0/LICENSE
```
