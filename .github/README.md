...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.418.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.418.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-10s0NsXw+83yk2D3gP+a7R1pvZqVu4eoUgYq9GQjJJYkBpsCVrrgdMyoiDrR7Mzb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.418.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.418.0/index.min.mjs": "sha384-10s0NsXw+83yk2D3gP+a7R1pvZqVu4eoUgYq9GQjJJYkBpsCVrrgdMyoiDrR7Mzb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.418.0/LICENSE
```
