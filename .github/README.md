...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.930.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.930.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fvtZqVDW6CrkB6Zy4w0t9Jt35C0AvOo4RE7jIlF9xgrtVUbExAtafDTDQrvqjIVq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.930.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.930.0/index.min.mjs": "sha384-fvtZqVDW6CrkB6Zy4w0t9Jt35C0AvOo4RE7jIlF9xgrtVUbExAtafDTDQrvqjIVq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.930.0/LICENSE
```
