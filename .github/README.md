...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.300.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.300.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kcER9mAdqIM+gfOsr1pAy54pe24bV1WpdccNCMEg3FUXZeN+wGYeKTsxljsKqBqK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.300.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.300.0/index.min.mjs": "sha384-kcER9mAdqIM+gfOsr1pAy54pe24bV1WpdccNCMEg3FUXZeN+wGYeKTsxljsKqBqK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.300.0/LICENSE
```
