...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.726.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.726.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-D7VgGWhnKwgGKgXMMtFtZEa2+2+MwrzHG6lub1cf4hyZ0iPF841mw+hJWTX/KYdu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.726.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.726.1/index.min.mjs": "sha384-D7VgGWhnKwgGKgXMMtFtZEa2+2+MwrzHG6lub1cf4hyZ0iPF841mw+hJWTX/KYdu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.726.1/LICENSE
```
