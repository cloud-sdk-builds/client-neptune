...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.19.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.19.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eBBwH3QUeP+8ehz1dypEniV7QtmPcLfSDE7ABZicpSqNgTo9YdkC1d77E6hQnI7/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.19.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.19.0/index.min.mjs": "sha384-eBBwH3QUeP+8ehz1dypEniV7QtmPcLfSDE7ABZicpSqNgTo9YdkC1d77E6hQnI7/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.19.0/LICENSE
```
