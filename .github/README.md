...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.712.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.712.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WW4u5aWm3X9F6bREHLuiLXB2h0QuNUoyw4LyEJdNYGwpOyoEgzbr8wixN5p3wyMB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.712.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.712.0/index.min.mjs": "sha384-WW4u5aWm3X9F6bREHLuiLXB2h0QuNUoyw4LyEJdNYGwpOyoEgzbr8wixN5p3wyMB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.712.0/LICENSE
```
