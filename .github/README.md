...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.658.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.658.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-OWD+lZVRejS2OtCzu6Yes7+NBl4/7Ljb4eImS9NDQ87hLzwRKiRVu5pOKHdGJ4KC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.658.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.658.1/index.min.mjs": "sha384-OWD+lZVRejS2OtCzu6Yes7+NBl4/7Ljb4eImS9NDQ87hLzwRKiRVu5pOKHdGJ4KC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.658.1/LICENSE
```
