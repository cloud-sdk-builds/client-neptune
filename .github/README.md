...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.503.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.503.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-N7890jm2E2UxwiK/aR0hoMgBdnA+CLm8zYcXZl4K/UCwI/vCW2F8YWIOHM11AOyn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.503.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.503.1/index.min.mjs": "sha384-N7890jm2E2UxwiK/aR0hoMgBdnA+CLm8zYcXZl4K/UCwI/vCW2F8YWIOHM11AOyn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.503.1/LICENSE
```
