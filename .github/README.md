...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.969.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.969.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ms5B7DF3CVKUmL6f4XUHyewuc1VgMbzoirA25VuIGbsiROGF2ZH/IGO8haRcw8ZV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.969.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.969.0/index.min.mjs": "sha384-ms5B7DF3CVKUmL6f4XUHyewuc1VgMbzoirA25VuIGbsiROGF2ZH/IGO8haRcw8ZV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.969.0/LICENSE
```
