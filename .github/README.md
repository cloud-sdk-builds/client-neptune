...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.592.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.592.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GzBPri75zuxoQobg8MFVmBE/dxNjemLQZ/dIFgWa5Hdx7YGz3eS0VR9tLoJ4lBEH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.592.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.592.0/index.min.mjs": "sha384-GzBPri75zuxoQobg8MFVmBE/dxNjemLQZ/dIFgWa5Hdx7YGz3eS0VR9tLoJ4lBEH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.592.0/LICENSE
```
