...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.159.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.159.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xdU/2ixBy/iQK7FYHfP0ZqdARR0XCI73YwrBsRJXOAZ2lgW+YhEKtUY9MQFMQk0Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.159.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.159.0/index.min.mjs": "sha384-xdU/2ixBy/iQK7FYHfP0ZqdARR0XCI73YwrBsRJXOAZ2lgW+YhEKtUY9MQFMQk0Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.159.0/LICENSE
```
