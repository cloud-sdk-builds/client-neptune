...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.774.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.774.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ubFvV5cOsnWWJ3G75ytygMVb27Om6t3kLpKsqSHHnl+g5WwJBN1nzmX46bgOBZhw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.774.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.774.0/index.min.mjs": "sha384-ubFvV5cOsnWWJ3G75ytygMVb27Om6t3kLpKsqSHHnl+g5WwJBN1nzmX46bgOBZhw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.774.0/LICENSE
```
