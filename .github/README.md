...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.254.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.254.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZyC+Ml+RQnXKFAyTcmyM0mwhTJq4Y+dogua7yXVAro/ELUHMptM+Ol8gw1Fdi0nz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.254.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.254.0/index.min.mjs": "sha384-ZyC+Ml+RQnXKFAyTcmyM0mwhTJq4Y+dogua7yXVAro/ELUHMptM+Ol8gw1Fdi0nz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.254.0/LICENSE
```
