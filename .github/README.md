...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.978.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.978.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n9e1lspXNZLwksO5lRlpddDxEaHVEopSb5vk3qmvVxjmn0LE4F1PF3x1r+YMql9y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.978.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.978.0/index.min.mjs": "sha384-n9e1lspXNZLwksO5lRlpddDxEaHVEopSb5vk3qmvVxjmn0LE4F1PF3x1r+YMql9y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.978.0/LICENSE
```
