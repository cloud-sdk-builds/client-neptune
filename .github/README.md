...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.910.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.910.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SJ3rMkYi7vFjP4EizGATFMOM/zxNMsFAu3kN7w8Qt1SigJ4YeIE7B0IxI0CzSAKc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.910.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.910.0/index.min.mjs": "sha384-SJ3rMkYi7vFjP4EizGATFMOM/zxNMsFAu3kN7w8Qt1SigJ4YeIE7B0IxI0CzSAKc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.910.0/LICENSE
```
