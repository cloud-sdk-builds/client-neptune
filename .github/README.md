...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.377.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.377.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Je3YrO+V3UZKjYjoSj4kNPS8mhluWUBvKLdiEEXiu0cZQbKZvrYaQt0ltkqMj1CM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.377.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.377.0/index.min.mjs": "sha384-Je3YrO+V3UZKjYjoSj4kNPS8mhluWUBvKLdiEEXiu0cZQbKZvrYaQt0ltkqMj1CM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.377.0/LICENSE
```
