...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.582.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.582.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RBCFZFO/BYFolohL2YyoKa/oKKvInOndJkYtv4FYKwg5+g6UYtYCEcjg0FDqt39p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.582.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.582.0/index.min.mjs": "sha384-RBCFZFO/BYFolohL2YyoKa/oKKvInOndJkYtv4FYKwg5+g6UYtYCEcjg0FDqt39p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.582.0/LICENSE
```
