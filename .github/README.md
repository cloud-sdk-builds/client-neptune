...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.23.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.23.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uHqeCYvzBTKl/zUOlY/ZfB8i3hpszDgDc8dMPowqY4hDXLq3vkPJfqPa9B8eP9H2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.23.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.23.0/index.min.mjs": "sha384-uHqeCYvzBTKl/zUOlY/ZfB8i3hpszDgDc8dMPowqY4hDXLq3vkPJfqPa9B8eP9H2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.23.0/LICENSE
```
