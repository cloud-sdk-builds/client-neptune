...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.554.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.554.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t/LKzFPXwaXm51ZIBogwuwqJ+jzfBMQH4djqugaZAAiLIIlOJKAXnX8N6HKhTbFB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.554.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.554.0/index.min.mjs": "sha384-t/LKzFPXwaXm51ZIBogwuwqJ+jzfBMQH4djqugaZAAiLIIlOJKAXnX8N6HKhTbFB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.554.0/LICENSE
```
