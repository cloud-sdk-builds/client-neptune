...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.47.2).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.47.2/index.min.mjs
```

SRI SHA Hash

```text
sha384-adfcDA4lHRIpbXlgTeN2ZaKrgk5GvWrp/eAeoy0DCe7zruXhH7t24EqSd5SJRDXj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.47.2/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.47.2/index.min.mjs": "sha384-adfcDA4lHRIpbXlgTeN2ZaKrgk5GvWrp/eAeoy0DCe7zruXhH7t24EqSd5SJRDXj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.47.2/LICENSE
```
