...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.565.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.565.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hImxMfISzPhJ3dc+cdcyLLhAxY7oPaQQEm2AExDs3U2nw+B0wIowSflsykg/xiwO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.565.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.565.0/index.min.mjs": "sha384-hImxMfISzPhJ3dc+cdcyLLhAxY7oPaQQEm2AExDs3U2nw+B0wIowSflsykg/xiwO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.565.0/LICENSE
```
