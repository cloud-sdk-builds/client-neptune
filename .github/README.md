...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.178.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.178.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aGL/AXXa3Zx8BkMNF8a2vsOu0dKgDckU5jmnBE+fTwqJhLAbjNlY68gRSMVRy4ox
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.178.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.178.0/index.min.mjs": "sha384-aGL/AXXa3Zx8BkMNF8a2vsOu0dKgDckU5jmnBE+fTwqJhLAbjNlY68gRSMVRy4ox"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.178.0/LICENSE
```
