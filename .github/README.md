...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.496.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.496.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fYe4u7xa8QbrBw50fgUmliGypTPSCzcgQWBO+21sUS0cfqP0rawq7OX1feT0un3Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.496.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.496.0/index.min.mjs": "sha384-fYe4u7xa8QbrBw50fgUmliGypTPSCzcgQWBO+21sUS0cfqP0rawq7OX1feT0un3Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.496.0/LICENSE
```
