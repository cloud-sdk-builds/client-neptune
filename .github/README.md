...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.974.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.974.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O7jhrHJcT7SP0tEbAZtj9yd6xuapK+ClP8kyCuIigg7Yq69dQ8okOxxnBuAhb/R4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.974.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.974.0/index.min.mjs": "sha384-O7jhrHJcT7SP0tEbAZtj9yd6xuapK+ClP8kyCuIigg7Yq69dQ8okOxxnBuAhb/R4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.974.0/LICENSE
```
