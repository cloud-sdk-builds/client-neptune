...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.421.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.421.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NTkrySfA0CaNRIZSGoXruTPiq3HMslSC9ED9P7hdg0qHLuBl2ym9WNc80G15wXeG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.421.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.421.0/index.min.mjs": "sha384-NTkrySfA0CaNRIZSGoXruTPiq3HMslSC9ED9P7hdg0qHLuBl2ym9WNc80G15wXeG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.421.0/LICENSE
```
