...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.598.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.598.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2ASguARa1h5mAvax/rVXrDuQsbC9iKZ3l5Yi4MZ/OuDiRnMMttk/K0UWmkG+2bl4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.598.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.598.0/index.min.mjs": "sha384-2ASguARa1h5mAvax/rVXrDuQsbC9iKZ3l5Yi4MZ/OuDiRnMMttk/K0UWmkG+2bl4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.598.0/LICENSE
```
