...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.212.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.212.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e6S1XcmPLB9Z5WV5fbgNtjlRrELB0u/NsV/pAWgUli+8OhPLGTM3xihAdN195m9g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.212.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.212.0/index.min.mjs": "sha384-e6S1XcmPLB9Z5WV5fbgNtjlRrELB0u/NsV/pAWgUli+8OhPLGTM3xihAdN195m9g"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.212.0/LICENSE
```
