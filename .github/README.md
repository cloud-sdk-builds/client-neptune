...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.215.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.215.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JZmb9d8N+wKK7zaXGr9oIoDC3SsrUk1ZWxw9jmlV1TdazpTXa4RJ+ikExLfWzk95
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.215.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.215.0/index.min.mjs": "sha384-JZmb9d8N+wKK7zaXGr9oIoDC3SsrUk1ZWxw9jmlV1TdazpTXa4RJ+ikExLfWzk95"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.215.0/LICENSE
```
