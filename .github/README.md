...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.533.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.533.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AF2uCWbInI4sGAGFMSO3Md1tkRTZ1hN4g1DUxWlmcb4xheoL0qCABDTjRIfvybQj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.533.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.533.0/index.min.mjs": "sha384-AF2uCWbInI4sGAGFMSO3Md1tkRTZ1hN4g1DUxWlmcb4xheoL0qCABDTjRIfvybQj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.533.0/LICENSE
```
