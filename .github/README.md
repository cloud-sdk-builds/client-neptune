...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.987.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.987.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gLvaUQ96JO1E7W0ekzNKlNcW8K6pfhfmPSOH9mFeFuaAvt9HyYjtoPPDpgLL5DVf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.987.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.987.0/index.min.mjs": "sha384-gLvaUQ96JO1E7W0ekzNKlNcW8K6pfhfmPSOH9mFeFuaAvt9HyYjtoPPDpgLL5DVf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.987.0/LICENSE
```
