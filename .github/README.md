...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.50.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.50.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-czC0ojOm2PW3VV8uuJ1MBtkUsxLjhe92dPP4nsongRmaYTPvNahvZkASLQQVs+Gz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.50.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.50.0/index.min.mjs": "sha384-czC0ojOm2PW3VV8uuJ1MBtkUsxLjhe92dPP4nsongRmaYTPvNahvZkASLQQVs+Gz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.50.0/LICENSE
```
