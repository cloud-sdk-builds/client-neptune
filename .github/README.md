...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h/VnDHs6flASMT/AoikWhTp0DWZSmzpnCm/yzaKHTv4C4FpEbrj+GSL0ZXp1jZex
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.876.0/index.min.mjs": "sha384-h/VnDHs6flASMT/AoikWhTp0DWZSmzpnCm/yzaKHTv4C4FpEbrj+GSL0ZXp1jZex"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.876.0/LICENSE
```
