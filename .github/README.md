...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1005.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1005.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v/2K7kYoESqJ7bKEPdIPCngU5o/m7zNk+YEYdtrh/ZUkCm1CT54tgwdj5/Gv/9Y7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1005.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1005.0/index.min.mjs": "sha384-v/2K7kYoESqJ7bKEPdIPCngU5o/m7zNk+YEYdtrh/ZUkCm1CT54tgwdj5/Gv/9Y7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1005.0/LICENSE
```
