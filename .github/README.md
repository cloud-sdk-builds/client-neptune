...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.35.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.35.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HXRdw/Focg9gtMQANHv+r5wNYQSdNh4loXhWRrACEQ1SHUSAjCab1EyrwnGfEKLl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.35.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.35.0/index.min.mjs": "sha384-HXRdw/Focg9gtMQANHv+r5wNYQSdNh4loXhWRrACEQ1SHUSAjCab1EyrwnGfEKLl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.35.0/LICENSE
```
