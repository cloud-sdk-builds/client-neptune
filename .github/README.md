...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.804.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.804.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5EayaElchUVW4mDvPZAWQ7WYc9r/eWmozT6CpXWCVZaxS7Ae7acvZ9bzl6BBeLms
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.804.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.804.0/index.min.mjs": "sha384-5EayaElchUVW4mDvPZAWQ7WYc9r/eWmozT6CpXWCVZaxS7Ae7acvZ9bzl6BBeLms"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.804.0/LICENSE
```
