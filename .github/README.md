...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.200.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.200.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V73IpeokhVyABtSunNV7/dC0IjzpgNnwpy2X9kToZN+B9QVScoWh6n0evNv/EMS/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.200.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.200.0/index.min.mjs": "sha384-V73IpeokhVyABtSunNV7/dC0IjzpgNnwpy2X9kToZN+B9QVScoWh6n0evNv/EMS/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.200.0/LICENSE
```
