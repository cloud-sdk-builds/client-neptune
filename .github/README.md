...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.328.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.328.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mtX19e8HSON4y4dDGk2QqPN635HTAnBWvKEClAqqPJKqtUcvSUlTgy/B9gYmzeQH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.328.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.328.0/index.min.mjs": "sha384-mtX19e8HSON4y4dDGk2QqPN635HTAnBWvKEClAqqPJKqtUcvSUlTgy/B9gYmzeQH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.328.0/LICENSE
```
