...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.540.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.540.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H3DnMwuhekbP55CvNmNuuJMWveOvdjJib7FhTz0j6uSX4itzSsuqn3KPZxieR7+a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.540.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.540.0/index.min.mjs": "sha384-H3DnMwuhekbP55CvNmNuuJMWveOvdjJib7FhTz0j6uSX4itzSsuqn3KPZxieR7+a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.540.0/LICENSE
```
