...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.359.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.359.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A4PRCUuFTsPWZ9bo4RHj9ELJbOJs02Jj5tR2Ald3+MBORTg3pE/9RLZzSL2UF/av
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.359.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.359.0/index.min.mjs": "sha384-A4PRCUuFTsPWZ9bo4RHj9ELJbOJs02Jj5tR2Ald3+MBORTg3pE/9RLZzSL2UF/av"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.359.0/LICENSE
```
