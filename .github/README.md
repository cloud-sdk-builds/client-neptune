...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.197.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.197.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JEjud2tcLpERgO8IvzIq2miASPQDSmK0Q79RpIr3v9SjsY/jjKjT8SHcEdYolN9X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.197.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.197.0/index.min.mjs": "sha384-JEjud2tcLpERgO8IvzIq2miASPQDSmK0Q79RpIr3v9SjsY/jjKjT8SHcEdYolN9X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.197.0/LICENSE
```
