...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.887.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.887.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Muav2ury55WSQsGgYorBWehhcZ5bd4UjCZwcAtJ49ZAdb0C/J2tRr/bPiMxEa191
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.887.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.887.0/index.min.mjs": "sha384-Muav2ury55WSQsGgYorBWehhcZ5bd4UjCZwcAtJ49ZAdb0C/J2tRr/bPiMxEa191"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.887.0/LICENSE
```
