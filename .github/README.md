...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.952.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.952.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1+TS7APyAF4tp3a8hYoD/6WOffdWSdTfZXCMkpthlE1JLedUSEHO30j5K/ye3LB6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.952.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.952.0/index.min.mjs": "sha384-1+TS7APyAF4tp3a8hYoD/6WOffdWSdTfZXCMkpthlE1JLedUSEHO30j5K/ye3LB6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.952.0/LICENSE
```
