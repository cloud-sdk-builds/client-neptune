...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.378.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.378.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fTMVj9KAdfePnm/4gsksAxMYd/7aj8+VNOFSKTqRBpjPCG8/s1zt2xXGelGEoA2A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.378.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.378.0/index.min.mjs": "sha384-fTMVj9KAdfePnm/4gsksAxMYd/7aj8+VNOFSKTqRBpjPCG8/s1zt2xXGelGEoA2A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.378.0/LICENSE
```
