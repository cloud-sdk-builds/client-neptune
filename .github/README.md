...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.292.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.292.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jwtmCPzVIBQvZNN4APo2M4r/1JBG6ajux/pm1e22H5bKzig+Oq3qNdNZxpF1rnRC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.292.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.292.0/index.min.mjs": "sha384-jwtmCPzVIBQvZNN4APo2M4r/1JBG6ajux/pm1e22H5bKzig+Oq3qNdNZxpF1rnRC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.292.0/LICENSE
```
