...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.631.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.631.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OvIjx8LNM3/IPJFWkm6qXOEO6XHKAlCUCIfl56lvHVAe092M+wjkFC4FE44jKeUL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.631.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.631.0/index.min.mjs": "sha384-OvIjx8LNM3/IPJFWkm6qXOEO6XHKAlCUCIfl56lvHVAe092M+wjkFC4FE44jKeUL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.631.0/LICENSE
```
