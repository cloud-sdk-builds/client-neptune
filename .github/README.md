...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B1JdTTsR61O2wyiVVTnx1lAIfBaFqSG7hs+rOecIhFlPlwCN9YoPNdFKhZayOa/F
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.932.0/index.min.mjs": "sha384-B1JdTTsR61O2wyiVVTnx1lAIfBaFqSG7hs+rOecIhFlPlwCN9YoPNdFKhZayOa/F"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.932.0/LICENSE
```
