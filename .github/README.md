...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.616.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.616.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BTxrQ0j2viROQic8mzcM9AsEHLNkTYfkeOwM20CKtw0qODioG7oO8PCuZbDBsql7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.616.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.616.0/index.min.mjs": "sha384-BTxrQ0j2viROQic8mzcM9AsEHLNkTYfkeOwM20CKtw0qODioG7oO8PCuZbDBsql7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.616.0/LICENSE
```
