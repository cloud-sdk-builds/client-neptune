...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.266.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.266.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2NXzUde1tU0z3xIeSWxyuGG95JwN0X66/z0nrfNCJpJunycPka9YzQtHXGQhL87J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.266.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.266.0/index.min.mjs": "sha384-2NXzUde1tU0z3xIeSWxyuGG95JwN0X66/z0nrfNCJpJunycPka9YzQtHXGQhL87J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.266.0/LICENSE
```
