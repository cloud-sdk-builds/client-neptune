...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.362.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.362.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fzWtikvP+5hF48pG3L8+HAgvBOm9qhOZTQ50KgsXhRQAs9AgzNVB7o2IikZUrOjh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.362.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.362.0/index.min.mjs": "sha384-fzWtikvP+5hF48pG3L8+HAgvBOm9qhOZTQ50KgsXhRQAs9AgzNVB7o2IikZUrOjh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.362.0/LICENSE
```
