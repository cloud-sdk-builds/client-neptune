...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.670.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.670.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6z6/9R9H+nToovOpk+KPR/w6OZAcH/3pnLUeVwKTdCN4ioKf3hZebJHmU6z+rWCf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.670.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.670.0/index.min.mjs": "sha384-6z6/9R9H+nToovOpk+KPR/w6OZAcH/3pnLUeVwKTdCN4ioKf3hZebJHmU6z+rWCf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.670.0/LICENSE
```
