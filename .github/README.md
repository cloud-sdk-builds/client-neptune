...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.272.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.272.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Koz6qRBiQDJccXEuF7q0ch21qS5WSeylgdzs4qwU5kAZgQgInGNRykYTFKLuavKs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.272.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.272.0/index.min.mjs": "sha384-Koz6qRBiQDJccXEuF7q0ch21qS5WSeylgdzs4qwU5kAZgQgInGNRykYTFKLuavKs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.272.0/LICENSE
```
