...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.716.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.716.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gOO3zeA+jV4qnu9V1P6oJCiAUC0QT8Kf+v+LZYeeJjltylcmY0s+eeHc2Gyf30Yz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.716.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.716.0/index.min.mjs": "sha384-gOO3zeA+jV4qnu9V1P6oJCiAUC0QT8Kf+v+LZYeeJjltylcmY0s+eeHc2Gyf30Yz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.716.0/LICENSE
```
