...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.511.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.511.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Dn1z3LHrFVMBN+YQvMvRu0gV/qMt3/8ya6msDDN80tvMJYTHM8y14xLLJTTkadpX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.511.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.511.0/index.min.mjs": "sha384-Dn1z3LHrFVMBN+YQvMvRu0gV/qMt3/8ya6msDDN80tvMJYTHM8y14xLLJTTkadpX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.511.0/LICENSE
```
