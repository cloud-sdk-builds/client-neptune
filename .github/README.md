...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.271.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.271.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Hei88/D1Fe/pSJhhnqFXZhQSdV2yglC+8Hy6CWIsIfuMSGozPF94QLNxpjUBG4Ia
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.271.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.271.0/index.min.mjs": "sha384-Hei88/D1Fe/pSJhhnqFXZhQSdV2yglC+8Hy6CWIsIfuMSGozPF94QLNxpjUBG4Ia"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.271.0/LICENSE
```
