...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.549.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.549.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XAUne82jgAXceOTKBjYNr514lPTnWK7KrUGulfz28xxyN1qUmFK54jyL2zEDWZHH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.549.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.549.0/index.min.mjs": "sha384-XAUne82jgAXceOTKBjYNr514lPTnWK7KrUGulfz28xxyN1qUmFK54jyL2zEDWZHH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.549.0/LICENSE
```
