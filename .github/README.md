...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.583.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.583.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/Jz17Cg1gH769sGF/2g3sjTT2WhaIx+QME+WZFHK9gqWKt7xjTWHJwmtoCVA//Kx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.583.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.583.0/index.min.mjs": "sha384-/Jz17Cg1gH769sGF/2g3sjTT2WhaIx+QME+WZFHK9gqWKt7xjTWHJwmtoCVA//Kx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.583.0/LICENSE
```
