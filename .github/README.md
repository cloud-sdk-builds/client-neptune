...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.825.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.825.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7qSEtosk3eGZPJ1zl3fM3F1dj+9dZ5ZJn4T3kFLmKp9k3UhbSPz/+si6m8A+8uU1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.825.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.825.0/index.min.mjs": "sha384-7qSEtosk3eGZPJ1zl3fM3F1dj+9dZ5ZJn4T3kFLmKp9k3UhbSPz/+si6m8A+8uU1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.825.0/LICENSE
```
