...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.693.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.693.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/JiL9nDtVybKqrdfm0u0Gsd9Ca9v9BGTpF9MWUMmMNDzcZcO8dq3p/xdkYlIwleY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.693.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.693.0/index.min.mjs": "sha384-/JiL9nDtVybKqrdfm0u0Gsd9Ca9v9BGTpF9MWUMmMNDzcZcO8dq3p/xdkYlIwleY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.693.0/LICENSE
```
