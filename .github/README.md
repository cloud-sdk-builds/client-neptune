...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.48.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.48.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-68jtG9KLbHosSGUGFwrmLGnc21MrrNxRh4+8U9OpxwGItgqQhLIt1YKE+QDKg4Me
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.48.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.48.0/index.min.mjs": "sha384-68jtG9KLbHosSGUGFwrmLGnc21MrrNxRh4+8U9OpxwGItgqQhLIt1YKE+QDKg4Me"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.48.0/LICENSE
```
