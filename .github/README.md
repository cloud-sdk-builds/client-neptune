...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.160.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.160.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VDbid+4c9cPM7C8Lj9TkPn1RQCsA2OlyrmOnRLip89fzznPLnrfEPNkw4qPN8F7S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.160.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.160.0/index.min.mjs": "sha384-VDbid+4c9cPM7C8Lj9TkPn1RQCsA2OlyrmOnRLip89fzznPLnrfEPNkw4qPN8F7S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.160.0/LICENSE
```
