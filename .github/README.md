...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.261.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.261.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-38XyLSu28djML/1EbH9Rp6VQUaZr+Wwy6ZWMNsYOzM6c4dS54aV9jboVKQrwPTCa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.261.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.261.0/index.min.mjs": "sha384-38XyLSu28djML/1EbH9Rp6VQUaZr+Wwy6ZWMNsYOzM6c4dS54aV9jboVKQrwPTCa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.261.0/LICENSE
```
