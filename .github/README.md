...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.81.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.81.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tqDL/Faa6iWcF0JlBCNPlG0f8doSJdAxmYSWi9/vWTU6F7RFP91sgJWb52sxvYTT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.81.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.81.0/index.min.mjs": "sha384-tqDL/Faa6iWcF0JlBCNPlG0f8doSJdAxmYSWi9/vWTU6F7RFP91sgJWb52sxvYTT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.81.0/LICENSE
```
