...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.954.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.954.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IIDxgO/gQYPWew6hN26FMkL0ROfQZHrSLaEetic8nH2jw+zneftvtj8YB9edpIsw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.954.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.954.0/index.min.mjs": "sha384-IIDxgO/gQYPWew6hN26FMkL0ROfQZHrSLaEetic8nH2jw+zneftvtj8YB9edpIsw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.954.0/LICENSE
```
