...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.637.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.637.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Q/BM56KxO3Dm88SggbI1R0gfMymMmOm/4km2SNhtFJzm5C8buV6HgPDMYgpPNx8R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.637.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.637.0/index.min.mjs": "sha384-Q/BM56KxO3Dm88SggbI1R0gfMymMmOm/4km2SNhtFJzm5C8buV6HgPDMYgpPNx8R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.637.0/LICENSE
```
