...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.436.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.436.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p22/zVrCvsmnUrt/v93eIBtIGD6JD91r89p5zP+jZ11PEIxm3YWCnBcFaVfWOrez
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.436.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.436.0/index.min.mjs": "sha384-p22/zVrCvsmnUrt/v93eIBtIGD6JD91r89p5zP+jZ11PEIxm3YWCnBcFaVfWOrez"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.436.0/LICENSE
```
