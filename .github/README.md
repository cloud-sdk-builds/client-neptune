...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.67.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.67.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S2NvaR4pl2JDP0tMouceWgER9yhL1nX793Gd6tz/UaZE+tMSdmDoGzwzA1UsE1Fb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.67.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.67.0/index.min.mjs": "sha384-S2NvaR4pl2JDP0tMouceWgER9yhL1nX793Gd6tz/UaZE+tMSdmDoGzwzA1UsE1Fb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.67.0/LICENSE
```
