...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.920.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.920.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UyuXxrWK9aDR8Ks6DMi9Z6Xmqh+mc8lWHy7KVDTNOsqNuRerqG2R1BQd6Hr6Ta0W
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.920.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.920.0/index.min.mjs": "sha384-UyuXxrWK9aDR8Ks6DMi9Z6Xmqh+mc8lWHy7KVDTNOsqNuRerqG2R1BQd6Hr6Ta0W"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.920.0/LICENSE
```
