...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.410.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.410.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zlwjtDMv4OIv7PaGfdVCtJbIef6bEYHcok2bDYfh3BexdjbxooO9SU0vD0KgaWYX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.410.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.410.0/index.min.mjs": "sha384-zlwjtDMv4OIv7PaGfdVCtJbIef6bEYHcok2bDYfh3BexdjbxooO9SU0vD0KgaWYX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.410.0/LICENSE
```
