...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.441.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.441.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5SUo1E/CfIq+gaT9/Z7DZufM3ZbC7Le7bsvDujc7gtAwuqeDZUYbUlVwrjWwuGwe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.441.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.441.0/index.min.mjs": "sha384-5SUo1E/CfIq+gaT9/Z7DZufM3ZbC7Le7bsvDujc7gtAwuqeDZUYbUlVwrjWwuGwe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.441.0/LICENSE
```
