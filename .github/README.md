...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.826.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.826.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N1F8YIWiIVruM1X6WGqnMDFd/GvFW59Olh1K/CPx5MGK/i7TmF/XJeMYzqinUcgF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.826.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.826.0/index.min.mjs": "sha384-N1F8YIWiIVruM1X6WGqnMDFd/GvFW59Olh1K/CPx5MGK/i7TmF/XJeMYzqinUcgF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.826.0/LICENSE
```
