...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.289.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.289.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-o4GDCD4W7aDXEBEXI/2JMQrTWm6tXaB1U2LDFoxVYPfnQ+oFyVmXYMtt5u2EhVJD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.289.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.289.0/index.min.mjs": "sha384-o4GDCD4W7aDXEBEXI/2JMQrTWm6tXaB1U2LDFoxVYPfnQ+oFyVmXYMtt5u2EhVJD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.289.0/LICENSE
```
