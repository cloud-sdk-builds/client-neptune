...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.916.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.916.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Zge9dl+VW+rhBh0XQKa6mZqmRBnCkONBbOiqNohPmcp3vwX1YeUKtyMlb+aePBR2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.916.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.916.0/index.min.mjs": "sha384-Zge9dl+VW+rhBh0XQKa6mZqmRBnCkONBbOiqNohPmcp3vwX1YeUKtyMlb+aePBR2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.916.0/LICENSE
```
