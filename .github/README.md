...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.943.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.943.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jyDR5zj1eiy3/CHVAf4cVI0Vy0folRZsvFR37nnJMsuXSgYuTeozNYF9Gq8GnKue
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.943.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.943.0/index.min.mjs": "sha384-jyDR5zj1eiy3/CHVAf4cVI0Vy0folRZsvFR37nnJMsuXSgYuTeozNYF9Gq8GnKue"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.943.0/LICENSE
```
