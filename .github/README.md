...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1041.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1041.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zl9IkZLuiT/9QUGCFVDh/s2hujtDkw8mPP/3Q3J6dOTJeATJOS41Jrtti3z2KUAJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1041.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1041.0/index.min.mjs": "sha384-zl9IkZLuiT/9QUGCFVDh/s2hujtDkw8mPP/3Q3J6dOTJeATJOS41Jrtti3z2KUAJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1041.0/LICENSE
```
