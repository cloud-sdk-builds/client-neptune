...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.216.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.216.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y41xR/8qz+cfq0JKoWLO2ZVt1IKAmPDEddPAzb6pUBJd1GjexRDQJ+kDMVNItjUp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.216.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.216.0/index.min.mjs": "sha384-y41xR/8qz+cfq0JKoWLO2ZVt1IKAmPDEddPAzb6pUBJd1GjexRDQJ+kDMVNItjUp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.216.0/LICENSE
```
