...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.445.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.445.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-seopG3HGJZGjA/bns/iCeJguxCCUXO0KaEV+E3jG1/zga+tBx+Sd0BVDfO8c+U92
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.445.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.445.0/index.min.mjs": "sha384-seopG3HGJZGjA/bns/iCeJguxCCUXO0KaEV+E3jG1/zga+tBx+Sd0BVDfO8c+U92"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.445.0/LICENSE
```
