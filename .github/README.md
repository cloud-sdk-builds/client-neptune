...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1019.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1019.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JfbjFkQnOeuP5AjVwbMWekchBPxn3QGzAgVrL2roGYcHw0nHjDePAvBpQ8uztfvl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1019.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1019.0/index.min.mjs": "sha384-JfbjFkQnOeuP5AjVwbMWekchBPxn3QGzAgVrL2roGYcHw0nHjDePAvBpQ8uztfvl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1019.0/LICENSE
```
