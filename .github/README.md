...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.449.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.449.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4XD7TN3GGlTWCfoXrgY9LoBHFS2XKkcfG5gWQYS1/kaZdK7fU3yIuS+tRhmaESel
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.449.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.449.0/index.min.mjs": "sha384-4XD7TN3GGlTWCfoXrgY9LoBHFS2XKkcfG5gWQYS1/kaZdK7fU3yIuS+tRhmaESel"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.449.0/LICENSE
```
