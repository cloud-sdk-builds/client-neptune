...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.30.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.30.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Cj0Ni9rgmrX/Sj1BocJ6S6jN+XVkTo6NGICyQtE+ugY45jP1SqlrFaEnhu9clYot
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.30.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.30.0/index.min.mjs": "sha384-Cj0Ni9rgmrX/Sj1BocJ6S6jN+XVkTo6NGICyQtE+ugY45jP1SqlrFaEnhu9clYot"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.30.0/LICENSE
```
