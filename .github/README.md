...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.7.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.7.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0o1B6Kr9N8jwKojwN8bRCojsALeC/Uzhh55FZgrT7Jnp5BHDyM9MhpInrPYHif3y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.7.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.7.0/index.min.mjs": "sha384-0o1B6Kr9N8jwKojwN8bRCojsALeC/Uzhh55FZgrT7Jnp5BHDyM9MhpInrPYHif3y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.7.0/LICENSE
```
