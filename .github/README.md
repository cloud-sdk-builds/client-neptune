...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.369.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.369.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IeQrO8qMlxv0K03siCcciUuGYSmNRduAiIT3vyLo2lQWmm69xsANZe+XGjUCO67I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.369.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.369.0/index.min.mjs": "sha384-IeQrO8qMlxv0K03siCcciUuGYSmNRduAiIT3vyLo2lQWmm69xsANZe+XGjUCO67I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.369.0/LICENSE
```
