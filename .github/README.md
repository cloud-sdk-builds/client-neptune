...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.691.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.691.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aLgvt176YlVY6v/LBNvK8IRy4YuOuCiYOsL1LOk53jlXex+96vEF62aMFocFbWpj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.691.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.691.0/index.min.mjs": "sha384-aLgvt176YlVY6v/LBNvK8IRy4YuOuCiYOsL1LOk53jlXex+96vEF62aMFocFbWpj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.691.0/LICENSE
```
