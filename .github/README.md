...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.934.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.934.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sEc3ks6zJbBLAQ9zeobvoDeWuDls6IRvYnJnz14R508WsYA0hW/ZYY1D54xc/4DX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.934.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.934.0/index.min.mjs": "sha384-sEc3ks6zJbBLAQ9zeobvoDeWuDls6IRvYnJnz14R508WsYA0hW/ZYY1D54xc/4DX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.934.0/LICENSE
```
