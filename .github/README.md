...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c65YS5Fhb9Io4kFnxdtkEgRdwUzQEcOFxNZUPRUJGZpZ1iR75504/lgqu79ALwVx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.798.0/index.min.mjs": "sha384-c65YS5Fhb9Io4kFnxdtkEgRdwUzQEcOFxNZUPRUJGZpZ1iR75504/lgqu79ALwVx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.798.0/LICENSE
```
