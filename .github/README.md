...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.588.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.588.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HT+ZXXIisOGRFRBfV2nYkW6sDPG+50B2Gz/FYyZuT3+V8z7Y1daYolo93hhY/f1x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.588.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.588.0/index.min.mjs": "sha384-HT+ZXXIisOGRFRBfV2nYkW6sDPG+50B2Gz/FYyZuT3+V8z7Y1daYolo93hhY/f1x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.588.0/LICENSE
```
