...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.713.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.713.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ur2S68TCm0z+8V46cpZ4OGcHzSpq1RPEpfpb/OqcKiHR5EnIz1SJJb1JWXAuDoJB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.713.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.713.0/index.min.mjs": "sha384-Ur2S68TCm0z+8V46cpZ4OGcHzSpq1RPEpfpb/OqcKiHR5EnIz1SJJb1JWXAuDoJB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.713.0/LICENSE
```
