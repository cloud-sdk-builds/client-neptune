...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.141.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.141.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JTOwHT3UHXc6xVrLIsOEh3HwdyN283o3ezM8KQrWw1tjQfLu0Lw64BnamIdexOIX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.141.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.141.0/index.min.mjs": "sha384-JTOwHT3UHXc6xVrLIsOEh3HwdyN283o3ezM8KQrWw1tjQfLu0Lw64BnamIdexOIX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.141.0/LICENSE
```
