...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.830.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.830.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nK38pdcuRUILqe4+OPfU71sK6lsRqVSApP8XzkPHlGCEoaBJM/m/43gCWo3wEkRx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.830.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.830.0/index.min.mjs": "sha384-nK38pdcuRUILqe4+OPfU71sK6lsRqVSApP8XzkPHlGCEoaBJM/m/43gCWo3wEkRx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.830.0/LICENSE
```
