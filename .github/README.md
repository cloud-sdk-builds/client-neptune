...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.935.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.935.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zhJLjuia2YUV3k47aFGQ6a9szLz1iF3jTWC8sBiqEVP7YldWwCDeGcypSi6tkkrL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.935.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.935.0/index.min.mjs": "sha384-zhJLjuia2YUV3k47aFGQ6a9szLz1iF3jTWC8sBiqEVP7YldWwCDeGcypSi6tkkrL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.935.0/LICENSE
```
