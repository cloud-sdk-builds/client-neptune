...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.344.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.344.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LOcghkjGuBkYgmc1Vl5XFf7+ntW43Fkhkq53sbsgnTPA/0m9u+P2YRx/FxLnd4l8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.344.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.344.0/index.min.mjs": "sha384-LOcghkjGuBkYgmc1Vl5XFf7+ntW43Fkhkq53sbsgnTPA/0m9u+P2YRx/FxLnd4l8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.344.0/LICENSE
```
