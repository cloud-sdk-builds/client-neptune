...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.772.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.772.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cAt4hFLlQc+FG+iZJkEA8kl7g6vQDY9Zs83yXp24EihBEToUTJVSXKxDlCuJ31HS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.772.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.772.0/index.min.mjs": "sha384-cAt4hFLlQc+FG+iZJkEA8kl7g6vQDY9Zs83yXp24EihBEToUTJVSXKxDlCuJ31HS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.772.0/LICENSE
```
