...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.425.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.425.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HaCGoWXOoXsp8QZWHFAGOX2AIRCutrRyw7RLp+C8fzYx0u4R3NGcG5XtFMzgkw0Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.425.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.425.0/index.min.mjs": "sha384-HaCGoWXOoXsp8QZWHFAGOX2AIRCutrRyw7RLp+C8fzYx0u4R3NGcG5XtFMzgkw0Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.425.0/LICENSE
```
