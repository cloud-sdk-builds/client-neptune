...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.609.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.609.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ga1lK1uMxXesoEEOGeVm6Csabi6sXmbPOqBCHT4U/EEBojKYVG+FmXEwHE2ksyER
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.609.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.609.0/index.min.mjs": "sha384-ga1lK1uMxXesoEEOGeVm6Csabi6sXmbPOqBCHT4U/EEBojKYVG+FmXEwHE2ksyER"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.609.0/LICENSE
```
