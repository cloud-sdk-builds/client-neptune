...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.379.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.379.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-bf/8NN/OUcUQhl1QS7fR3qydITwkJXrPcv94qrqtwqlxH0mnvWQEdTQCaPcXPX/N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.379.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.379.1/index.min.mjs": "sha384-bf/8NN/OUcUQhl1QS7fR3qydITwkJXrPcv94qrqtwqlxH0mnvWQEdTQCaPcXPX/N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.379.1/LICENSE
```
