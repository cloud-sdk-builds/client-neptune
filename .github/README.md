...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.929.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.929.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/cwucAka4iePFfTKJdtfLyez91Z+XSC2jkyuBJJDBo6AI+Uq6nyBQl64YwOWUcDD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.929.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.929.0/index.min.mjs": "sha384-/cwucAka4iePFfTKJdtfLyez91Z+XSC2jkyuBJJDBo6AI+Uq6nyBQl64YwOWUcDD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.929.0/LICENSE
```
