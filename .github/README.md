...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.817.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.817.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XCLqW+VcmAKMB2Haudcp88D7nCHkFXD4EVHlZtYhYGwHUR5OAnsZgkGrwzI/Y1Ih
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.817.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.817.0/index.min.mjs": "sha384-XCLqW+VcmAKMB2Haudcp88D7nCHkFXD4EVHlZtYhYGwHUR5OAnsZgkGrwzI/Y1Ih"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.817.0/LICENSE
```
