...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.645.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.645.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-leV0DAxkqRxOaV3XculuaC2MpCxjhttOcMay6PpkniTDb16zfhjIWbqgbQFUt6Qw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.645.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.645.0/index.min.mjs": "sha384-leV0DAxkqRxOaV3XculuaC2MpCxjhttOcMay6PpkniTDb16zfhjIWbqgbQFUt6Qw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.645.0/LICENSE
```
