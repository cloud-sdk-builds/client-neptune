...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.327.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.327.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wrGvOYuRt7M8u3dTo2B+Bed0sbj4S8Eceq0MB6D8DtkKJjrH3GDVppNL3xHZobwk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.327.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.327.0/index.min.mjs": "sha384-wrGvOYuRt7M8u3dTo2B+Bed0sbj4S8Eceq0MB6D8DtkKJjrH3GDVppNL3xHZobwk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.327.0/LICENSE
```
