...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.358.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.358.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PonXv65BEObiYl4epxnFv75Hxy2H9VkqHhilgJ06HLV0UIMBmmsp6ADu2z7CM6V1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.358.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.358.0/index.min.mjs": "sha384-PonXv65BEObiYl4epxnFv75Hxy2H9VkqHhilgJ06HLV0UIMBmmsp6ADu2z7CM6V1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.358.0/LICENSE
```
