...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.872.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.872.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0Q+EJo+wYlYh0IP0nkLq1lb9jQg3utRrT3DJmVonDKcT/F3ruS3x6k5+4zZKZNLc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.872.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.872.0/index.min.mjs": "sha384-0Q+EJo+wYlYh0IP0nkLq1lb9jQg3utRrT3DJmVonDKcT/F3ruS3x6k5+4zZKZNLc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.872.0/LICENSE
```
