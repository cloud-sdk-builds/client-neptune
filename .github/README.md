...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.696.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.696.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-enqtXooqhr5oEm9UhZjWi+IZzXD4CQzJhw8c0YwaSIXClw/3GBczwh8js+aTm8Uz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.696.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.696.0/index.min.mjs": "sha384-enqtXooqhr5oEm9UhZjWi+IZzXD4CQzJhw8c0YwaSIXClw/3GBczwh8js+aTm8Uz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.696.0/LICENSE
```
