...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.192.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.192.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Rtcds84xTuMYCRaxj0My8TuBqIeMAHfErOsgkJqVYAmTkL9J1gc2Huf2MQmtyd40
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.192.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.192.0/index.min.mjs": "sha384-Rtcds84xTuMYCRaxj0My8TuBqIeMAHfErOsgkJqVYAmTkL9J1gc2Huf2MQmtyd40"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.192.0/LICENSE
```
