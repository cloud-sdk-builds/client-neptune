...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.568.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.568.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yE+peO0rQxvVEapyA9pmEcMbHzAbQCbqkr1eyrlQ3QpAjC0qzuOw/8dGXMyqae6u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.568.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.568.0/index.min.mjs": "sha384-yE+peO0rQxvVEapyA9pmEcMbHzAbQCbqkr1eyrlQ3QpAjC0qzuOw/8dGXMyqae6u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.568.0/LICENSE
```
