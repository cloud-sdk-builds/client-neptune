...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.857.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.857.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nQa77fY2FrvO1x5zcPgySY9HocEDYn+L4ho6lElhVRjNpKHxM+a5U4x1rsjOucRE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.857.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.857.0/index.min.mjs": "sha384-nQa77fY2FrvO1x5zcPgySY9HocEDYn+L4ho6lElhVRjNpKHxM+a5U4x1rsjOucRE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.857.0/LICENSE
```
