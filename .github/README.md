...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.970.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.970.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M3OomH0F8tNArx0Mr66FVMGW9prAGMvbyn0bPwjX9pmSm0I1CZLK+KfSymYGoTfm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.970.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.970.0/index.min.mjs": "sha384-M3OomH0F8tNArx0Mr66FVMGW9prAGMvbyn0bPwjX9pmSm0I1CZLK+KfSymYGoTfm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.970.0/LICENSE
```
