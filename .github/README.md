...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.188.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.188.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VkmWWEguui1HnUsjtuzJHbHuNWwRclzWUonOUNAo5Mrg3Kf5b1FEVteu8ihyL/9H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.188.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.188.0/index.min.mjs": "sha384-VkmWWEguui1HnUsjtuzJHbHuNWwRclzWUonOUNAo5Mrg3Kf5b1FEVteu8ihyL/9H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.188.0/LICENSE
```
