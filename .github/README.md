...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.968.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.968.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4/DYi7hK4qdx6zqo1JicAfuJIEDg5BFIu5KQZYLGCQBJZp5S1LLDfnZNM+HHz9Bo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.968.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.968.0/index.min.mjs": "sha384-4/DYi7hK4qdx6zqo1JicAfuJIEDg5BFIu5KQZYLGCQBJZp5S1LLDfnZNM+HHz9Bo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.968.0/LICENSE
```
