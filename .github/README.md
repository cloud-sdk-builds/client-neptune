...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.859.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.859.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CQGX9c2FCAbgt9aNuFkNyRNU4vydxTnTYo5gHPEV+Mu3n08d7QxcrBNMQM+V+RBQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.859.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.859.0/index.min.mjs": "sha384-CQGX9c2FCAbgt9aNuFkNyRNU4vydxTnTYo5gHPEV+Mu3n08d7QxcrBNMQM+V+RBQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.859.0/LICENSE
```
