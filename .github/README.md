...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.883.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.883.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7a055uymvamT2B4FHWiFbQQn07P2cOdp67lS2UjBvplgZaLoTR8IYSuHV4JO1rjQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.883.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.883.0/index.min.mjs": "sha384-7a055uymvamT2B4FHWiFbQQn07P2cOdp67lS2UjBvplgZaLoTR8IYSuHV4JO1rjQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.883.0/LICENSE
```
