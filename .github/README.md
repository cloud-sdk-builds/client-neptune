...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1035.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1035.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3AFYTsXUtk0Kg2DaqwbcelR+5zVV2sDIznhL8B+M5cfoXOEL5GeCVz3kLg6RxaH8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1035.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1035.0/index.min.mjs": "sha384-3AFYTsXUtk0Kg2DaqwbcelR+5zVV2sDIznhL8B+M5cfoXOEL5GeCVz3kLg6RxaH8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1035.0/LICENSE
```
