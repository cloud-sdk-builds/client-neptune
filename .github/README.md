...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.893.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.893.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rpNdVTDz3Y9D/2JqjZ/pX0hVZiggqbKKGnsnbeeTu88F2B8stWirNoh63c+Cnsas
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.893.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.893.0/index.min.mjs": "sha384-rpNdVTDz3Y9D/2JqjZ/pX0hVZiggqbKKGnsnbeeTu88F2B8stWirNoh63c+Cnsas"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.893.0/LICENSE
```
