...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.348.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.348.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zE9ublrQ+kSZ4H6MI51vlpIRS5G7swMFx0eRtvb06Kokdw3a0illcfsVylv7HSg7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.348.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.348.0/index.min.mjs": "sha384-zE9ublrQ+kSZ4H6MI51vlpIRS5G7swMFx0eRtvb06Kokdw3a0illcfsVylv7HSg7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.348.0/LICENSE
```
