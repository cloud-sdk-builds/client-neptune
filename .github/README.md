...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.360.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.360.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nWbqJbX395tN7kmvGR50aSO/6shN9Ng0hXyHcynXtccyxQcDS45+e5ITWe0s1OmX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.360.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.360.0/index.min.mjs": "sha384-nWbqJbX395tN7kmvGR50aSO/6shN9Ng0hXyHcynXtccyxQcDS45+e5ITWe0s1OmX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.360.0/LICENSE
```
