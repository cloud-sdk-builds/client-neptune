...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.730.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.730.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i+fc7ZVtTQsDqCeDazJ5njd1l/MmYnq31BEwKEbB0CDllQradfotAH6yAUL9Y11m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.730.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.730.0/index.min.mjs": "sha384-i+fc7ZVtTQsDqCeDazJ5njd1l/MmYnq31BEwKEbB0CDllQradfotAH6yAUL9Y11m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.730.0/LICENSE
```
