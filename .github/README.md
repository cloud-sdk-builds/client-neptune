...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.266.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.266.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-YF2z2LauZLT9SIIoZF49RUwZ7YWvTrhlGGT6VLksTz3P5eJ7py2Hm6lyP2jm7UjP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.266.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.266.1/index.min.mjs": "sha384-YF2z2LauZLT9SIIoZF49RUwZ7YWvTrhlGGT6VLksTz3P5eJ7py2Hm6lyP2jm7UjP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.266.1/LICENSE
```
