...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.430.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.430.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-buHKAd+7MQUR9f74YCXAWTkLwj13k5eLELbKitjJ12C3Kesu0kmf6oeKB/7iM9Vp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.430.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.430.0/index.min.mjs": "sha384-buHKAd+7MQUR9f74YCXAWTkLwj13k5eLELbKitjJ12C3Kesu0kmf6oeKB/7iM9Vp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.430.0/LICENSE
```
