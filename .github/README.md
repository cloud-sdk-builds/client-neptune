...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.408.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.408.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0SrDpdjoS42d/Adcd9JXmIg8UGvAp0ZJOuBQZ2lqhr/bv/nhtk4XTl85K1RW4EL+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.408.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.408.0/index.min.mjs": "sha384-0SrDpdjoS42d/Adcd9JXmIg8UGvAp0ZJOuBQZ2lqhr/bv/nhtk4XTl85K1RW4EL+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.408.0/LICENSE
```
