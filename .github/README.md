...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.347.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.347.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-GIg00gEbNxCyfgCh1oKXM6XPfCdP+GgaAMuOCC0P5nbzRTJ/ouRSHVpMd/XIhhjK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.347.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.347.1/index.min.mjs": "sha384-GIg00gEbNxCyfgCh1oKXM6XPfCdP+GgaAMuOCC0P5nbzRTJ/ouRSHVpMd/XIhhjK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.347.1/LICENSE
```
