...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.490.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.490.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1vei9SynxVmQIGO9zTe+LMUYjWoq0vSIQ++Hcp7pIrKBnKosqvksM6unjhXWjiWL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.490.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.490.0/index.min.mjs": "sha384-1vei9SynxVmQIGO9zTe+LMUYjWoq0vSIQ++Hcp7pIrKBnKosqvksM6unjhXWjiWL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.490.0/LICENSE
```
