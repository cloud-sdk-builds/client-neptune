...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.37.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.37.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BV2y4VIoWh6k6ZyhJcQA8HS6UzaMcxLfbyCV/pUIcxwtcpmZF8WU1YP15/fiTqDt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.37.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.37.0/index.min.mjs": "sha384-BV2y4VIoWh6k6ZyhJcQA8HS6UzaMcxLfbyCV/pUIcxwtcpmZF8WU1YP15/fiTqDt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.37.0/LICENSE
```
