...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.79.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.79.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LjFJx0MkmWaAgW+LcfTfHX+XiTMJL9QUWa7xn/ZUVIw4ZkEus11pqQu5YmlGuFiB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.79.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.79.0/index.min.mjs": "sha384-LjFJx0MkmWaAgW+LcfTfHX+XiTMJL9QUWa7xn/ZUVIw4ZkEus11pqQu5YmlGuFiB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.79.0/LICENSE
```
