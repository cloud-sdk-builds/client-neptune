...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.26.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.26.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l0c9x2MMNLMQlwQzlYnYEXgspl+bsjhyp1bXBr3WP/GVQ+gj1l6oZntaM5s1Ja4U
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.26.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.26.0/index.min.mjs": "sha384-l0c9x2MMNLMQlwQzlYnYEXgspl+bsjhyp1bXBr3WP/GVQ+gj1l6oZntaM5s1Ja4U"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.26.0/LICENSE
```
