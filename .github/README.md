...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.54.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.54.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-IoopTyZ+g4aXjDSVyxTFs4jA+N51/ZBVzELUQ7ta/EnlqTCH9qk9tZB46pXhJkeW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.54.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.54.1/index.min.mjs": "sha384-IoopTyZ+g4aXjDSVyxTFs4jA+N51/ZBVzELUQ7ta/EnlqTCH9qk9tZB46pXhJkeW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.54.1/LICENSE
```
