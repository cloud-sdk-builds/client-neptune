...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.563.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.563.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u2clhIDox3yMZPdnxTRyandLzS7qE6ff96dBuN/ybszIt0izd9Vsk9MPV26b04S9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.563.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.563.0/index.min.mjs": "sha384-u2clhIDox3yMZPdnxTRyandLzS7qE6ff96dBuN/ybszIt0izd9Vsk9MPV26b04S9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.563.0/LICENSE
```
