...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.622.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.622.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-49SwQlqbFvjqqLIaBDMy6zE43xaT/KOQ7Qsf5wizy7HrGwpfdddLu+vR/FZ0eVqQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.622.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.622.0/index.min.mjs": "sha384-49SwQlqbFvjqqLIaBDMy6zE43xaT/KOQ7Qsf5wizy7HrGwpfdddLu+vR/FZ0eVqQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.622.0/LICENSE
```
