...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.438.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.438.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FgY54HCrz/z0LNgSdn3L+ArogBEiIWsL/wni9jII5GbVAIxGbRZQDVdInM0cXAz/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.438.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.438.0/index.min.mjs": "sha384-FgY54HCrz/z0LNgSdn3L+ArogBEiIWsL/wni9jII5GbVAIxGbRZQDVdInM0cXAz/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.438.0/LICENSE
```
