...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.669.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.669.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YEJfjl0sj58Ss9rwvFzQBRKbx0u1auQ4jnuRy7G6GywpJrgkEck8gL0dRtAdmU8f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.669.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.669.0/index.min.mjs": "sha384-YEJfjl0sj58Ss9rwvFzQBRKbx0u1auQ4jnuRy7G6GywpJrgkEck8gL0dRtAdmU8f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.669.0/LICENSE
```
