...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.621.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.621.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JcTDM+8sz9W4nLl0NETt2mFzkpxH6cEYAMH2jcdSUTnpV3StpPhRMqif+43+BvFG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.621.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.621.0/index.min.mjs": "sha384-JcTDM+8sz9W4nLl0NETt2mFzkpxH6cEYAMH2jcdSUTnpV3StpPhRMqif+43+BvFG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.621.0/LICENSE
```
