...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.118.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.118.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gq8IhUOajJ0K5QWlSK4IbOZVtMV2QbsCDaP7Y8ucSR4wtdYwLApIbE+Wu0khmxcV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.118.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.118.0/index.min.mjs": "sha384-Gq8IhUOajJ0K5QWlSK4IbOZVtMV2QbsCDaP7Y8ucSR4wtdYwLApIbE+Wu0khmxcV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.118.0/LICENSE
```
