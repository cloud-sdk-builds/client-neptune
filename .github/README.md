...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.982.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.982.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gpASmIo2TaAvRLByqr+SOiXv59XBJbfhaExcsC0h40uqtlkLxJbE9II3e0WQ888/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.982.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.982.0/index.min.mjs": "sha384-gpASmIo2TaAvRLByqr+SOiXv59XBJbfhaExcsC0h40uqtlkLxJbE9II3e0WQ888/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.982.0/LICENSE
```
