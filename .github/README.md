...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.988.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.988.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vzAxaC5MsxHX9m8vpeGn1mfns6iB1gvpH00wyEWyTLpOu7n09pw+7H+bqtW6s6t0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.988.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.988.0/index.min.mjs": "sha384-vzAxaC5MsxHX9m8vpeGn1mfns6iB1gvpH00wyEWyTLpOu7n09pw+7H+bqtW6s6t0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.988.0/LICENSE
```
