...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.623.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.623.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lQSx9k36GAlHaTa8od+ZDZpmD0kiLRsiyeivJu0a4BD3mrg1metFIOk5iBq1MX4b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.623.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.623.0/index.min.mjs": "sha384-lQSx9k36GAlHaTa8od+ZDZpmD0kiLRsiyeivJu0a4BD3mrg1metFIOk5iBq1MX4b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.623.0/LICENSE
```
