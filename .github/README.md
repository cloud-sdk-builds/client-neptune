...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.335.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.335.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-P/rsgtT/oQ40IpP8JNQqgZ/1mxeZwThZ2BwgjfhUPAvoKu/OeDJHHcGTLx+Ym76v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.335.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.335.0/index.min.mjs": "sha384-P/rsgtT/oQ40IpP8JNQqgZ/1mxeZwThZ2BwgjfhUPAvoKu/OeDJHHcGTLx+Ym76v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.335.0/LICENSE
```
