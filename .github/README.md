...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.6.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.6.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-N4jMghO44lCBl3PH+/wYdl7XdZBlUG3fO7MtlP6cT9IIlWOYvEL3g5kBGB2Zkbwv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.6.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.6.1/index.min.mjs": "sha384-N4jMghO44lCBl3PH+/wYdl7XdZBlUG3fO7MtlP6cT9IIlWOYvEL3g5kBGB2Zkbwv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.6.1/LICENSE
```
