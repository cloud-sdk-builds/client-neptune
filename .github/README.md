...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.3.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.3.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g3SXz9d/22kQf2gWQ9tzUUi5tghB7zMzrFSplOMlDbAZswPTvHveYUUg12oSAGJa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.3.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.3.0/index.min.mjs": "sha384-g3SXz9d/22kQf2gWQ9tzUUi5tghB7zMzrFSplOMlDbAZswPTvHveYUUg12oSAGJa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.3.0/LICENSE
```
