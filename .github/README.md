...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.226.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.226.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cOZU8dIkqVxAeEcmjadyjnF9SOgpFnjkAC9phjqQudat5VZBkhiSwu/mLvsm1Gi8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.226.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.226.0/index.min.mjs": "sha384-cOZU8dIkqVxAeEcmjadyjnF9SOgpFnjkAC9phjqQudat5VZBkhiSwu/mLvsm1Gi8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.226.0/LICENSE
```
