...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.471.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.471.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-agfC9HZgsktc4RVnt5tWH282Ld6obSEnSAcNpa1UbetvNzccCOVSFrsg1CdFFBvt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.471.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.471.0/index.min.mjs": "sha384-agfC9HZgsktc4RVnt5tWH282Ld6obSEnSAcNpa1UbetvNzccCOVSFrsg1CdFFBvt"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.471.0`)
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.471.0/LICENSE
```
