...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.41.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.41.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8p5NnS+etOkIbP2kLoz26oKSL9U4QxIkZa0bbvYqVaPKe92a9LIn0wUkuCIg36JB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.41.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.41.0/index.min.mjs": "sha384-8p5NnS+etOkIbP2kLoz26oKSL9U4QxIkZa0bbvYqVaPKe92a9LIn0wUkuCIg36JB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.41.0/LICENSE
```
