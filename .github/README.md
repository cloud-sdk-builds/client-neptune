...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.474.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.474.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jJZiEmz+VEhBHdncmAP3EsxFdoDC46dMQrCf0T22D1/cbAJIp6XWUDP40EZTBhuk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.474.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.474.0/index.min.mjs": "sha384-jJZiEmz+VEhBHdncmAP3EsxFdoDC46dMQrCf0T22D1/cbAJIp6XWUDP40EZTBhuk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.474.0/LICENSE
```
