...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.258.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.258.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sM/2/EnaKwseaK+txYu1StjFJZiYG68IxjhNqPy7r3x6zF+dToHmXavIHBh8qE4r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.258.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.258.0/index.min.mjs": "sha384-sM/2/EnaKwseaK+txYu1StjFJZiYG68IxjhNqPy7r3x6zF+dToHmXavIHBh8qE4r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.258.0/LICENSE
```
