...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.552.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.552.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i+hLVjWzBbTmjQ3Op8/B0a6b5ztMAJnJMzsTZtHFxDQETcRfgYnXION8lxQ6ul2S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.552.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.552.0/index.min.mjs": "sha384-i+hLVjWzBbTmjQ3Op8/B0a6b5ztMAJnJMzsTZtHFxDQETcRfgYnXION8lxQ6ul2S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.552.0/LICENSE
```
