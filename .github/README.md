...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.395.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.395.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+A8B5jq0pkPVcOUuVhya/4yAJp6cfBmHlRcnWwD4aXhTXzg1bnRwB/n+1RiNmMhP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.395.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.395.0/index.min.mjs": "sha384-+A8B5jq0pkPVcOUuVhya/4yAJp6cfBmHlRcnWwD4aXhTXzg1bnRwB/n+1RiNmMhP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.395.0/LICENSE
```
