...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1003.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1003.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-icKZ3b8/T6E7GtHNIEGhIFAljK2h7D6Koewcfh8K0AtgDJO/Ia7Y5AfDfRHbMq0l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1003.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1003.0/index.min.mjs": "sha384-icKZ3b8/T6E7GtHNIEGhIFAljK2h7D6Koewcfh8K0AtgDJO/Ia7Y5AfDfRHbMq0l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1003.0/LICENSE
```
