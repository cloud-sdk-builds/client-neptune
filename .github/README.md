...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.495.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.495.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BteSxWrVegqQtccDQxx0Qd0kRZXxiYExvKwbZXS3N1D7PJEdBxYbYn66wjcddplq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.495.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.495.0/index.min.mjs": "sha384-BteSxWrVegqQtccDQxx0Qd0kRZXxiYExvKwbZXS3N1D7PJEdBxYbYn66wjcddplq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.495.0/LICENSE
```
