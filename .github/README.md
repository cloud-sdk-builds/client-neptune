...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.357.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.357.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NmIuvjibolY/+fkui/ZAuvlrV7EWWKRuFPOn6B2HzpHfkwoh5UNbP2KRD4mYOvKB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.357.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.357.0/index.min.mjs": "sha384-NmIuvjibolY/+fkui/ZAuvlrV7EWWKRuFPOn6B2HzpHfkwoh5UNbP2KRD4mYOvKB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.357.0/LICENSE
```
