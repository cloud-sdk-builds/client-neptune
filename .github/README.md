...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.326.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.326.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tv6uBjfvYfYaZPZCDxMHkZqdODOARmQvYcN70nL5JgDfFPCnbNWYfBf6fpFrkE8o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.326.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.326.0/index.min.mjs": "sha384-tv6uBjfvYfYaZPZCDxMHkZqdODOARmQvYcN70nL5JgDfFPCnbNWYfBf6fpFrkE8o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.326.0/LICENSE
```
