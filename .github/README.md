...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.529.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.529.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-mirz40MOlLjpsT5UgQUYvt+AUFTNstiRx9D3ssSe4pvk3a8XMeWoEZMD0XHIKE7D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.529.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.529.1/index.min.mjs": "sha384-mirz40MOlLjpsT5UgQUYvt+AUFTNstiRx9D3ssSe4pvk3a8XMeWoEZMD0XHIKE7D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.529.1/LICENSE
```
