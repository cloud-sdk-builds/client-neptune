...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.429.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.429.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TcCHJWoiZVMgm2mSCi1VHeejGs2EljjK18kguYoiqi3IU+CidcPSOs1hdn+jA0nq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.429.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.429.0/index.min.mjs": "sha384-TcCHJWoiZVMgm2mSCi1VHeejGs2EljjK18kguYoiqi3IU+CidcPSOs1hdn+jA0nq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.429.0/LICENSE
```
