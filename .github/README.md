...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.808.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.808.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vhMq6X5D+uregzXFhOB2Cim8a4u6B0R2iBjd2GbFvZsFEc+SKxJJJcgxA7DKgWZq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.808.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.808.0/index.min.mjs": "sha384-vhMq6X5D+uregzXFhOB2Cim8a4u6B0R2iBjd2GbFvZsFEc+SKxJJJcgxA7DKgWZq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.808.0/LICENSE
```
