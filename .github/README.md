...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.476.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.476.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gDyTa/HTC4AxU6e61wREl2P82jFsRtz0YfhdgHkbohkRLa/OmNstUs+E3MFExBTf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.476.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.476.0/index.min.mjs": "sha384-gDyTa/HTC4AxU6e61wREl2P82jFsRtz0YfhdgHkbohkRLa/OmNstUs+E3MFExBTf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.476.0/LICENSE
```
