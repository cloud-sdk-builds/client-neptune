...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.966.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.966.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CHPftLhw9n0HohpY/Zbq+n3mHnMQ8GjZeW2VX3qgE+fycjti/20Qmiz0J4NdDA1V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.966.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.966.0/index.min.mjs": "sha384-CHPftLhw9n0HohpY/Zbq+n3mHnMQ8GjZeW2VX3qgE+fycjti/20Qmiz0J4NdDA1V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.966.0/LICENSE
```
