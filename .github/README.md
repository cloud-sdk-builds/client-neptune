...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.957.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.957.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pa6vXcROvltKkCKvmYvcf8IQyEi2g4Mv+kMlbCAyPtDtPpWGX79DtKtLR+4QYmyr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.957.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.957.0/index.min.mjs": "sha384-pa6vXcROvltKkCKvmYvcf8IQyEi2g4Mv+kMlbCAyPtDtPpWGX79DtKtLR+4QYmyr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.957.0/LICENSE
```
