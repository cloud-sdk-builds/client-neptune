...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lA5Rwb0iUXEZneAsh/VgK1zUAEHA7PTSGTLoDoP/ALNJQi/0Xe4jgl3sUYpZSCq2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.726.0/index.min.mjs": "sha384-lA5Rwb0iUXEZneAsh/VgK1zUAEHA7PTSGTLoDoP/ALNJQi/0Xe4jgl3sUYpZSCq2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.726.0/LICENSE
```
