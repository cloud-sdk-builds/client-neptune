...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.145.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.145.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BZ92L+gpYmB/KoAz1h3JUJG5F7mJTRQwAbbX/sMNlSdBcOf7EFNjVdfSPm4BQS3S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.145.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.145.0/index.min.mjs": "sha384-BZ92L+gpYmB/KoAz1h3JUJG5F7mJTRQwAbbX/sMNlSdBcOf7EFNjVdfSPm4BQS3S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.145.0/LICENSE
```
