...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.8.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.8.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-re7X8LQoxroXFa3iluulS5o/L+S69gP7qXI1zhQ8KGGNGmxqueX9Cwxng0ZgP8d9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.8.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.8.1/index.min.mjs": "sha384-re7X8LQoxroXFa3iluulS5o/L+S69gP7qXI1zhQ8KGGNGmxqueX9Cwxng0ZgP8d9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.8.1/LICENSE
```
