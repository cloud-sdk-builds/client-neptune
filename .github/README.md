...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.36.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.36.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-jcyc2bRkxaPprMb85Q30y0OXkaf89ENqPKw/a4ltk4uvA0w3JaiWN6KxP09uVi03
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.36.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.36.1/index.min.mjs": "sha384-jcyc2bRkxaPprMb85Q30y0OXkaf89ENqPKw/a4ltk4uvA0w3JaiWN6KxP09uVi03"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.36.1/LICENSE
```
