...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1042.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1042.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G7Cu5AZ5dBn4QkVNOuXBtvFrUTGvqMTFsaJ0diEocgAjwj9m//hgUyt2doSLR4jk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1042.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1042.0/index.min.mjs": "sha384-G7Cu5AZ5dBn4QkVNOuXBtvFrUTGvqMTFsaJ0diEocgAjwj9m//hgUyt2doSLR4jk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1042.0/LICENSE
```
