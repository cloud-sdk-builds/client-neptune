...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.264.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.264.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2cARTO2rlWTv2q/AN4L6vV3nxphkUkzaSFKjkYBBFaSEs82+3keodN5s/X//j2ul
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.264.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.264.0/index.min.mjs": "sha384-2cARTO2rlWTv2q/AN4L6vV3nxphkUkzaSFKjkYBBFaSEs82+3keodN5s/X//j2ul"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.264.0/LICENSE
```
