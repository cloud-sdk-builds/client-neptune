...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.431.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.431.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gMZOcaJsLpXrlToxO7y/V3VQhz+uhK632lEBA5Prg4/NbyzT1sm/dAeNiwYBsUYB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.431.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.431.0/index.min.mjs": "sha384-gMZOcaJsLpXrlToxO7y/V3VQhz+uhK632lEBA5Prg4/NbyzT1sm/dAeNiwYBsUYB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.431.0/LICENSE
```
