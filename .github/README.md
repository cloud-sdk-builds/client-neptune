...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.731.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.731.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-7Yh4eu34Nf+9PII+WtkKcqMJrP9iE7YLDqLSOKKhPqkzHnc5fg+xCroxNotebzOD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.731.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.731.1/index.min.mjs": "sha384-7Yh4eu34Nf+9PII+WtkKcqMJrP9iE7YLDqLSOKKhPqkzHnc5fg+xCroxNotebzOD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.731.1/LICENSE
```
