...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.52.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.52.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fYUD0Z8FZkjQokH02vby8DMKuTAte0TPgHwZb6IurPbycSY2UZvcXMRG0A2h8hu6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.52.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.52.0/index.min.mjs": "sha384-fYUD0Z8FZkjQokH02vby8DMKuTAte0TPgHwZb6IurPbycSY2UZvcXMRG0A2h8hu6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.52.0/LICENSE
```
