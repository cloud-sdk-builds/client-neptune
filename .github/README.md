...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.296.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.296.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cvduQyYiJ/OVrK7E6mxShoF+JjAFgK1jzz3A3imInFPewq6zXmV+06Ym363O0csT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.296.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.296.0/index.min.mjs": "sha384-cvduQyYiJ/OVrK7E6mxShoF+JjAFgK1jzz3A3imInFPewq6zXmV+06Ym363O0csT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.296.0/LICENSE
```
