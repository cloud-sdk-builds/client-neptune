...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.997.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.997.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vgVhVklQaJHYnsoIF+73qG12wYMyChLZu856+EzPkun9afuO7SGEW0qa6h+mEv4J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.997.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.997.0/index.min.mjs": "sha384-vgVhVklQaJHYnsoIF+73qG12wYMyChLZu856+EzPkun9afuO7SGEW0qa6h+mEv4J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.997.0/LICENSE
```
