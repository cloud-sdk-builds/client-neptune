...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.128.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.128.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FwPU8eD8I4FlTZf/Fdjm08ngp8s9v5C1v8EBgR0lNc63pgC77XrIXyelHVf7N+8X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.128.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.128.0/index.min.mjs": "sha384-FwPU8eD8I4FlTZf/Fdjm08ngp8s9v5C1v8EBgR0lNc63pgC77XrIXyelHVf7N+8X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.128.0/LICENSE
```
