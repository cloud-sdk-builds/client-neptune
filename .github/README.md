...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GlfHCk+qEkVWPyLyfgOdqF5FHt96ZFzNDoIiXQ1Op5QuahXtHex9t846CqSD9iTE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.848.0/index.min.mjs": "sha384-GlfHCk+qEkVWPyLyfgOdqF5FHt96ZFzNDoIiXQ1Op5QuahXtHex9t846CqSD9iTE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.848.0/LICENSE
```
