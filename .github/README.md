...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.185.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.185.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IpTI6R5gIa513KdYKZRdnoB4fIYYgLQlOOLrq0Np6fJUnfud3eUg7Ju5hNo3curE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.185.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.185.0/index.min.mjs": "sha384-IpTI6R5gIa513KdYKZRdnoB4fIYYgLQlOOLrq0Np6fJUnfud3eUg7Ju5hNo3curE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.185.0/LICENSE
```
