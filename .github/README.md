...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.891.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.891.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+iCm3fqsrGJsFe7mcsS7dxAAfvAvegmngdLh+WLpbP9DcSnD7bUroZmqT2Bat9zc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.891.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.891.0/index.min.mjs": "sha384-+iCm3fqsrGJsFe7mcsS7dxAAfvAvegmngdLh+WLpbP9DcSnD7bUroZmqT2Bat9zc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.891.0/LICENSE
```
