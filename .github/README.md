...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.981.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.981.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dMufge2HNHNbHg0yFhR5Xh8LhmBgcy2x77mDBs8a2mplG8/nIc0uAYIGDYdepDm5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.981.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.981.0/index.min.mjs": "sha384-dMufge2HNHNbHg0yFhR5Xh8LhmBgcy2x77mDBs8a2mplG8/nIc0uAYIGDYdepDm5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.981.0/LICENSE
```
