...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-agXAd2CMDGm451o5ZPZ2YvPx5P4IeEhw9HEvVZEvVVT9GOr3peDsUDJkwOlsDCCE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.241.0/index.min.mjs": "sha384-agXAd2CMDGm451o5ZPZ2YvPx5P4IeEhw9HEvVZEvVVT9GOr3peDsUDJkwOlsDCCE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.241.0/LICENSE
```
