...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.523.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.523.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4g1QekQWJ3wSRB9SUe5OGDK5nTRitfGKeSQi1UN4p+BMxdpZ/jCT4sXiFiJ9X8JK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.523.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.523.0/index.min.mjs": "sha384-4g1QekQWJ3wSRB9SUe5OGDK5nTRitfGKeSQi1UN4p+BMxdpZ/jCT4sXiFiJ9X8JK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.523.0/LICENSE
```
