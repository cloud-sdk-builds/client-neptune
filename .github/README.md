...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.980.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.980.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6QO+1gAzt9cTz0J+ExDwONh6gg8Rlw9A4ziRd1Y1qOP0u3uei9SpVj+E+ORBjjkm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.980.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.980.0/index.min.mjs": "sha384-6QO+1gAzt9cTz0J+ExDwONh6gg8Rlw9A4ziRd1Y1qOP0u3uei9SpVj+E+ORBjjkm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.980.0/LICENSE
```
