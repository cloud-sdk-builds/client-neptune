...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.435.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.435.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Mdzfn6qsdwaRSPHKmqVeNRJ3EBELJPCeysEclgcKsKy8sA14ctm6R5aZu/4HD2Hh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.435.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.435.0/index.min.mjs": "sha384-Mdzfn6qsdwaRSPHKmqVeNRJ3EBELJPCeysEclgcKsKy8sA14ctm6R5aZu/4HD2Hh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.435.0/LICENSE
```
