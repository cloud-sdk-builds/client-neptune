...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.49.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.49.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RqFXPIlUEc4XMAzwBLzWzSzeDOzl+Sd7Sz8UR11phbxeMqW9e8bm0YggwPnV3SaU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.49.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.49.0/index.min.mjs": "sha384-RqFXPIlUEc4XMAzwBLzWzSzeDOzl+Sd7Sz8UR11phbxeMqW9e8bm0YggwPnV3SaU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.49.0/LICENSE
```
