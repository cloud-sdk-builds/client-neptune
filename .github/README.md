...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.121.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.121.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eUq24zed5EKbBeKeMxM+buCiRaoFyj2L9LWqay5EiK5EbVktZQu5hA77AwCg+3S/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.121.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.121.0/index.min.mjs": "sha384-eUq24zed5EKbBeKeMxM+buCiRaoFyj2L9LWqay5EiK5EbVktZQu5hA77AwCg+3S/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.121.0/LICENSE
```
