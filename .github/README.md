...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.38.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.38.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wal6/H82He2ZX2aH5FzrjONxggBcto1zCnrlC/s3hJK7xi193orZHeD0+QIjAOlk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.38.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.38.0/index.min.mjs": "sha384-wal6/H82He2ZX2aH5FzrjONxggBcto1zCnrlC/s3hJK7xi193orZHeD0+QIjAOlk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.38.0/LICENSE
```
