...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.414.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.414.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Izvs2u9iGH3XWl4ccmwdPMeOGVIH+HB/DQa7R0/cuXZI/CLEYn3w243fGvffAv6G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.414.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.414.0/index.min.mjs": "sha384-Izvs2u9iGH3XWl4ccmwdPMeOGVIH+HB/DQa7R0/cuXZI/CLEYn3w243fGvffAv6G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.414.0/LICENSE
```
