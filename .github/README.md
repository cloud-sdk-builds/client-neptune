...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.222.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.222.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uHkESqygGIuMM2DJEx0zLLkGX963VVsUbRRNFki9sCSORaWHLHn8c9VhaDO61MAE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.222.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.222.0/index.min.mjs": "sha384-uHkESqygGIuMM2DJEx0zLLkGX963VVsUbRRNFki9sCSORaWHLHn8c9VhaDO61MAE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.222.0/LICENSE
```
