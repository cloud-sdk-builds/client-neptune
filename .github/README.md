...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.896.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.896.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RdT6wt5L6K33Qe9Lb9BhHr1k1nUAYZNHXFHjm9GwNrkiaBY/EnXC1Jket0IjC5dN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.896.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.896.0/index.min.mjs": "sha384-RdT6wt5L6K33Qe9Lb9BhHr1k1nUAYZNHXFHjm9GwNrkiaBY/EnXC1Jket0IjC5dN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.896.0/LICENSE
```
