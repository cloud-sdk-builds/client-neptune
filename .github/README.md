...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.252.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.252.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Zt9hqyVieRvNPL+aMtr+SW2nwvwFmGQTASJNVeDvjvVlAjx+Gul8+JXnn/nVmDCz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.252.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.252.0/index.min.mjs": "sha384-Zt9hqyVieRvNPL+aMtr+SW2nwvwFmGQTASJNVeDvjvVlAjx+Gul8+JXnn/nVmDCz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.252.0/LICENSE
```
