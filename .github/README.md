...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.281.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.281.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qwVjN5f3HFVOlNiaJiAkyVjOIG7rA+NX9eanLic3pZhlo/Exy/+X4MJJldKkVLJX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.281.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.281.0/index.min.mjs": "sha384-qwVjN5f3HFVOlNiaJiAkyVjOIG7rA+NX9eanLic3pZhlo/Exy/+X4MJJldKkVLJX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.281.0/LICENSE
```
