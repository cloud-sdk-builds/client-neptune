...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.109.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.109.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Nw/KF2NntHhru2ITOz2wEO1sJ3TzkziGMy2PJ0xTAfNqOApSuUy1LJ+rfxDSl8Yb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.109.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.109.0/index.min.mjs": "sha384-Nw/KF2NntHhru2ITOz2wEO1sJ3TzkziGMy2PJ0xTAfNqOApSuUy1LJ+rfxDSl8Yb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.109.0/LICENSE
```
