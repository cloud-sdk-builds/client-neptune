...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.927.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.927.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-67pCKp4GyE3hIubPsDadK3dZb1+2QzBvoeg3Nq+UJZuNo8Q6xgDJo1fhWoYZLWgZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.927.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.927.0/index.min.mjs": "sha384-67pCKp4GyE3hIubPsDadK3dZb1+2QzBvoeg3Nq+UJZuNo8Q6xgDJo1fhWoYZLWgZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.927.0/LICENSE
```
