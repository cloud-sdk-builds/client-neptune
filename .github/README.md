...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.278.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.278.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n6JOxlxKdP/SIDNTIArP8tmhR8goqqLDGeKvy1VMjts2bGo2wi2j5NUlDMygHiBw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.278.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.278.0/index.min.mjs": "sha384-n6JOxlxKdP/SIDNTIArP8tmhR8goqqLDGeKvy1VMjts2bGo2wi2j5NUlDMygHiBw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.278.0/LICENSE
```
