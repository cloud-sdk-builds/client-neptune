...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.315.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.315.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xlMbumRR5SwORYzR5yNYY0z93XMPi5inc3IV4tLFur3dAhQGrgoY07Z5fHHVPSRy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.315.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.315.0/index.min.mjs": "sha384-xlMbumRR5SwORYzR5yNYY0z93XMPi5inc3IV4tLFur3dAhQGrgoY07Z5fHHVPSRy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.315.0/LICENSE
```
