...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.465.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.465.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NTc3A2q2TEu1s2giZZOgXYm6uu/pFtzIn5pcIBU6wusregLlqcIQgm67bP+kx58Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.465.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.465.0/index.min.mjs": "sha384-NTc3A2q2TEu1s2giZZOgXYm6uu/pFtzIn5pcIBU6wusregLlqcIQgm67bP+kx58Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.465.0/LICENSE
```
