...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.799.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.799.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TO+0zBT/Ly4ok+SZ1fkhCCOYE6NlbiOdN3pOiJiQwvomDPpHJcK6CaI1unLqjk0m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.799.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.799.0/index.min.mjs": "sha384-TO+0zBT/Ly4ok+SZ1fkhCCOYE6NlbiOdN3pOiJiQwvomDPpHJcK6CaI1unLqjk0m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.799.0/LICENSE
```
