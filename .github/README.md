...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.321.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.321.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-tPICxn0XtGno09ee/a2C1lmODou+7wEjJTUUlVVQ2yE90VN7I7kWLnGBw7QDLS9f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.321.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.321.1/index.min.mjs": "sha384-tPICxn0XtGno09ee/a2C1lmODou+7wEjJTUUlVVQ2yE90VN7I7kWLnGBw7QDLS9f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.321.1/LICENSE
```
