...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.888.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.888.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0HxtXb5VkM0awShRXp3lqhSU4mZCFiB3JTDjpe5pAeTYOe65frLL5Z0cZtjt1eJz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.888.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.888.0/index.min.mjs": "sha384-0HxtXb5VkM0awShRXp3lqhSU4mZCFiB3JTDjpe5pAeTYOe65frLL5Z0cZtjt1eJz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.888.0/LICENSE
```
