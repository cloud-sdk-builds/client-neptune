...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.743.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.743.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N3SaJoEj8tgpH2Whd85O1hquv7QecQwUC4wEGpyYqv1rWecWlUV6a2ABdeVvHSQk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.743.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.743.0/index.min.mjs": "sha384-N3SaJoEj8tgpH2Whd85O1hquv7QecQwUC4wEGpyYqv1rWecWlUV6a2ABdeVvHSQk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.743.0/LICENSE
```
