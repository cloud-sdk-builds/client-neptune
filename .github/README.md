...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.22.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.22.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-b/M2jOd9cNekeH3xUX0eAOzw97ac3Hr97zKFovwpnDfja6fbKdj9aZ/Hbhfr7aPW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.22.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.22.0/index.min.mjs": "sha384-b/M2jOd9cNekeH3xUX0eAOzw97ac3Hr97zKFovwpnDfja6fbKdj9aZ/Hbhfr7aPW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.22.0/LICENSE
```
