...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.668.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.668.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fwEXWnIz0m0z/DdesCza1o6G+ccnDVL8wbamuprL03XvwCKwcMDuZmZUFljuEVWg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.668.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.668.0/index.min.mjs": "sha384-fwEXWnIz0m0z/DdesCza1o6G+ccnDVL8wbamuprL03XvwCKwcMDuZmZUFljuEVWg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.668.0/LICENSE
```
