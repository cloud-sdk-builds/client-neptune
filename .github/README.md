...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.78.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.78.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7u6b/fUkhWaEAjwcltXJCq6nWNYuv98mB1PhOiyb40VIFVrHrN9NHEIFBosQ+xMW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.78.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.78.0/index.min.mjs": "sha384-7u6b/fUkhWaEAjwcltXJCq6nWNYuv98mB1PhOiyb40VIFVrHrN9NHEIFBosQ+xMW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.78.0/LICENSE
```
