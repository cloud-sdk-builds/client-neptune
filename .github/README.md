...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.556.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.556.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+YLNz7JtC9Mk3SjXl6/VyGSwsfsHDgwrsVd1/KPKllsi4OMCNg/LRTUf4qG2qzkr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.556.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.556.0/index.min.mjs": "sha384-+YLNz7JtC9Mk3SjXl6/VyGSwsfsHDgwrsVd1/KPKllsi4OMCNg/LRTUf4qG2qzkr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.556.0/LICENSE
```
