...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.687.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.687.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0x0UgdtcyVsAOg3mGQAG0nc8TupuzmB+q23RzV23NhR/pdP/h9NTIC2bG7PcU6yO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.687.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.687.0/index.min.mjs": "sha384-0x0UgdtcyVsAOg3mGQAG0nc8TupuzmB+q23RzV23NhR/pdP/h9NTIC2bG7PcU6yO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.687.0/LICENSE
```
