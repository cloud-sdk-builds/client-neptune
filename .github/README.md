...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.312.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.312.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eopoaFba5uLwOKTP4r1Lrz46OcjRt17LAn8Nnss2yzP2y4PwD6oppYqOteHLAjEi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.312.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.312.0/index.min.mjs": "sha384-eopoaFba5uLwOKTP4r1Lrz46OcjRt17LAn8Nnss2yzP2y4PwD6oppYqOteHLAjEi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.312.0/LICENSE
```
