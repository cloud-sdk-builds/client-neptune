...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.947.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.947.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cf5AL92nqYFYGf3zvMALqqKYvn3aiaFyW6QYEjhF3djY2U5YOxFYS/AFU7zquYYQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.947.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.947.0/index.min.mjs": "sha384-cf5AL92nqYFYGf3zvMALqqKYvn3aiaFyW6QYEjhF3djY2U5YOxFYS/AFU7zquYYQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.947.0/LICENSE
```
