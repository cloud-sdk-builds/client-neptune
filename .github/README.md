...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.329.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.329.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g7e//B87oC0lsAIHzi+5Iag+HvdV1PYvTwLuORsYiqnFmyOWYI772v6IACCBpcKx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.329.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.329.0/index.min.mjs": "sha384-g7e//B87oC0lsAIHzi+5Iag+HvdV1PYvTwLuORsYiqnFmyOWYI772v6IACCBpcKx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.329.0/LICENSE
```
