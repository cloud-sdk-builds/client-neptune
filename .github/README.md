...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.787.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.787.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I4qOrLXIAZfhIxGC4Mse7+Z71yesexClzP4fsuvVt8foqpbX5034cWDKIxvWZWEk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.787.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.787.0/index.min.mjs": "sha384-I4qOrLXIAZfhIxGC4Mse7+Z71yesexClzP4fsuvVt8foqpbX5034cWDKIxvWZWEk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.787.0/LICENSE
```
