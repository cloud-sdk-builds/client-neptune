...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.484.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.484.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EQkCITyyzJyhdYiCOdyf7/FWKIzaoq9y7RUNk9KOxQ0+w0FOQ0aBV0SPafmY4iDX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.484.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.484.0/index.min.mjs": "sha384-EQkCITyyzJyhdYiCOdyf7/FWKIzaoq9y7RUNk9KOxQ0+w0FOQ0aBV0SPafmY4iDX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.484.0/LICENSE
```
