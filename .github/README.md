...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.363.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.363.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5x19PEl30gpKxhC2JyveKEu4vvtC5TfjRIJ99N2eF9nqdNvbA6fTe9+i8/Mo/m7x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.363.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.363.0/index.min.mjs": "sha384-5x19PEl30gpKxhC2JyveKEu4vvtC5TfjRIJ99N2eF9nqdNvbA6fTe9+i8/Mo/m7x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.363.0/LICENSE
```
