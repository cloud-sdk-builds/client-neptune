...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.921.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.921.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NjB4MbsdroK0v+zgIOmeBeQhT3ChMG2OulYlx0jQfkFyVOIkw5bVz1U7KdEDT7MK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.921.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.921.0/index.min.mjs": "sha384-NjB4MbsdroK0v+zgIOmeBeQhT3ChMG2OulYlx0jQfkFyVOIkw5bVz1U7KdEDT7MK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.921.0/LICENSE
```
