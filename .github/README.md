...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.911.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.911.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-E3tM2DUpkryHt8iBKqxBL9ntiOGrQWUPJolPYCqRZ4ARcedAlQdRKNrQwldPaoIu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.911.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.911.0/index.min.mjs": "sha384-E3tM2DUpkryHt8iBKqxBL9ntiOGrQWUPJolPYCqRZ4ARcedAlQdRKNrQwldPaoIu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.911.0/LICENSE
```
