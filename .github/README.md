...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1012.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1012.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bym9qrwl0SGCfMdBvuqUIpfm+29UrlYuGuYTi/ZEv1YpRfZP7dLCGc3zrtNGHVJa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1012.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1012.0/index.min.mjs": "sha384-bym9qrwl0SGCfMdBvuqUIpfm+29UrlYuGuYTi/ZEv1YpRfZP7dLCGc3zrtNGHVJa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1012.0/LICENSE
```
