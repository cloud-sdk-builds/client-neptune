...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.750.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.750.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oiAktYNRroJO8LnSBQLhfuyYni78CO4YCGu56BRND5PtoOxIDa2x/74Dzq//X0m1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.750.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.750.0/index.min.mjs": "sha384-oiAktYNRroJO8LnSBQLhfuyYni78CO4YCGu56BRND5PtoOxIDa2x/74Dzq//X0m1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.750.0/LICENSE
```
