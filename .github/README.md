...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.92.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.92.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qJajf3qVvB8B1PtjnSxA8e+uU971/d6Cibta6y/TesDaalOFcVXoUV7Isq1sz5VT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.92.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.92.0/index.min.mjs": "sha384-qJajf3qVvB8B1PtjnSxA8e+uU971/d6Cibta6y/TesDaalOFcVXoUV7Isq1sz5VT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.92.0/LICENSE
```
