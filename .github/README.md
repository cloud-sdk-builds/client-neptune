...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.55.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.55.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sFUBbGZps01T9Na6l3+KG0WOOKNKv5rt2mYrB6GrHfYBq18juwiP2bWcs5UKtQpM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.55.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.55.0/index.min.mjs": "sha384-sFUBbGZps01T9Na6l3+KG0WOOKNKv5rt2mYrB6GrHfYBq18juwiP2bWcs5UKtQpM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.55.0/LICENSE
```
