...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.4.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.4.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-U1rMjh1+L22MQXm08YiycZAZF7iGX0f08Va6KSs5pvZSQTKdlDAFY2JmtReP38Qp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.4.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.4.1/index.min.mjs": "sha384-U1rMjh1+L22MQXm08YiycZAZF7iGX0f08Va6KSs5pvZSQTKdlDAFY2JmtReP38Qp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.4.1/LICENSE
```
