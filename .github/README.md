...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.972.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.972.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PYD9TC+CkYmDlIx+Rbv3jGsZKJ7NA3bwnX//gN1hWwpRdz3zJ8pLfwTIUokLzVXL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.972.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.972.0/index.min.mjs": "sha384-PYD9TC+CkYmDlIx+Rbv3jGsZKJ7NA3bwnX//gN1hWwpRdz3zJ8pLfwTIUokLzVXL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.972.0/LICENSE
```
