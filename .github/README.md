...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.983.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.983.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ROzbtq60mn4zpsreJz/k2B49oWhek/f0r3fpyuLjJejWpvI8SbQkUdT6YI+qXBSS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.983.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.983.0/index.min.mjs": "sha384-ROzbtq60mn4zpsreJz/k2B49oWhek/f0r3fpyuLjJejWpvI8SbQkUdT6YI+qXBSS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.983.0/LICENSE
```
