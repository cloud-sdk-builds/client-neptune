...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.913.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.913.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Hs2CKQZ4ik9EREtiXOfTF8O42kQA/juKFT16Rah7pY9h2SnxAWjuxZEplCmAHaBx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.913.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.913.0/index.min.mjs": "sha384-Hs2CKQZ4ik9EREtiXOfTF8O42kQA/juKFT16Rah7pY9h2SnxAWjuxZEplCmAHaBx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.913.0/LICENSE
```
