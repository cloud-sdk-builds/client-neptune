...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.901.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.901.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c5hvKam6xBnG4m6tLhu2bm6dcszh8Uh8ArN9b6eS+lNzA4iVTp4Bu0Rvfa4eNQpu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.901.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.901.0/index.min.mjs": "sha384-c5hvKam6xBnG4m6tLhu2bm6dcszh8Uh8ArN9b6eS+lNzA4iVTp4Bu0Rvfa4eNQpu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.901.0/LICENSE
```
