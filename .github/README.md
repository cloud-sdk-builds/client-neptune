...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.14.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.14.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bmIF+TmeWBjZPJLZe1gw2KBSxvBwrS5Z8skGBwqG+2zKX7mG9g5CFblzHQjjAacr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.14.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.14.0/index.min.mjs": "sha384-bmIF+TmeWBjZPJLZe1gw2KBSxvBwrS5Z8skGBwqG+2zKX7mG9g5CFblzHQjjAacr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.14.0/LICENSE
```
