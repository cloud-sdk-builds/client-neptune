...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.198.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.198.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JA2dZ74EThb9oM74vjjFo93vDTnnw42hQ+9EkvqYAMwhwGHfp+XErBo7Lbs64PmS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.198.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.198.0/index.min.mjs": "sha384-JA2dZ74EThb9oM74vjjFo93vDTnnw42hQ+9EkvqYAMwhwGHfp+XErBo7Lbs64PmS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.198.0/LICENSE
```
