...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.309.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.309.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i0r9FtJvVHlS8h+paEmZNP6Mcq2PEmHsj70VMvW+mvkxraUX/WA2CejwRBmGtIKJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.309.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.309.0/index.min.mjs": "sha384-i0r9FtJvVHlS8h+paEmZNP6Mcq2PEmHsj70VMvW+mvkxraUX/WA2CejwRBmGtIKJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.309.0/LICENSE
```
