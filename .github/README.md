...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.744.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.744.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-az5M4rEIcOKGpxsV8bnFMuob4jD/sWlAhF+dDT9VT9SyOsN2gj6kxjmemqnaRz80
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.744.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.744.0/index.min.mjs": "sha384-az5M4rEIcOKGpxsV8bnFMuob4jD/sWlAhF+dDT9VT9SyOsN2gj6kxjmemqnaRz80"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.744.0/LICENSE
```
