...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.873.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.873.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H20+CRUa7W6qV9YJfHBkO0mldHlGqBIRVaPK23n39qRp9rMesz9xfzcSbUkOevMO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.873.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.873.0/index.min.mjs": "sha384-H20+CRUa7W6qV9YJfHBkO0mldHlGqBIRVaPK23n39qRp9rMesz9xfzcSbUkOevMO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.873.0/LICENSE
```
