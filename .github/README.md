...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1036.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1036.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V+3uKxUMwXHAQaXD4Yv3Ocv2x8x+Kam1Q/SysgkWWbSca5UW0Z+kiZupkOni9Ae5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1036.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1036.0/index.min.mjs": "sha384-V+3uKxUMwXHAQaXD4Yv3Ocv2x8x+Kam1Q/SysgkWWbSca5UW0Z+kiZupkOni9Ae5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1036.0/LICENSE
```
