...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.462.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.462.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oHqKb1aM7gUc5UZSiU0E2z69TLIFUkd6fqy7tU1Fe3rxBshVBa1rZlpoL3BEdZJx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.462.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.462.0/index.min.mjs": "sha384-oHqKb1aM7gUc5UZSiU0E2z69TLIFUkd6fqy7tU1Fe3rxBshVBa1rZlpoL3BEdZJx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.462.0/LICENSE
```
