...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.926.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.926.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tnMoVrhFQNx2AhkcPuUFHWRmgf3LwG1S/u3QAs0h8jz3flWI08BWTrpZ/Ty7i0ov
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.926.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.926.0/index.min.mjs": "sha384-tnMoVrhFQNx2AhkcPuUFHWRmgf3LwG1S/u3QAs0h8jz3flWI08BWTrpZ/Ty7i0ov"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.926.0/LICENSE
```
