...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.42.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.42.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VarmUx0JLpQkdwn1mt5l7JpbZ38O6y3h5j7pTWXIyNCha6AmMyRt4CummP0FCuT0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.42.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.42.0/index.min.mjs": "sha384-VarmUx0JLpQkdwn1mt5l7JpbZ38O6y3h5j7pTWXIyNCha6AmMyRt4CummP0FCuT0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.42.0/LICENSE
```
