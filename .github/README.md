...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.405.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.405.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/GhJx0+VjUmu7q04JHkxp461mt6817pEtstsJCxKd1IHmp7SwiUTTJGAHiXCaN93
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.405.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.405.0/index.min.mjs": "sha384-/GhJx0+VjUmu7q04JHkxp461mt6817pEtstsJCxKd1IHmp7SwiUTTJGAHiXCaN93"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.405.0/LICENSE
```
