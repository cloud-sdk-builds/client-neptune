...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.301.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.301.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JvgAP27FWpCBqExyo1NS4LURGdGnikgNXZLwvxXhlArft2zN6+90Ga3s82vhf9aa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.301.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.301.0/index.min.mjs": "sha384-JvgAP27FWpCBqExyo1NS4LURGdGnikgNXZLwvxXhlArft2zN6+90Ga3s82vhf9aa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.301.0/LICENSE
```
