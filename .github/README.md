...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.667.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.667.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yIU3U+EDh7omw9OhvxetubI9+uYgxdWj5X+MgWmgTq6Y77gEC/jOHPEbtndJ4cZd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.667.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.667.0/index.min.mjs": "sha384-yIU3U+EDh7omw9OhvxetubI9+uYgxdWj5X+MgWmgTq6Y77gEC/jOHPEbtndJ4cZd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.667.0/LICENSE
```
