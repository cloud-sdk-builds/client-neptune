...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1031.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1031.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M8z6O/JfbRqAk/DKEfgqIgOtU+ArPehkqcLxZdlSneSsYJvGnuKfgQa2vIA7bxjO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1031.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1031.0/index.min.mjs": "sha384-M8z6O/JfbRqAk/DKEfgqIgOtU+ArPehkqcLxZdlSneSsYJvGnuKfgQa2vIA7bxjO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1031.0/LICENSE
```
