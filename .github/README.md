...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.131.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.131.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-60baztt11oB+KXyJLmbnHSVz2Zc83ZjJiulRO0u/fpVxMsgc7u2LgTM1ERwbS9Cr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.131.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.131.0/index.min.mjs": "sha384-60baztt11oB+KXyJLmbnHSVz2Zc83ZjJiulRO0u/fpVxMsgc7u2LgTM1ERwbS9Cr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.131.0/LICENSE
```
