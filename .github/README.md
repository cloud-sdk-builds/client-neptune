...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.34.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.34.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZVFMbql7NJXijKQKeA9rUf6dNmmP7RKx6fxgUx78YxqMPjVGA9RXz2sY6VzDLWFi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.34.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.34.0/index.min.mjs": "sha384-ZVFMbql7NJXijKQKeA9rUf6dNmmP7RKx6fxgUx78YxqMPjVGA9RXz2sY6VzDLWFi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.34.0/LICENSE
```
