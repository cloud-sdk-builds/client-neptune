...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.338.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.338.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-58W96x07KqVUYBFEqf7JEziyavHjmYezAkxvo2s8bwwQf+9RNn5pjyk+r5JfFKC/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.338.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.338.0/index.min.mjs": "sha384-58W96x07KqVUYBFEqf7JEziyavHjmYezAkxvo2s8bwwQf+9RNn5pjyk+r5JfFKC/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.338.0/LICENSE
```
