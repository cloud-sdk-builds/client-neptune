...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.352.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.352.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ss4oEQIJDd1TLbotZokUantl+cwMKpnxrajnnqoDYee4ARqDX/p05UVtYzN7d2np
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.352.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.352.0/index.min.mjs": "sha384-ss4oEQIJDd1TLbotZokUantl+cwMKpnxrajnnqoDYee4ARqDX/p05UVtYzN7d2np"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.352.0/LICENSE
```
