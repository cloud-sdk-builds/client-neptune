...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.946.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.946.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FGmI2bsDPnU/MI9B6kaZU86eKbWI/jMTCgV9sBrhtfgftw3U4Nqf4vmZ42JOzM4y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.946.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.946.0/index.min.mjs": "sha384-FGmI2bsDPnU/MI9B6kaZU86eKbWI/jMTCgV9sBrhtfgftw3U4Nqf4vmZ42JOzM4y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.946.0/LICENSE
```
