...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.353.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.353.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-E3GS9y1COwaOStpjaMyZ3mggmfF2ThbQzGxTvIrMRTHgjayL/KH4YKPyA9g6U4a8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.353.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.353.0/index.min.mjs": "sha384-E3GS9y1COwaOStpjaMyZ3mggmfF2ThbQzGxTvIrMRTHgjayL/KH4YKPyA9g6U4a8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.353.0/LICENSE
```
