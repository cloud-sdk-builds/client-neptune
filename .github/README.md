...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.99.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.99.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w/BCCMfo9q0gZlDidEypevfDrcUXsJOFLGzK7epvNrZo1WMdum6DXYCsYBdOOyU3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.99.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.99.0/index.min.mjs": "sha384-w/BCCMfo9q0gZlDidEypevfDrcUXsJOFLGzK7epvNrZo1WMdum6DXYCsYBdOOyU3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.99.0/LICENSE
```
