...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.994.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.994.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jp1nHHRi8s2APnhseQP1xKI6/E2ZTHx5SpHf1qwDEMKgZUWZpAUmsVf6R0KcQQYn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.994.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.994.0/index.min.mjs": "sha384-jp1nHHRi8s2APnhseQP1xKI6/E2ZTHx5SpHf1qwDEMKgZUWZpAUmsVf6R0KcQQYn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.994.0/LICENSE
```
