...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.112.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.112.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Rl98Cmqc8BGi5okRHTdFU1jhiITJoquKVs2ms/L+whG5SCFfKWX7tAmos/SXelFY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.112.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.112.0/index.min.mjs": "sha384-Rl98Cmqc8BGi5okRHTdFU1jhiITJoquKVs2ms/L+whG5SCFfKWX7tAmos/SXelFY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.112.0/LICENSE
```
