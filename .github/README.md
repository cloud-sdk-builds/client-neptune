...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.33.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.33.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-88s2ZvMh266V0EubB+oPgU8P+Pqmgk0BDvK5+ndAfRes81WGRfkha8VHwJLoDffx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.33.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.33.0/index.min.mjs": "sha384-88s2ZvMh266V0EubB+oPgU8P+Pqmgk0BDvK5+ndAfRes81WGRfkha8VHwJLoDffx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.33.0/LICENSE
```
