...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.914.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.914.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ma8UqPjL8d0WBGecAb7dVtggdlJaDzx8yApheyO+rHXObpIcMwAN6Wfe7XVa4Zt/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.914.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.914.0/index.min.mjs": "sha384-Ma8UqPjL8d0WBGecAb7dVtggdlJaDzx8yApheyO+rHXObpIcMwAN6Wfe7XVa4Zt/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.914.0/LICENSE
```
