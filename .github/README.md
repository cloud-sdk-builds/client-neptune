...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.209.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.209.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BSr7OPO8LkIj+zDt/cOl5Cc9Bv5muLdWmsMLg4XLjt/gsFb4O+xFqyuKG+kfQ9l9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.209.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.209.0/index.min.mjs": "sha384-BSr7OPO8LkIj+zDt/cOl5Cc9Bv5muLdWmsMLg4XLjt/gsFb4O+xFqyuKG+kfQ9l9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.209.0/LICENSE
```
