...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.388.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.388.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OthGGkbpvLUiHbVN+fyfA7aTvUknsPKZce26x3ym7YoNsK48+C0E2YZlKCqOTgLu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.388.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.388.0/index.min.mjs": "sha384-OthGGkbpvLUiHbVN+fyfA7aTvUknsPKZce26x3ym7YoNsK48+C0E2YZlKCqOTgLu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.388.0/LICENSE
```
