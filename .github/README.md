...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.165.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.165.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ck5PH8GG90LS17f5WS0teJj+diEUU/I+xVXsvtKCJmuMy/lugfsY1V7lKXVhr4FX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.165.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.165.0/index.min.mjs": "sha384-ck5PH8GG90LS17f5WS0teJj+diEUU/I+xVXsvtKCJmuMy/lugfsY1V7lKXVhr4FX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.165.0/LICENSE
```
