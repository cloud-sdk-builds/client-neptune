...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.423.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.423.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6NjehshEYhmq8E7IXIukDWzBmAUX0FsNjUKaHCFXE6WWjMP8Uge78FnR3MItDH2C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.423.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.423.0/index.min.mjs": "sha384-6NjehshEYhmq8E7IXIukDWzBmAUX0FsNjUKaHCFXE6WWjMP8Uge78FnR3MItDH2C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.423.0/LICENSE
```
