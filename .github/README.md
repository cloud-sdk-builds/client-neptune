...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.576.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.576.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aY8YARt5sdcGJWOR606WQMgNc1kxa4e/ZEgPJns1cOuWaDJZKEDesvSGqP+rtFNG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.576.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.576.0/index.min.mjs": "sha384-aY8YARt5sdcGJWOR606WQMgNc1kxa4e/ZEgPJns1cOuWaDJZKEDesvSGqP+rtFNG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.576.0/LICENSE
```
