...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.10.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.10.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TeDMNbhIINnkqw+oAdV5+j9H8pi8N/X0rUzWNPrSP2BKCAcm4fenirNAzH8v4e6k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.10.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.10.0/index.min.mjs": "sha384-TeDMNbhIINnkqw+oAdV5+j9H8pi8N/X0rUzWNPrSP2BKCAcm4fenirNAzH8v4e6k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.10.0/LICENSE
```
