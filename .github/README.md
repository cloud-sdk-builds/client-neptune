...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.204.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.204.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QVd46Bz63cIrxHrEtdK6i4dz7m+s1UQ7FGJu93im3sDsXyLgGGHj3tBpPqd0LEPb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.204.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.204.0/index.min.mjs": "sha384-QVd46Bz63cIrxHrEtdK6i4dz7m+s1UQ7FGJu93im3sDsXyLgGGHj3tBpPqd0LEPb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.204.0/LICENSE
```
