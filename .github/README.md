...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.20.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.20.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3azD9qDlYsUQqUltbM9Zrhc370wdfCU21S32fQZvvEFddVEDkjxutHZzBn0/SBf/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.20.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.20.0/index.min.mjs": "sha384-3azD9qDlYsUQqUltbM9Zrhc370wdfCU21S32fQZvvEFddVEDkjxutHZzBn0/SBf/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.20.0/LICENSE
```
