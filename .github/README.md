...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.606.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.606.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OexVIt7fDkBsk+V3ZEfPS2/hoKTrjypyOwANwFik2ggVqvNQuxHGc/JBciTN2f7B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.606.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.606.0/index.min.mjs": "sha384-OexVIt7fDkBsk+V3ZEfPS2/hoKTrjypyOwANwFik2ggVqvNQuxHGc/JBciTN2f7B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.606.0/LICENSE
```
