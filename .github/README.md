...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.194.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.194.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5A0fjtl1HXIA6P+UvSgYSVlJZ/dzbMqIA2C8xFkwK1pTuAqYXnJf203HSYWG5s3O
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.194.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.194.0/index.min.mjs": "sha384-5A0fjtl1HXIA6P+UvSgYSVlJZ/dzbMqIA2C8xFkwK1pTuAqYXnJf203HSYWG5s3O"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.194.0/LICENSE
```
