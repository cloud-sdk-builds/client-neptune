...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.40.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.40.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-epQh73iM2KiOaUalfvLHT2QSOwqRkXabdmdCfyuqyeG7/p185lrYzr/VJmTz67u9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.40.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.40.0/index.min.mjs": "sha384-epQh73iM2KiOaUalfvLHT2QSOwqRkXabdmdCfyuqyeG7/p185lrYzr/VJmTz67u9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.40.0/LICENSE
```
