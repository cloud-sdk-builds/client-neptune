...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.306.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.306.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d7Pbbw9oY/4WAg/hmLfHotDzPbldEBn12t/VtdCKXEw7pJ0cdNheor2AeDM9NxU5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.306.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.306.0/index.min.mjs": "sha384-d7Pbbw9oY/4WAg/hmLfHotDzPbldEBn12t/VtdCKXEw7pJ0cdNheor2AeDM9NxU5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.306.0/LICENSE
```
