...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1006.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1006.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FWFPOzYWbu+DkES7OLlcjbX9/NsgzxgO5wGLka4eDIXkN1pXTLHS4qgLlz1yBNJq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1006.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1006.0/index.min.mjs": "sha384-FWFPOzYWbu+DkES7OLlcjbX9/NsgzxgO5wGLka4eDIXkN1pXTLHS4qgLlz1yBNJq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1006.0/LICENSE
```
