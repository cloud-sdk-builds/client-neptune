...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.94.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.94.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-73wY1lz/Tq0ds67T5uPh0VeHbGSPMQk+p8mdgl+dXfnrSjbJPq250WBC7eAiFoR/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.94.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.94.0/index.min.mjs": "sha384-73wY1lz/Tq0ds67T5uPh0VeHbGSPMQk+p8mdgl+dXfnrSjbJPq250WBC7eAiFoR/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.94.0/LICENSE
```
