...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.347.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.347.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8OOSGPNTuhhhDqFZVEMdIN9n+Q4ukYgFmHeoNIi6aCWfnWaxskZ/4t2Q4FBYD/yJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.347.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.347.0/index.min.mjs": "sha384-8OOSGPNTuhhhDqFZVEMdIN9n+Q4ukYgFmHeoNIi6aCWfnWaxskZ/4t2Q4FBYD/yJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.347.0/LICENSE
```
