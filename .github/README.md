...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1014.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1014.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a0d6rr0KxUrKkZ3JS+gL49S2WDagOY42FeUaz9K3apHuBNULnH0B74VJvPmoG7Y7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1014.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1014.0/index.min.mjs": "sha384-a0d6rr0KxUrKkZ3JS+gL49S2WDagOY42FeUaz9K3apHuBNULnH0B74VJvPmoG7Y7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1014.0/LICENSE
```
