...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.964.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.964.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jIh0JbDk4+6KEC2XH9Q5WFmTAJYBL68hzLQgfNfqbxzsdnw5qEiP1wvmE8HWbHyB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.964.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.964.0/index.min.mjs": "sha384-jIh0JbDk4+6KEC2XH9Q5WFmTAJYBL68hzLQgfNfqbxzsdnw5qEiP1wvmE8HWbHyB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.964.0/LICENSE
```
