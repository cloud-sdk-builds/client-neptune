...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1007.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1007.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/pZbGWvT/7eF3R84uQIwfIMft2yiwoBfpMDJP8cYJjlwWeM7dYapbMFs3VURvt46
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1007.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1007.0/index.min.mjs": "sha384-/pZbGWvT/7eF3R84uQIwfIMft2yiwoBfpMDJP8cYJjlwWeM7dYapbMFs3VURvt46"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1007.0/LICENSE
```
