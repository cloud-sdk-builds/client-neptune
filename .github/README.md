...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.9.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.9.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vb7bcoDAslzkXJsVyHxGCyolKzqD9Ziml5LB4KOWQ2egEIyF9KYT3Ej3JS41fSZK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.9.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.9.0/index.min.mjs": "sha384-vb7bcoDAslzkXJsVyHxGCyolKzqD9Ziml5LB4KOWQ2egEIyF9KYT3Ej3JS41fSZK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.9.0/LICENSE
```
