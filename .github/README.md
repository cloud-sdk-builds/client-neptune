...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.11.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.11.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PpFSUQsVx/B9A0oBrBiGYZmjytZ9b9COHhk500MlEgk3MUwgHERwEkJfztC6VFlL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.11.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.11.0/index.min.mjs": "sha384-PpFSUQsVx/B9A0oBrBiGYZmjytZ9b9COHhk500MlEgk3MUwgHERwEkJfztC6VFlL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.11.0/LICENSE
```
