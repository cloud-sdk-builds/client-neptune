...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.28.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.28.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oZbP+H8RkkGuPmhF/D1gWo+KwwrU6HT9L4UBtiR9xNmHY2Cohrunt1b2iqVvdjNw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.28.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.28.0/index.min.mjs": "sha384-oZbP+H8RkkGuPmhF/D1gWo+KwwrU6HT9L4UBtiR9xNmHY2Cohrunt1b2iqVvdjNw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.28.0/LICENSE
```
