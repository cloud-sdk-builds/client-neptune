...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.39.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.39.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h/4+WxK316fXXi3fTfUfuzuxAlln+NBN+8uDHxQnOE2DT9X1+6oayz4R/01WxEQf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.39.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.39.0/index.min.mjs": "sha384-h/4+WxK316fXXi3fTfUfuzuxAlln+NBN+8uDHxQnOE2DT9X1+6oayz4R/01WxEQf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.39.0/LICENSE
```
