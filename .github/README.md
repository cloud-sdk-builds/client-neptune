...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.654.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.654.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bmOJ2u3yE+KZbkHqvX5s3yJKJJKiqvUVbNwkeSEBJ2rrV8zIgOoJHxGBsf6WEl4B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.654.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.654.0/index.min.mjs": "sha384-bmOJ2u3yE+KZbkHqvX5s3yJKJJKiqvUVbNwkeSEBJ2rrV8zIgOoJHxGBsf6WEl4B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.654.0/LICENSE
```
