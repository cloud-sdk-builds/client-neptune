...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.899.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.899.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JSKwrFKZDiym2uPdCcgsBvVo0mJIXOCBhxl9YlILTXQNDk85nn6/PNkQKT5u7Jpf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.899.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.899.0/index.min.mjs": "sha384-JSKwrFKZDiym2uPdCcgsBvVo0mJIXOCBhxl9YlILTXQNDk85nn6/PNkQKT5u7Jpf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.899.0/LICENSE
```
