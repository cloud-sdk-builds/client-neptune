...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.303.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.303.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lV4fhm6E1ohqgp5wyFIGbWTCL47NVX52045zB9Lq3nJ2YKincTTg0gpZuuIaBAqx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.303.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.303.0/index.min.mjs": "sha384-lV4fhm6E1ohqgp5wyFIGbWTCL47NVX52045zB9Lq3nJ2YKincTTg0gpZuuIaBAqx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.303.0/LICENSE
```
