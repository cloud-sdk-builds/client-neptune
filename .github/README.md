...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.276.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.276.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mRa+A5pyuMnC5ynHbRF3x0p18P+fxuRs75G3waaPx4dwQBN8thzdJUhzzPdWSMTc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.276.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.276.0/index.min.mjs": "sha384-mRa+A5pyuMnC5ynHbRF3x0p18P+fxuRs75G3waaPx4dwQBN8thzdJUhzzPdWSMTc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.276.0/LICENSE
```
