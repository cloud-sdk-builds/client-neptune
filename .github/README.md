...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.24.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.24.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VTwDZt8hSwWTahVeNL1LrrBKJSD5y77736GGB0+2thKlRO2Fbarck/HlJVEZboqJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.24.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.24.0/index.min.mjs": "sha384-VTwDZt8hSwWTahVeNL1LrrBKJSD5y77736GGB0+2thKlRO2Fbarck/HlJVEZboqJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.24.0/LICENSE
```
