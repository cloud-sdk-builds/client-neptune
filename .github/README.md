...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.989.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.989.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6nX+q1FXfftKErrpiq+u2umoIY5/qQtzLmWqXRG92tGBMooFsi17HxaB73c4P/Xx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.989.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.989.0/index.min.mjs": "sha384-6nX+q1FXfftKErrpiq+u2umoIY5/qQtzLmWqXRG92tGBMooFsi17HxaB73c4P/Xx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.989.0/LICENSE
```
