...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1039.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1039.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OVcvmXrP/cv0aR6byb/JAV5gnX0RPFAV8zf6yc2BMbj4EmurMe+wXz2+T/iUNwUP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1039.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1039.0/index.min.mjs": "sha384-OVcvmXrP/cv0aR6byb/JAV5gnX0RPFAV8zf6yc2BMbj4EmurMe+wXz2+T/iUNwUP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1039.0/LICENSE
```
