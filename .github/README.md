...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.986.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.986.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rbTjRZBzwjE2jXP/qJhrDTiuaO62jWCn5K6Cg+Fkda5ptGwBaDFJLYnMQrsyh4pl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.986.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.986.0/index.min.mjs": "sha384-rbTjRZBzwjE2jXP/qJhrDTiuaO62jWCn5K6Cg+Fkda5ptGwBaDFJLYnMQrsyh4pl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.986.0/LICENSE
```
