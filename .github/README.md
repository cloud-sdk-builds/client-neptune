...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.749.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.749.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CoiomPPJOq0M8yM1MFjAneybt0lzN4SWbj+HhJx1jurqHDKfPoJ1uMO/DR13KQNz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.749.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.749.0/index.min.mjs": "sha384-CoiomPPJOq0M8yM1MFjAneybt0lzN4SWbj+HhJx1jurqHDKfPoJ1uMO/DR13KQNz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.749.0/LICENSE
```
