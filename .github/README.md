...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.485.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.485.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5JdqCCGo3cxsZ7yt0u0sYeTep+siE24vdfVXIgp78QX/wRlf9vMQcg8D8m/ANU4w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.485.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.485.0/index.min.mjs": "sha384-5JdqCCGo3cxsZ7yt0u0sYeTep+siE24vdfVXIgp78QX/wRlf9vMQcg8D8m/ANU4w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.485.0/LICENSE
```
