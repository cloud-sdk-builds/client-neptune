...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.12.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.12.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K1SUpC/QoRl8RLjcecAH6vJNEwQDyEsd9gwyfEk34nP3hBeikvbf5bu6/UB2ICgi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.12.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.12.0/index.min.mjs": "sha384-K1SUpC/QoRl8RLjcecAH6vJNEwQDyEsd9gwyfEk34nP3hBeikvbf5bu6/UB2ICgi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.12.0/LICENSE
```
