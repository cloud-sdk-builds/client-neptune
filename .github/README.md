...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.993.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.993.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GYkXs5ueBGcxbnjraxw2wmEmnajjmRYUIgHlNozr/hoQP00+GBZkW2j+LbObtaRS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.993.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.993.0/index.min.mjs": "sha384-GYkXs5ueBGcxbnjraxw2wmEmnajjmRYUIgHlNozr/hoQP00+GBZkW2j+LbObtaRS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.993.0/LICENSE
```
