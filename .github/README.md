...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.917.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.917.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3bf0Syv889d2X1goo/8AKguhHcGE6jDdNi/tu1rG4UYWLRO6Ojn999HGaH++cxD5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.917.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.917.0/index.min.mjs": "sha384-3bf0Syv889d2X1goo/8AKguhHcGE6jDdNi/tu1rG4UYWLRO6Ojn999HGaH++cxD5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.917.0/LICENSE
```
