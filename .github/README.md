...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1023.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1023.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SUtWxB6zTW3Ni0ZtGpJc756Aai4kW+0H6PqY6K5f3s8z+YUH5RQNVHCbebr5smPc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1023.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1023.0/index.min.mjs": "sha384-SUtWxB6zTW3Ni0ZtGpJc756Aai4kW+0H6PqY6K5f3s8z+YUH5RQNVHCbebr5smPc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1023.0/LICENSE
```
