...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.25.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.25.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RZMMNK/7k8otdIqz7i9DVfyl/EAcBSDh9khXRIivMMcLkvZvlH6CzMIVwpUw2A3R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.25.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.25.0/index.min.mjs": "sha384-RZMMNK/7k8otdIqz7i9DVfyl/EAcBSDh9khXRIivMMcLkvZvlH6CzMIVwpUw2A3R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.25.0/LICENSE
```
