...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.345.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.345.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zQE93Q9CoiBTJN/NLt/j5iE3keGl3RerG43qeWH3fipMG99pKssdzeLIVxUuLdXm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.345.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.345.0/index.min.mjs": "sha384-zQE93Q9CoiBTJN/NLt/j5iE3keGl3RerG43qeWH3fipMG99pKssdzeLIVxUuLdXm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.345.0/LICENSE
```
