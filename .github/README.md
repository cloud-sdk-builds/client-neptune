...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-E/z/bihts5aLTSHcRXoT0GZpZcSEu5s1nYwwSrBz7ATylwaot4FsE7gfZ57w1dUC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.855.0/index.min.mjs": "sha384-E/z/bihts5aLTSHcRXoT0GZpZcSEu5s1nYwwSrBz7ATylwaot4FsE7gfZ57w1dUC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.855.0/LICENSE
```
