...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.741.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.741.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1/grWma+QMWaxwke9DGSuI4IKcUrnniEVyCI36BZ2md4Hm9d/JMujNu+3lI4/h3M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.741.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.741.0/index.min.mjs": "sha384-1/grWma+QMWaxwke9DGSuI4IKcUrnniEVyCI36BZ2md4Hm9d/JMujNu+3lI4/h3M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.741.0/LICENSE
```
