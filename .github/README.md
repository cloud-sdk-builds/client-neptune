...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.262.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.262.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ARVmS6DZGebCCXgEp9pg/+mMdfBxgTDZCM4/2kaf57c30HGzuAVcNSuBTKNs4i50
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.262.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.262.0/index.min.mjs": "sha384-ARVmS6DZGebCCXgEp9pg/+mMdfBxgTDZCM4/2kaf57c30HGzuAVcNSuBTKNs4i50"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.262.0/LICENSE
```
