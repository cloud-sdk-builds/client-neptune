...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.620.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.620.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VIrYbN/8gS/wcUQkaBqNuBgSBp4gMYaO0f6nYMSi9exdiTeYnbt+X1PHngB08S+Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.620.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.620.0/index.min.mjs": "sha384-VIrYbN/8gS/wcUQkaBqNuBgSBp4gMYaO0f6nYMSi9exdiTeYnbt+X1PHngB08S+Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.620.0/LICENSE
```
