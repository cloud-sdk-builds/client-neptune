...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.812.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.812.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0dtM3GirMJhPIRVwEX5en4rOOLKhK3lJz2I1ZnIuBjqkRDMgtYuGK6uDBZoIhXu5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.812.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.812.0/index.min.mjs": "sha384-0dtM3GirMJhPIRVwEX5en4rOOLKhK3lJz2I1ZnIuBjqkRDMgtYuGK6uDBZoIhXu5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.812.0/LICENSE
```
