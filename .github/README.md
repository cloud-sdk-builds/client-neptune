...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.967.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.967.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fasYdLD/6ky7tiXLnOnDGQmDVksXWLmXnA5+5raJ8BvBolTVnLZP/mKNL7w9VvUH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.967.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.967.0/index.min.mjs": "sha384-fasYdLD/6ky7tiXLnOnDGQmDVksXWLmXnA5+5raJ8BvBolTVnLZP/mKNL7w9VvUH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.967.0/LICENSE
```
