...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.0.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.0.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eKfVzHr2EDMemm+YS77ecAGvetZkgTjs7aAQhzd+ieLzk0Mw8C/E6wJszd8cTzWc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.0.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.0.0/index.min.mjs": "sha384-eKfVzHr2EDMemm+YS77ecAGvetZkgTjs7aAQhzd+ieLzk0Mw8C/E6wJszd8cTzWc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.0.0/LICENSE
```
