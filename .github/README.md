...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.279.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.279.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gIM13FT5eDUMq4xz0J2duIjyPeLHkUKVRqZGqGZmqhD9d7/0/RzkvIFnMve1Bidy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.279.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.279.0/index.min.mjs": "sha384-gIM13FT5eDUMq4xz0J2duIjyPeLHkUKVRqZGqGZmqhD9d7/0/RzkvIFnMve1Bidy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.279.0/LICENSE
```
