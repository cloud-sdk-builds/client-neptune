...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.190.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.190.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PuU93bexVBIZq4pqeE5LtOb1dL3PyenPt7mZXfuip35R/e0ljMJ+31vzL6xK2TsS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.190.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.190.0/index.min.mjs": "sha384-PuU93bexVBIZq4pqeE5LtOb1dL3PyenPt7mZXfuip35R/e0ljMJ+31vzL6xK2TsS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.190.0/LICENSE
```
