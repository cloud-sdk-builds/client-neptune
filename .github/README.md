...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.193.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.193.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qrkjFmbhYmFL57pDLsen99cxJhc29jN9RfAcWeWqdYE5dj5Z/vQ+yaT/+V5m4juW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.193.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.193.0/index.min.mjs": "sha384-qrkjFmbhYmFL57pDLsen99cxJhc29jN9RfAcWeWqdYE5dj5Z/vQ+yaT/+V5m4juW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.193.0/LICENSE
```
