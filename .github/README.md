...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.962.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.962.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IoImyFcSShMxZi6Wvz1mF4WT3ElL4lkiUXTrXRxOmPK7HYKK8EoMFXroGCdfTbR0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.962.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.962.0/index.min.mjs": "sha384-IoImyFcSShMxZi6Wvz1mF4WT3ElL4lkiUXTrXRxOmPK7HYKK8EoMFXroGCdfTbR0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.962.0/LICENSE
```
