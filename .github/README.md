...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.127.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cne0nuY3eEg+V+Lr9FguByfQjzDAvUOgLpiWNNNpOFItan18Psdu+czwpFoepfAT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.127.0/index.min.mjs": "sha384-cne0nuY3eEg+V+Lr9FguByfQjzDAvUOgLpiWNNNpOFItan18Psdu+czwpFoepfAT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.127.0/LICENSE
```
