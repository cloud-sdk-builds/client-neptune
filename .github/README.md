...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eNQFmNil96ZXng5kv+wRO95YzYOdeS4CGwA6UtmOR3PrzH/iSHanHgvmJawyyLLN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1.0/index.min.mjs": "sha384-eNQFmNil96ZXng5kv+wRO95YzYOdeS4CGwA6UtmOR3PrzH/iSHanHgvmJawyyLLN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1.0/LICENSE
```
