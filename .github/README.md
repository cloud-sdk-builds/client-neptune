...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.454.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.454.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BBh7XsNVn9pvljYJdBaladIdsudAwxbp2Hr+Ft40JBGF60sbfT28lp445UR1aowc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.454.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.454.0/index.min.mjs": "sha384-BBh7XsNVn9pvljYJdBaladIdsudAwxbp2Hr+Ft40JBGF60sbfT28lp445UR1aowc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.454.0/LICENSE
```
