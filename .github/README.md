...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.31.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.31.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4H4OzG8IQXw1qlyWtdzWcSAA6bV1jAxl+lC9Fv7gU9FMKFVJmZAO911T9memFZN9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.31.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.31.0/index.min.mjs": "sha384-4H4OzG8IQXw1qlyWtdzWcSAA6bV1jAxl+lC9Fv7gU9FMKFVJmZAO911T9memFZN9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.31.0/LICENSE
```
