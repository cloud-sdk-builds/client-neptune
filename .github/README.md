...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.567.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.567.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sY6riO3rA/txa4DrD79NEE0Q8/EZqRulOE0jdxBBbuKVzQnwSNYKRsfxpJ1/W2+V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.567.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.567.0/index.min.mjs": "sha384-sY6riO3rA/txa4DrD79NEE0Q8/EZqRulOE0jdxBBbuKVzQnwSNYKRsfxpJ1/W2+V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.567.0/LICENSE
```
