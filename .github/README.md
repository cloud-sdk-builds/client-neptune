...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.47.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.47.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-vFy+vXEJpa/OhnwNgQaBO8chhhg6rdHLESG6Y+nr+UuzDocteh/iZC+5+71bWafj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.47.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.47.1/index.min.mjs": "sha384-vFy+vXEJpa/OhnwNgQaBO8chhhg6rdHLESG6Y+nr+UuzDocteh/iZC+5+71bWafj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.47.1/LICENSE
```
