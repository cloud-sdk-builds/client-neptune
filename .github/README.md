...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.4.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.4.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OnNSFi2KyohTwuTNf85FEnG2PzmxzQcLARv0zu6LuFlcxrn9uiiQWYB5VvxYhiPj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.4.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.4.0/index.min.mjs": "sha384-OnNSFi2KyohTwuTNf85FEnG2PzmxzQcLARv0zu6LuFlcxrn9uiiQWYB5VvxYhiPj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.4.0/LICENSE
```
