...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O6bqsSvU6aSisq7F9uu873UJJAy/1jlUUs0GbdsAHxiBWqBPOyz3gRP8cze0J4eY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.991.0/index.min.mjs": "sha384-O6bqsSvU6aSisq7F9uu873UJJAy/1jlUUs0GbdsAHxiBWqBPOyz3gRP8cze0J4eY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.991.0/LICENSE
```
