...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.575.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.575.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xpeFGFTiLnskZAWTGxtAjXiJ2svcQSzeD3UDy1R9HxPIMMNUhm6mulf1d10VTNua
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.575.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.575.0/index.min.mjs": "sha384-xpeFGFTiLnskZAWTGxtAjXiJ2svcQSzeD3UDy1R9HxPIMMNUhm6mulf1d10VTNua"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.575.0/LICENSE
```
