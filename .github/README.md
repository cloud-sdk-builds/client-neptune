...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.564.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.564.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L7RcyUDiAempB/sFdPw+HcRCrfH9w3IofumUHY5rXBT4IIbQdEfuAZaL2J1MBcUa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.564.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.564.0/index.min.mjs": "sha384-L7RcyUDiAempB/sFdPw+HcRCrfH9w3IofumUHY5rXBT4IIbQdEfuAZaL2J1MBcUa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.564.0/LICENSE
```
