...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.257.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.257.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oaeF+LIvK2K4Q1ODYJaqn0UfQnk1974MAYsTOae6DXGwJ/ri4y/0wt7zt/+zEOa3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.257.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.257.0/index.min.mjs": "sha384-oaeF+LIvK2K4Q1ODYJaqn0UfQnk1974MAYsTOae6DXGwJ/ri4y/0wt7zt/+zEOa3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.257.0/LICENSE
```
