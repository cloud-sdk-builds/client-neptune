...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.316.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.316.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-79s0TwfqFIuEwaksbbSX+2Dho4ppbfh6mmW6gjbsVO0/qQmk8RgFwhWmArA+MVTN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.316.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.316.0/index.min.mjs": "sha384-79s0TwfqFIuEwaksbbSX+2Dho4ppbfh6mmW6gjbsVO0/qQmk8RgFwhWmArA+MVTN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.316.0/LICENSE
```
