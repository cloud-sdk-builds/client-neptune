...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.658.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.658.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lhGvNBcytg0uKTiCOcfUsnIboYzPwDhvC2dp6fTqIqHnFfw9OabTqmX7cUt9gkZC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.658.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.658.0/index.min.mjs": "sha384-lhGvNBcytg0uKTiCOcfUsnIboYzPwDhvC2dp6fTqIqHnFfw9OabTqmX7cUt9gkZC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.658.0/LICENSE
```
