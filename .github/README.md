...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.846.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.846.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TwL6VNgh9w8RxrkVbNPUpT2jIOytFkZUVsn72kvEuukj96eOspqxPLPS7rbBsHky
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.846.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.846.0/index.min.mjs": "sha384-TwL6VNgh9w8RxrkVbNPUpT2jIOytFkZUVsn72kvEuukj96eOspqxPLPS7rbBsHky"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.846.0/LICENSE
```
