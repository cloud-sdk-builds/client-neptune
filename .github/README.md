...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.513.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.513.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mnc28VJYDm02ogA0i/Qv+lr56BTOtU7FttmJC4WCq4gG2uSvXbjqzx7lTkHNH2zZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.513.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.513.0/index.min.mjs": "sha384-mnc28VJYDm02ogA0i/Qv+lr56BTOtU7FttmJC4WCq4gG2uSvXbjqzx7lTkHNH2zZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.513.0/LICENSE
```
