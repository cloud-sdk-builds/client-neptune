...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.290.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.290.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OYvHFsWnDvEFXpo/AI7ww6GOT7N9APgy/2UsR33RfwKCxylvMMlphzmRmOTLD2hT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.290.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.290.0/index.min.mjs": "sha384-OYvHFsWnDvEFXpo/AI7ww6GOT7N9APgy/2UsR33RfwKCxylvMMlphzmRmOTLD2hT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.290.0/LICENSE
```
