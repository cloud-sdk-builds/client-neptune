...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.782.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.782.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DF2if63nfrUFmtBndfA84ZZT8iaZIBQl1ku1QS7bIh39nffnOi/38egeKq0RwW0E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.782.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.782.0/index.min.mjs": "sha384-DF2if63nfrUFmtBndfA84ZZT8iaZIBQl1ku1QS7bIh39nffnOi/38egeKq0RwW0E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.782.0/LICENSE
```
