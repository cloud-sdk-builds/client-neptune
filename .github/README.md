...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.161.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.161.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IvKSgzEIuzBr0Cf7BWh+QkoZpcp8jy92DwklvAUrshuWHycuvN8xcR+i4Zf0wr1q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.161.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.161.0/index.min.mjs": "sha384-IvKSgzEIuzBr0Cf7BWh+QkoZpcp8jy92DwklvAUrshuWHycuvN8xcR+i4Zf0wr1q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.161.0/LICENSE
```
