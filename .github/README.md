...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.632.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.632.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0q2STY7YKeJQTeitYIKQF8JccecEoDRKwdkLffyxweT6/5HZWjZqiRdNS/sh5qbi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.632.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.632.0/index.min.mjs": "sha384-0q2STY7YKeJQTeitYIKQF8JccecEoDRKwdkLffyxweT6/5HZWjZqiRdNS/sh5qbi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.632.0/LICENSE
```
