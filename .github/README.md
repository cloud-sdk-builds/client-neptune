...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.45.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.45.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SDxh9MKy5VyCpFXo+iFgLDJEgcbMHFtdqU9/nsJOzfxZ0GLtCzV+rk3CQorLg3jW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.45.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.45.0/index.min.mjs": "sha384-SDxh9MKy5VyCpFXo+iFgLDJEgcbMHFtdqU9/nsJOzfxZ0GLtCzV+rk3CQorLg3jW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.45.0/LICENSE
```
