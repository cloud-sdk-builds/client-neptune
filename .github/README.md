...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1026.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1026.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8cV9vZk8fl/WfoNQeiGSTsy4j0BzVa/jTyAKGeFDb+fjMYrNbSkA+v3L7Ft2GdS6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1026.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1026.0/index.min.mjs": "sha384-8cV9vZk8fl/WfoNQeiGSTsy4j0BzVa/jTyAKGeFDb+fjMYrNbSkA+v3L7Ft2GdS6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1026.0/LICENSE
```
