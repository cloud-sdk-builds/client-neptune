...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.862.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.862.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-o0ppktHtMJxyP3Z4siQr+SL4lK2ADb3PbZ3mCb/mlJi7J7VFSCDaW26U6ewcxvFh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.862.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.862.0/index.min.mjs": "sha384-o0ppktHtMJxyP3Z4siQr+SL4lK2ADb3PbZ3mCb/mlJi7J7VFSCDaW26U6ewcxvFh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.862.0/LICENSE
```
