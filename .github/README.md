...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.82.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.82.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DUOt1SgzOm5d6VnpCm3HeP0Tvf75sLIFcy7GdxNTiuGI8b/3LlznnPh80ckPaf/S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.82.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.82.0/index.min.mjs": "sha384-DUOt1SgzOm5d6VnpCm3HeP0Tvf75sLIFcy7GdxNTiuGI8b/3LlznnPh80ckPaf/S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.82.0/LICENSE
```
