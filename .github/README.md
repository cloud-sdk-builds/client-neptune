...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.587.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.587.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v6CN9tzQOIUDayYg5hb3wTl+YniXBJpPLSCirWwR4ytKfI5BmJf9WbLEQcHiCr3w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.587.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.587.0/index.min.mjs": "sha384-v6CN9tzQOIUDayYg5hb3wTl+YniXBJpPLSCirWwR4ytKfI5BmJf9WbLEQcHiCr3w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.587.0/LICENSE
```
