...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-D8ax0KX+LtVPH6TfWLzJfE6FaKyH+Du6bAJbBoI3l6XJnTj8kdFGQq7mrQp8rDpE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.168.0/index.min.mjs": "sha384-D8ax0KX+LtVPH6TfWLzJfE6FaKyH+Du6bAJbBoI3l6XJnTj8kdFGQq7mrQp8rDpE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.168.0/LICENSE
```
