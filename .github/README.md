...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.231.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.231.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QIJ/Q/SR3uQjkstPSP00J+TmxPNrzvk+dUpeEKrFOfZoc/8ikvR72Wppw8aTHRVj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.231.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.231.0/index.min.mjs": "sha384-QIJ/Q/SR3uQjkstPSP00J+TmxPNrzvk+dUpeEKrFOfZoc/8ikvR72Wppw8aTHRVj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.231.0/LICENSE
```
