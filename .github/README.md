...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.803.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.803.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Zc8apdZnGXAiEVu1lQ0NBI/hc7/WdMit5N+wtoA77XZQGNaQRoUY0xzARsJelXVK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.803.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.803.0/index.min.mjs": "sha384-Zc8apdZnGXAiEVu1lQ0NBI/hc7/WdMit5N+wtoA77XZQGNaQRoUY0xzARsJelXVK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.803.0/LICENSE
```
