...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.856.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.856.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AI7SRnygkUgTar26jvAeC0uC30rA0wEKifrILzhvxvyXmu6NKXltPNsfcODLaz7u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.856.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.856.0/index.min.mjs": "sha384-AI7SRnygkUgTar26jvAeC0uC30rA0wEKifrILzhvxvyXmu6NKXltPNsfcODLaz7u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.856.0/LICENSE
```
