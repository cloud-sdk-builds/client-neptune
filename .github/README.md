...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x1Agxrmkex58SJrnRdrG13tR44ke445PiM7aS1f3iJjIqDgcIL0ohkYh+haHhqj8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.919.0/index.min.mjs": "sha384-x1Agxrmkex58SJrnRdrG13tR44ke445PiM7aS1f3iJjIqDgcIL0ohkYh+haHhqj8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.919.0/LICENSE
```
