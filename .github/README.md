...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1028.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1028.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FTuK4ZwqVTZEb87kWMTVUziB55xyDjssun9mmGZlvIpm+EAhW1azP3shu2Ioshq8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1028.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1028.0/index.min.mjs": "sha384-FTuK4ZwqVTZEb87kWMTVUziB55xyDjssun9mmGZlvIpm+EAhW1azP3shu2Ioshq8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1028.0/LICENSE
```
