...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.797.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.797.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3R+WIKSuzePgfdofw0qBQK/FQc7HCtk8Hf8xoPKMlNpZLwY+5/dPDw9mmq8wYauc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.797.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.797.0/index.min.mjs": "sha384-3R+WIKSuzePgfdofw0qBQK/FQc7HCtk8Hf8xoPKMlNpZLwY+5/dPDw9mmq8wYauc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.797.0/LICENSE
```
