...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.287.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.287.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qA7L06NiACdrcRx03NQweV/uVWYUTU2cytm0cSy2f2BW2iGdYeUCoJMLui/WzGQO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.287.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.287.0/index.min.mjs": "sha384-qA7L06NiACdrcRx03NQweV/uVWYUTU2cytm0cSy2f2BW2iGdYeUCoJMLui/WzGQO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.287.0/LICENSE
```
