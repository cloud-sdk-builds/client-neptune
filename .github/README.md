...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.928.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.928.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/t6f1r1K1D9wgRKTvcy6AtBxDAm0ybBN+dB30qwTqEe1/2u8duIaQcMEN1pcYouS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.928.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.928.0/index.min.mjs": "sha384-/t6f1r1K1D9wgRKTvcy6AtBxDAm0ybBN+dB30qwTqEe1/2u8duIaQcMEN1pcYouS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.928.0/LICENSE
```
