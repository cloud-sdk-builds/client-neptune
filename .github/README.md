...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.47.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.47.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WH74ckUcLJLmtwbXh6JZC5Vt5IlDTkKVTlRX9AWAnUjmXZhC85PCWYHoLahMc69I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.47.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.47.0/index.min.mjs": "sha384-WH74ckUcLJLmtwbXh6JZC5Vt5IlDTkKVTlRX9AWAnUjmXZhC85PCWYHoLahMc69I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.47.0/LICENSE
```
