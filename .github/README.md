...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.845.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.845.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DBaTY0XPfT8ugcg9rIBGY6IluSpixMKGreIvCTkm4XEq3tsOyVJYtUqYx2i0KqRI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.845.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.845.0/index.min.mjs": "sha384-DBaTY0XPfT8ugcg9rIBGY6IluSpixMKGreIvCTkm4XEq3tsOyVJYtUqYx2i0KqRI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.845.0/LICENSE
```
