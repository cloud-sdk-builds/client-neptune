...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.940.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.940.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gqrm1anJnLFGhObtlDn+zKSbjI2NeuM7LjawnetFVAhovFy0DxAq6dmfVM0+Rxu4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.940.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.940.0/index.min.mjs": "sha384-Gqrm1anJnLFGhObtlDn+zKSbjI2NeuM7LjawnetFVAhovFy0DxAq6dmfVM0+Rxu4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.940.0/LICENSE
```
