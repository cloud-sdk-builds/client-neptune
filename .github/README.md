...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.709.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.709.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rghJwMuSek1ayyLtuzx3YD0pjegYN8eg3SzhFhc5lK43j8x08IVFjUds6TjM9g2x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.709.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.709.0/index.min.mjs": "sha384-rghJwMuSek1ayyLtuzx3YD0pjegYN8eg3SzhFhc5lK43j8x08IVFjUds6TjM9g2x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.709.0/LICENSE
```
