...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3yy8YPZHgEiouJ09VV507zRkpGhUrsfltdQnj3uepyv91knSsfBC5xm0ohavHEGd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.796.0/index.min.mjs": "sha384-3yy8YPZHgEiouJ09VV507zRkpGhUrsfltdQnj3uepyv91knSsfBC5xm0ohavHEGd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.796.0/LICENSE
```
