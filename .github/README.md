...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.413.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.413.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JmjxjjMtIDP3XcsyQABO70N9vlBfPDKWpT9f4XVogTaEsXtSDoItMEhiGrpEEgiL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.413.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.413.0/index.min.mjs": "sha384-JmjxjjMtIDP3XcsyQABO70N9vlBfPDKWpT9f4XVogTaEsXtSDoItMEhiGrpEEgiL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.413.0/LICENSE
```
