...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.354.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.354.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aP82q8r+XhWY62WcIJMyYCtmulowtB61zzVtTqAdCS0X9j9YRzUix+VUE2vbaUe+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.354.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.354.0/index.min.mjs": "sha384-aP82q8r+XhWY62WcIJMyYCtmulowtB61zzVtTqAdCS0X9j9YRzUix+VUE2vbaUe+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.354.0/LICENSE
```
