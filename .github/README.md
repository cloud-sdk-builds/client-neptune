...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.150.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.150.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aFU4vYA/OIrLlbBAkFMzsqiERyAO04EQM/2kOYfkHjhFFUBwXUzGhW0qJzs81Vxz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.150.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.150.0/index.min.mjs": "sha384-aFU4vYA/OIrLlbBAkFMzsqiERyAO04EQM/2kOYfkHjhFFUBwXUzGhW0qJzs81Vxz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.150.0/LICENSE
```
