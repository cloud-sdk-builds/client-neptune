...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.682.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.682.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HpfaV1AIkt9n/cnrE/kXOcrpZLYAFEc/U8yEB5MsU2wOv7O9aYzB/V7cMD71iFlh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.682.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.682.0/index.min.mjs": "sha384-HpfaV1AIkt9n/cnrE/kXOcrpZLYAFEc/U8yEB5MsU2wOv7O9aYzB/V7cMD71iFlh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.682.0/LICENSE
```
