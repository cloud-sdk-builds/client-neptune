...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.163.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.163.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dDBpVVQwBhvcY2PwRjAEXUWNdDDTZhJ4hUvYCke70xysW3PfHVPEXFJmuW/OI+uw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.163.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.163.0/index.min.mjs": "sha384-dDBpVVQwBhvcY2PwRjAEXUWNdDDTZhJ4hUvYCke70xysW3PfHVPEXFJmuW/OI+uw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.163.0/LICENSE
```
