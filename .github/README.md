...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.721.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.721.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ltOWUkgByvu2KVXzXxDPvskKpPs/19U0/w5zJISJNJa5fKh51YhSZQ+cKX6Z8FFG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.721.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.721.0/index.min.mjs": "sha384-ltOWUkgByvu2KVXzXxDPvskKpPs/19U0/w5zJISJNJa5fKh51YhSZQ+cKX6Z8FFG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.721.0/LICENSE
```
