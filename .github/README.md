...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.137.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.137.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zDgVBj+lB8NTylEqxoDWjt03L96HUKZPaJ+cXPaC+yh5YGuEh/OYQ0/2jx+Sp+kD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.137.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.137.0/index.min.mjs": "sha384-zDgVBj+lB8NTylEqxoDWjt03L96HUKZPaJ+cXPaC+yh5YGuEh/OYQ0/2jx+Sp+kD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.137.0/LICENSE
```
