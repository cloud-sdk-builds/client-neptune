...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.85.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.85.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bAY26Qozv09mumEosO4aXtQMw4AuMaBjBZkVikB/3DQPqTJ4F8tvc74JgS3YbM8g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.85.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.85.0/index.min.mjs": "sha384-bAY26Qozv09mumEosO4aXtQMw4AuMaBjBZkVikB/3DQPqTJ4F8tvc74JgS3YbM8g"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.85.0/LICENSE
```
