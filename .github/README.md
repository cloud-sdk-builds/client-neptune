...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.80.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.80.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OtOBtkqFR2K5byRl4MKHze6rmbRxV3MIwpm967JXjjtS2XXx9dEbboRV+rx4/9cW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.80.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.80.0/index.min.mjs": "sha384-OtOBtkqFR2K5byRl4MKHze6rmbRxV3MIwpm967JXjjtS2XXx9dEbboRV+rx4/9cW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.80.0/LICENSE
```
