...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.179.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.179.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LFhXuuccTl3TwvcazcdToezwaQj+Kd+og8RWF/LjVBJtYtUXItCO+Y+FnSR1We+e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.179.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.179.0/index.min.mjs": "sha384-LFhXuuccTl3TwvcazcdToezwaQj+Kd+og8RWF/LjVBJtYtUXItCO+Y+FnSR1We+e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.179.0/LICENSE
```
