...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.504.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.504.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RdsRDdDu1+/KRE4YxuwyFYoQT2OutWmNa1H9t4ncIoTHbfJlmb1hHy1qZlOrkT2g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.504.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.504.0/index.min.mjs": "sha384-RdsRDdDu1+/KRE4YxuwyFYoQT2OutWmNa1H9t4ncIoTHbfJlmb1hHy1qZlOrkT2g"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.504.0/LICENSE
```
