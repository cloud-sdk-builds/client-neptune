...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.886.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.886.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uUx2b5Gf2U0uL/jyYVUX3HMk0OsflyV01w+zX7FMtlvjqI4PC7CzJ+0I4fCzkHzS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.886.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.886.0/index.min.mjs": "sha384-uUx2b5Gf2U0uL/jyYVUX3HMk0OsflyV01w+zX7FMtlvjqI4PC7CzJ+0I4fCzkHzS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.886.0/LICENSE
```
