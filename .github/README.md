...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.183.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.183.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cob7VhEFNxbsl+G+LOH+yWf/FFsla9kkCaWS25n5ZllLvi4s77o5RqctCQBFqr3D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.183.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.183.0/index.min.mjs": "sha384-cob7VhEFNxbsl+G+LOH+yWf/FFsla9kkCaWS25n5ZllLvi4s77o5RqctCQBFqr3D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.183.0/LICENSE
```
