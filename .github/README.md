...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.758.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.758.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-buY/v6F90O7fCyGfhhvNrQxHdb59/B5BrxNcX++DgQxbb2Tf9ECDsaKa2LZcxXAN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.758.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.758.0/index.min.mjs": "sha384-buY/v6F90O7fCyGfhhvNrQxHdb59/B5BrxNcX++DgQxbb2Tf9ECDsaKa2LZcxXAN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.758.0/LICENSE
```
