...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.635.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.635.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VnAFXFS4ZQU5jln5yiQP2tdncmk5YKvAtn9dIZcdmZ0kBTIL7/1/q6lB5xKj1sw1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.635.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.635.0/index.min.mjs": "sha384-VnAFXFS4ZQU5jln5yiQP2tdncmk5YKvAtn9dIZcdmZ0kBTIL7/1/q6lB5xKj1sw1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.635.0/LICENSE
```
