...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.398.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.398.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PT/PQx1PtrBKM/CK0DLQ0PoB+Y6hIKuBzVvY45EDxETSdwlcat2sWrAtK7nin0+0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.398.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.398.0/index.min.mjs": "sha384-PT/PQx1PtrBKM/CK0DLQ0PoB+Y6hIKuBzVvY45EDxETSdwlcat2sWrAtK7nin0+0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.398.0/LICENSE
```
