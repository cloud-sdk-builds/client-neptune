...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.282.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.282.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NlSF3n7tuJG5JUc6jiklnU1HygxcaLvdV7JTJi5vRbn+qY+kcoTc7qGOiR7S9p2S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.282.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.282.0/index.min.mjs": "sha384-NlSF3n7tuJG5JUc6jiklnU1HygxcaLvdV7JTJi5vRbn+qY+kcoTc7qGOiR7S9p2S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.282.0/LICENSE
```
