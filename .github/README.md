...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.692.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.692.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RFLnNpRL2eelR8tsOe9CRwZa35yhZkQdO+D1PKQysumNQ11TntxkGfPrIeMZq9KT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.692.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.692.0/index.min.mjs": "sha384-RFLnNpRL2eelR8tsOe9CRwZa35yhZkQdO+D1PKQysumNQ11TntxkGfPrIeMZq9KT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.692.0/LICENSE
```
