...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wA5jeDPKYcHv+BLoIraCdobIMGszno6zn/l3G7b2+1wD8eYS4RAuG9tSWIXiE9JS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.985.0/index.min.mjs": "sha384-wA5jeDPKYcHv+BLoIraCdobIMGszno6zn/l3G7b2+1wD8eYS4RAuG9tSWIXiE9JS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.985.0/LICENSE
```
