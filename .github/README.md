...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fx1ez8g3wB/21oByU30vBll1JbvIAcDoiYBC+kOd/2Zs2s/FM5KZNW6EnmpvbAFw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.777.0/index.min.mjs": "sha384-fx1ez8g3wB/21oByU30vBll1JbvIAcDoiYBC+kOd/2Zs2s/FM5KZNW6EnmpvbAFw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.777.0/LICENSE
```
