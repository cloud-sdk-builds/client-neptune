...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.984.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.984.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7l3YOGaYhegh8a+qHIxx+4Ecr4wdwYUqFoxsxjXYFG0BIdSaVkhcVtZM/hb1qxPy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.984.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.984.0/index.min.mjs": "sha384-7l3YOGaYhegh8a+qHIxx+4Ecr4wdwYUqFoxsxjXYFG0BIdSaVkhcVtZM/hb1qxPy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.984.0/LICENSE
```
