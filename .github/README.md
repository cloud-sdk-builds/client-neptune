...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.386.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.386.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cQaazlB19NzPwtVzjLcPcXyAmlkgrZjgDc22Q2KtDl7RcYQegu0Tt6tviIcD0eov
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.386.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.386.0/index.min.mjs": "sha384-cQaazlB19NzPwtVzjLcPcXyAmlkgrZjgDc22Q2KtDl7RcYQegu0Tt6tviIcD0eov"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.386.0/LICENSE
```
