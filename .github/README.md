...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.15.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.15.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-z5waG/IehighY/km8oAgusVvLIMUeJDKF/pu4q1lMMBvmxu2NvFtNPGQ2Bu5sOMx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.15.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.15.0/index.min.mjs": "sha384-z5waG/IehighY/km8oAgusVvLIMUeJDKF/pu4q1lMMBvmxu2NvFtNPGQ2Bu5sOMx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.15.0/LICENSE
```
