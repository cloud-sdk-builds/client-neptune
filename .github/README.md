...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.427.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.427.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AU/2G6XPQ9ICLumGgJNiqqBa8BzFkutsvVt7Sf+/knEdGdGB4n+Dv4zniM/S6fmY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.427.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.427.0/index.min.mjs": "sha384-AU/2G6XPQ9ICLumGgJNiqqBa8BzFkutsvVt7Sf+/knEdGdGB4n+Dv4zniM/S6fmY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.427.0/LICENSE
```
