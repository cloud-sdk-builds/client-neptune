...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.460.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.460.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Oj0kbF4+3TDxNMZ85CFuW8yMoxjogovlVDjP7fkw0VLqGb2vvXWsjBX/plw5w9o9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.460.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.460.0/index.min.mjs": "sha384-Oj0kbF4+3TDxNMZ85CFuW8yMoxjogovlVDjP7fkw0VLqGb2vvXWsjBX/plw5w9o9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.460.0/LICENSE
```
