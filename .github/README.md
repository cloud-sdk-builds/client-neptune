...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.998.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.998.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rMo01cvoN9c8XFR4XEtXayBtYdK2txTiIkzuqEK3nIRzeqxq2BSwjel+sTGLrreB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.998.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.998.0/index.min.mjs": "sha384-rMo01cvoN9c8XFR4XEtXayBtYdK2txTiIkzuqEK3nIRzeqxq2BSwjel+sTGLrreB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.998.0/LICENSE
```
