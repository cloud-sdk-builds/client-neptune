...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.664.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.664.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7slkDtEIU4H7Mpy0ukoPulWrfWAfjpxn2eGZyhBjE8Er2rfuqch8PvHSJ+QlLPIZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.664.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.664.0/index.min.mjs": "sha384-7slkDtEIU4H7Mpy0ukoPulWrfWAfjpxn2eGZyhBjE8Er2rfuqch8PvHSJ+QlLPIZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.664.0/LICENSE
```
