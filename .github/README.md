...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.738.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BAeFN9f/e5omZmj8z60goHnMKwQhOfAwBh2tCADaQ4wXYrFCSHuPBbJfQ4BWmuv9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.738.0/index.min.mjs": "sha384-BAeFN9f/e5omZmj8z60goHnMKwQhOfAwBh2tCADaQ4wXYrFCSHuPBbJfQ4BWmuv9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.738.0/LICENSE
```
