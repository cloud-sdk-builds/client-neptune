...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.43.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.43.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N6ha6wrTftY5L7H/PBKJSLEMfFKjNFTyekuOsiGsZR8p1uA0qkgOI/MSP8SaL/Qb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.43.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.43.0/index.min.mjs": "sha384-N6ha6wrTftY5L7H/PBKJSLEMfFKjNFTyekuOsiGsZR8p1uA0qkgOI/MSP8SaL/Qb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.43.0/LICENSE
```
