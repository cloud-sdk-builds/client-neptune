...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.734.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.734.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dSNPHnidqwXAkBoGmYYGkkH28d6EYnvhP8eKLzqG+i0fkx4jqqAbsgWIJL/ZsnR7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.734.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.734.0/index.min.mjs": "sha384-dSNPHnidqwXAkBoGmYYGkkH28d6EYnvhP8eKLzqG+i0fkx4jqqAbsgWIJL/ZsnR7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.734.0/LICENSE
```
