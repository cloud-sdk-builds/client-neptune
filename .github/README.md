...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.907.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.907.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iBmc5SKBXb0nvpBDi8gEuyOUXwzbJcP0/gLBsAsa4prdeUxTb0BjmDondaJ0UXZj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.907.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.907.0/index.min.mjs": "sha384-iBmc5SKBXb0nvpBDi8gEuyOUXwzbJcP0/gLBsAsa4prdeUxTb0BjmDondaJ0UXZj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.907.0/LICENSE
```
