...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+7LTe/IVnhRFC2pOD/JSAiujQoi/VGwlfn0tw81fBzXHU8YcpAL7r1Zuz/UCfzC2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.995.0/index.min.mjs": "sha384-+7LTe/IVnhRFC2pOD/JSAiujQoi/VGwlfn0tw81fBzXHU8YcpAL7r1Zuz/UCfzC2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.995.0/LICENSE
```
