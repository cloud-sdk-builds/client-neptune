...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1008.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1008.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LztQiuc3G8XqjfI3eLyG1BoFpVKhkQXfsckovWiJcJpVNzDHVI1MVIxWYnsNVAnL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1008.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1008.0/index.min.mjs": "sha384-LztQiuc3G8XqjfI3eLyG1BoFpVKhkQXfsckovWiJcJpVNzDHVI1MVIxWYnsNVAnL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1008.0/LICENSE
```
