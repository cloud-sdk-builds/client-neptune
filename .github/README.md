...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.458.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.458.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HBnrnBC2hkT+M1xAUX8y150z8gfcgvcJkGyieqGY7pNgnraXE4wwyavEuJTZCzLp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.458.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.458.0/index.min.mjs": "sha384-HBnrnBC2hkT+M1xAUX8y150z8gfcgvcJkGyieqGY7pNgnraXE4wwyavEuJTZCzLp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.458.0/LICENSE
```
