...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.879.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.879.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xbp8K8EHgNNVqzn1dwVtUA1dN1VUeWmxxu5dYbEqfpIo3ArPZ8cvUD8kcfJn98h7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.879.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.879.0/index.min.mjs": "sha384-Xbp8K8EHgNNVqzn1dwVtUA1dN1VUeWmxxu5dYbEqfpIo3ArPZ8cvUD8kcfJn98h7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.879.0/LICENSE
```
