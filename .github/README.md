...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1013.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1013.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-03mEHWHgimRMn0cd/33qLPhDlQ6l1/ixd3mZU1Js6+XkLCZyl+zkNnnzLBz56I/4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1013.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1013.0/index.min.mjs": "sha384-03mEHWHgimRMn0cd/33qLPhDlQ6l1/ixd3mZU1Js6+XkLCZyl+zkNnnzLBz56I/4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1013.0/LICENSE
```
