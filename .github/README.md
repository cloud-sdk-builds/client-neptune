...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.723.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.723.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-41FyX8cXv2JIkExjcMwk9nkLpWxep6hbabuKsXRh2b/scMCRTwOvVJVTiH3ROzNe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.723.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.723.0/index.min.mjs": "sha384-41FyX8cXv2JIkExjcMwk9nkLpWxep6hbabuKsXRh2b/scMCRTwOvVJVTiH3ROzNe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.723.0/LICENSE
```
