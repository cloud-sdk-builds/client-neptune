...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.298.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.298.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yUhQhgV9Q0jJ/VaA9++XASOEHoO0qu/LpIO4QZhrQfRZATaYj2kq1ZJrQUaoDiZd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.298.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.298.0/index.min.mjs": "sha384-yUhQhgV9Q0jJ/VaA9++XASOEHoO0qu/LpIO4QZhrQfRZATaYj2kq1ZJrQUaoDiZd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.298.0/LICENSE
```
