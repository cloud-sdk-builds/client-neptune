...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.844.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.844.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YY7yDUBWz+XF/WtqRUxT/9aPi/xEJCxFKwE/oa8wieGynbZBLF+n2INe3TDJ7/8K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.844.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.844.0/index.min.mjs": "sha384-YY7yDUBWz+XF/WtqRUxT/9aPi/xEJCxFKwE/oa8wieGynbZBLF+n2INe3TDJ7/8K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.844.0/LICENSE
```
