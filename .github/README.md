...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.56.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.56.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2WQAm+S0s87VP3ztGQY/z0L7LDAsJi/K+JBVqxA+0ty/HtwD2Vatfax4Lsgu54MH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.56.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.56.0/index.min.mjs": "sha384-2WQAm+S0s87VP3ztGQY/z0L7LDAsJi/K+JBVqxA+0ty/HtwD2Vatfax4Lsgu54MH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.56.0/LICENSE
```
