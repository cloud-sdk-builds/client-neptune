...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.535.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.535.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NBa8qycAeFhTb98SJp6fqXKAxQRHKppXnc0Zfhjp4qj35EDZLX9/ZA9aKDiH98Uh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.535.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.535.0/index.min.mjs": "sha384-NBa8qycAeFhTb98SJp6fqXKAxQRHKppXnc0Zfhjp4qj35EDZLX9/ZA9aKDiH98Uh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.535.0/LICENSE
```
