...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.473.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.473.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tTbPst4kU05W8doCrlYaB/q4bj7IycwRGOXNi/ld42bBs1jLQuH4fmCRXzf0dNr2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.473.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.473.0/index.min.mjs": "sha384-tTbPst4kU05W8doCrlYaB/q4bj7IycwRGOXNi/ld42bBs1jLQuH4fmCRXzf0dNr2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.473.0/LICENSE
```
