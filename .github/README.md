...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.892.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.892.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mbb+4c5rX0aFn6HWxxrGVpJNkvR7Fr4r9/Ji5rEbTEFuUI1xT31BUjjUf6/U9ySb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.892.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.892.0/index.min.mjs": "sha384-mbb+4c5rX0aFn6HWxxrGVpJNkvR7Fr4r9/Ji5rEbTEFuUI1xT31BUjjUf6/U9ySb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.892.0/LICENSE
```
