...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1025.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1025.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7DNFEETJce3mg8cDINA7CJU9RwKsc/lbA23REQzHg1pMEoFuenWMrX/0tNDdiaEj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1025.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1025.0/index.min.mjs": "sha384-7DNFEETJce3mg8cDINA7CJU9RwKsc/lbA23REQzHg1pMEoFuenWMrX/0tNDdiaEj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1025.0/LICENSE
```
