...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.624.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.624.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eNS7nG6mDl9o99ZWqAZNvPeCjA9KQ3AflQj0dOs05MR9jkD88haWsUb6PBzFnyW5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.624.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.624.0/index.min.mjs": "sha384-eNS7nG6mDl9o99ZWqAZNvPeCjA9KQ3AflQj0dOs05MR9jkD88haWsUb6PBzFnyW5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.624.0/LICENSE
```
