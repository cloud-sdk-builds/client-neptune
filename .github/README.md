...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.256.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.256.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-igKojPRw857c2B9Y0h1peABxtGflIhIOIKzr3WuhYTqn3e1J1vQedzwNCe4n+FZG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.256.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.256.0/index.min.mjs": "sha384-igKojPRw857c2B9Y0h1peABxtGflIhIOIKzr3WuhYTqn3e1J1vQedzwNCe4n+FZG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.256.0/LICENSE
```
