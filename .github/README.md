...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.507.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.507.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MLCdakBvj4sj/tjap4D2gZLe02fVBUFqPuMEmrR28gLkiJIPlqATAHmAezotU8uh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.507.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.507.0/index.min.mjs": "sha384-MLCdakBvj4sj/tjap4D2gZLe02fVBUFqPuMEmrR28gLkiJIPlqATAHmAezotU8uh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.507.0/LICENSE
```
