...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1029.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1029.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tRBhHY3cPXJrPnooRYnI70BLxEwLUWF+qX1/rrzvKz4mklwfGn0hDvtE8Dx6+kdL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1029.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1029.0/index.min.mjs": "sha384-tRBhHY3cPXJrPnooRYnI70BLxEwLUWF+qX1/rrzvKz4mklwfGn0hDvtE8Dx6+kdL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1029.0/LICENSE
```
