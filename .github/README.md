...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.489.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.489.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A5YTmKYTQ3RcePPToCGE9A+2Nab9+lPcL4WSHGi7cVb0WktPZC5QWXZyBYCtqTsX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.489.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.489.0/index.min.mjs": "sha384-A5YTmKYTQ3RcePPToCGE9A+2Nab9+lPcL4WSHGi7cVb0WktPZC5QWXZyBYCtqTsX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.489.0/LICENSE
```
