...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1016.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1016.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RSpEzuVYX5A9niBE/nJorJ49MTVP2cVni8UyeQk4fadPIRmx4EdRkEoBJgK4PJPk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1016.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1016.0/index.min.mjs": "sha384-RSpEzuVYX5A9niBE/nJorJ49MTVP2cVni8UyeQk4fadPIRmx4EdRkEoBJgK4PJPk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1016.0/LICENSE
```
