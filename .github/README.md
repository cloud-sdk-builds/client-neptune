...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.503.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.503.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L9QFvkUNhwzkACFFo2S387pROYcYy0okrDVfAcT1cWQmKNn/FQ5+iAP1rNkLjZKc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.503.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.503.0/index.min.mjs": "sha384-L9QFvkUNhwzkACFFo2S387pROYcYy0okrDVfAcT1cWQmKNn/FQ5+iAP1rNkLjZKc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.503.0/LICENSE
```
