...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.16.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.16.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i7DiHFHi/KThUyuXbw+NBZ7zlzlLrZ4SnXfZyN6vqZwHPBJH+YaETYF2SAjwQU/W
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.16.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.16.0/index.min.mjs": "sha384-i7DiHFHi/KThUyuXbw+NBZ7zlzlLrZ4SnXfZyN6vqZwHPBJH+YaETYF2SAjwQU/W"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.16.0/LICENSE
```
