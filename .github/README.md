...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.18.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.18.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mlOXSjonl+RuSPjlpU/aA489JxA/zLsNFUST2+pF4XlnXjpQzdSjtPEnh074TBJu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.18.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.18.0/index.min.mjs": "sha384-mlOXSjonl+RuSPjlpU/aA489JxA/zLsNFUST2+pF4XlnXjpQzdSjtPEnh074TBJu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.18.0/LICENSE
```
