...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.649.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.649.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oWiun6DXvhE/mDb8WaEBPc/CIfKhhhiyNhh93GIrV0rjX7Z3ez9q421ZaCFwgtMU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.649.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.649.0/index.min.mjs": "sha384-oWiun6DXvhE/mDb8WaEBPc/CIfKhhhiyNhh93GIrV0rjX7Z3ez9q421ZaCFwgtMU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.649.0/LICENSE
```
