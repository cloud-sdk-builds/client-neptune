...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.481.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.481.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xc/CEaIFs66KX1iT35PSKSsDrU8JjtQ9MZxGW346lKKftaxAQI7hK8rNmxyefL/+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.481.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.481.0/index.min.mjs": "sha384-xc/CEaIFs66KX1iT35PSKSsDrU8JjtQ9MZxGW346lKKftaxAQI7hK8rNmxyefL/+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.481.0/LICENSE
```
