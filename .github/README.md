...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.17.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.17.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BpuEPkBkPs0e0nBatcgkBl+xZ+Y78VZguqspzU6iiKbTnV9aH7Rkv3hjVtsjuG+y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.17.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.17.0/index.min.mjs": "sha384-BpuEPkBkPs0e0nBatcgkBl+xZ+Y78VZguqspzU6iiKbTnV9aH7Rkv3hjVtsjuG+y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.17.0/LICENSE
```
