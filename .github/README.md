...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.880.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.880.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3Gtj7SQKbJmONSIFk35R2z5sgTWQSOwJv1fSqZUzC8FTlcmW00nSiBXFacz/9EBF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.880.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.880.0/index.min.mjs": "sha384-3Gtj7SQKbJmONSIFk35R2z5sgTWQSOwJv1fSqZUzC8FTlcmW00nSiBXFacz/9EBF"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.880.0`)
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.880.0/LICENSE
```
