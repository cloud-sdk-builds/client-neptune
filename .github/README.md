...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.835.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.835.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DHDM/T2olVpO14Z8HU6165cGlBzFEiSxeW0RZKFoEod4/cHCbu6YfxwIpoY15bj3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.835.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.835.0/index.min.mjs": "sha384-DHDM/T2olVpO14Z8HU6165cGlBzFEiSxeW0RZKFoEod4/cHCbu6YfxwIpoY15bj3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.835.0/LICENSE
```
