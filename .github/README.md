...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.1017.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1017.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wzpYkdA3uhvtyG9/0cvI4q/qjbuUxVmRM8KsDqeKHqzPEyjJVp0bDO7Ryjk/KS2V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1017.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.1017.0/index.min.mjs": "sha384-wzpYkdA3uhvtyG9/0cvI4q/qjbuUxVmRM8KsDqeKHqzPEyjJVp0bDO7Ryjk/KS2V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.1017.0/LICENSE
```
