...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.806.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.806.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Pp4sxjdTGEPts1+6sz0LiwSIQghfJg7GX3UpTqr3h+Z7U+OUfHKm3j4EKRjcGKbQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.806.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.806.0/index.min.mjs": "sha384-Pp4sxjdTGEPts1+6sz0LiwSIQghfJg7GX3UpTqr3h+Z7U+OUfHKm3j4EKRjcGKbQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.806.0/LICENSE
```
