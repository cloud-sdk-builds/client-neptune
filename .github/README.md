...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.451.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.451.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7eLTcHDlPRVaZfz+y1EIBodJ8qxDjuCBwpY0nVx80hhnIWGglIFD61Bq8RQKyaaJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.451.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.451.0/index.min.mjs": "sha384-7eLTcHDlPRVaZfz+y1EIBodJ8qxDjuCBwpY0nVx80hhnIWGglIFD61Bq8RQKyaaJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.451.0/LICENSE
```
