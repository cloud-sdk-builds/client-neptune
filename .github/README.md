...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.662.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.662.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uW9WGNDNwYfsUtS8nOAjU4QjnCvwpWQrzmt0xAJ7G3QxeGmhn+VZqFXfTC0oimEX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.662.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.662.0/index.min.mjs": "sha384-uW9WGNDNwYfsUtS8nOAjU4QjnCvwpWQrzmt0xAJ7G3QxeGmhn+VZqFXfTC0oimEX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.662.0/LICENSE
```
