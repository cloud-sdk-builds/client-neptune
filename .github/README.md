...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.236.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.236.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8rkJRXCk99tVVjziNT7dpRVNmFPhZgf0fICUq3eaPWi2+W2YK4YCQ45s2JT9DVHJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.236.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.236.0/index.min.mjs": "sha384-8rkJRXCk99tVVjziNT7dpRVNmFPhZgf0fICUq3eaPWi2+W2YK4YCQ45s2JT9DVHJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.236.0/LICENSE
```
