...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.409.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.409.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VbAUtvdHhOo64/1miI3AIlNt2pB5wdGl6V2xEFu2vV/0NdvYcXFHcozKIKUPMMYd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.409.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.409.0/index.min.mjs": "sha384-VbAUtvdHhOo64/1miI3AIlNt2pB5wdGl6V2xEFu2vV/0NdvYcXFHcozKIKUPMMYd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.409.0/LICENSE
```
