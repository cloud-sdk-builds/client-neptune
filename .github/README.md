...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.36.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.36.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Q3QhzNgqMalA/Rvx3PIO+CcLVmDipl5mN/1Ta2Qe3AWHL6m/EURMICKakrFV2V8n
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.36.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.36.0/index.min.mjs": "sha384-Q3QhzNgqMalA/Rvx3PIO+CcLVmDipl5mN/1Ta2Qe3AWHL6m/EURMICKakrFV2V8n"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.36.0/LICENSE
```
