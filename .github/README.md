...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.13.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.13.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-jvUWUbjxZBlPjwSTk9holPB58wsPkLpOS6+/YMvRpEzJw/AynpJ9CfsUgpFYjpqT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.13.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.13.1/index.min.mjs": "sha384-jvUWUbjxZBlPjwSTk9holPB58wsPkLpOS6+/YMvRpEzJw/AynpJ9CfsUgpFYjpqT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.13.1/LICENSE
```
