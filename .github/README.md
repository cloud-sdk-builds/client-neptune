...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.267.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.267.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YARaaU0ry7tkIwx2ke/0mC7+37Z8Uuw5YyeQTi1zHKfejKX4rWWG4U+BPK4lDfrj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.267.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.267.0/index.min.mjs": "sha384-YARaaU0ry7tkIwx2ke/0mC7+37Z8Uuw5YyeQTi1zHKfejKX4rWWG4U+BPK4lDfrj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.267.0/LICENSE
```
