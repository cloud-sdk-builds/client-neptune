...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.325.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.325.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3QT5GNO32an2FX8ntq1d9ib5OnuwVTlIhbK/cndgbXko1Lp298KRjAfnzr4RIvhF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.325.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.325.0/index.min.mjs": "sha384-3QT5GNO32an2FX8ntq1d9ib5OnuwVTlIhbK/cndgbXko1Lp298KRjAfnzr4RIvhF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.325.0/LICENSE
```
