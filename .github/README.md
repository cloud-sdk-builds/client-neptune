...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.895.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.895.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-POPJtT9T60NtByfoKuHS4nwiZlRofHzb9AWIAGEEf/vyLM9m1KcM0Rn0nX7kriNC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.895.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.895.0/index.min.mjs": "sha384-POPJtT9T60NtByfoKuHS4nwiZlRofHzb9AWIAGEEf/vyLM9m1KcM0Rn0nX7kriNC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.895.0/LICENSE
```
