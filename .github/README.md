...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.297.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.297.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7PneXdmNHvAwWfvAehKQIAdI/9uI8Dz9nIvq488vpMRtyeQnNTMBWpU7jEGK9bfA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.297.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.297.0/index.min.mjs": "sha384-7PneXdmNHvAwWfvAehKQIAdI/9uI8Dz9nIvq488vpMRtyeQnNTMBWpU7jEGK9bfA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.297.0/LICENSE
```
