...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.936.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.936.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tp9Pl91DW5Bi3GfV9vUWC1X6e9DWaHG0pETaIL7la/Dwct6zaYvctEFEy1Ef6fbq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.936.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.936.0/index.min.mjs": "sha384-tp9Pl91DW5Bi3GfV9vUWC1X6e9DWaHG0pETaIL7la/Dwct6zaYvctEFEy1Ef6fbq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.936.0/LICENSE
```
