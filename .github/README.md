...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.299.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.299.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aRjQ2m+n7odfv97hZ8+XEnVKsjDEmVS1LAiGotNSFGdJmZh600z2dlXx/GCfx7Pc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.299.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.299.0/index.min.mjs": "sha384-aRjQ2m+n7odfv97hZ8+XEnVKsjDEmVS1LAiGotNSFGdJmZh600z2dlXx/GCfx7Pc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.299.0/LICENSE
```
