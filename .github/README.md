...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.130.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.130.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ju8ncQMqONzG38PonHYerF49tvU7FLGx9NZpaxoxqQRY0u7slAwBLfXggJ8Xx3hz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.130.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.130.0/index.min.mjs": "sha384-Ju8ncQMqONzG38PonHYerF49tvU7FLGx9NZpaxoxqQRY0u7slAwBLfXggJ8Xx3hz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.130.0/LICENSE
```
