...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.235.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.235.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Lcl3m1hzfl7NpOOCfh2SRrQB3OYhcnVS6NeIfBHM6YuqIbfY/ROr53ed6CFj4bjz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.235.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.235.0/index.min.mjs": "sha384-Lcl3m1hzfl7NpOOCfh2SRrQB3OYhcnVS6NeIfBHM6YuqIbfY/ROr53ed6CFj4bjz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.235.0/LICENSE
```
