...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.387.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.387.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fTxoSoP/lYYhOpxp/KPO7YHpT1tHdtMMQvZte9aQJS4u5uphVGoAsoEG8lzd4NH1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.387.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.387.0/index.min.mjs": "sha384-fTxoSoP/lYYhOpxp/KPO7YHpT1tHdtMMQvZte9aQJS4u5uphVGoAsoEG8lzd4NH1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.387.0/LICENSE
```
