...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.501.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.501.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xXFGQYE3kOI+PdCxUjd0H3Xd2Tw0y3bNN3WswTiXswmUezH9c7cep7Sp3vuVwnMG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.501.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.501.0/index.min.mjs": "sha384-xXFGQYE3kOI+PdCxUjd0H3Xd2Tw0y3bNN3WswTiXswmUezH9c7cep7Sp3vuVwnMG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.501.0/LICENSE
```
