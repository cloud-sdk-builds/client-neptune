...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.29.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.29.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HuCTmxqrgU/DJg6AicVUJmVriu+NNu9z1+VaSAf3NIdsn2Q9PHknN2QmgyYjdwyn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.29.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.29.0/index.min.mjs": "sha384-HuCTmxqrgU/DJg6AicVUJmVriu+NNu9z1+VaSAf3NIdsn2Q9PHknN2QmgyYjdwyn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.29.0/LICENSE
```
