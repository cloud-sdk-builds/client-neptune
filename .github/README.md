...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.224.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.224.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9yLy/I2faHivJsc+lDc+39QgoucAvlpINa45nuO29EzxGADnsMb0Xq87Bl39u14P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.224.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.224.0/index.min.mjs": "sha384-9yLy/I2faHivJsc+lDc+39QgoucAvlpINa45nuO29EzxGADnsMb0Xq87Bl39u14P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.224.0/LICENSE
```
