...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.54.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.54.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7l2Sx4pAmaBtm+dnIHFYPDZllZfN08QHemzLKX7NMeOXxoVNp2ktJ2N70YttLuCj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.54.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.54.0/index.min.mjs": "sha384-7l2Sx4pAmaBtm+dnIHFYPDZllZfN08QHemzLKX7NMeOXxoVNp2ktJ2N70YttLuCj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.54.0/LICENSE
```
