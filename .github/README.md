...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.319.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.319.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6rfbojH+jQjrpymcj3Vl0nHcfXmY8nRHluttioaBXc1tLitcDpe3oKfuvu0AC435
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.319.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.319.0/index.min.mjs": "sha384-6rfbojH+jQjrpymcj3Vl0nHcfXmY8nRHluttioaBXc1tLitcDpe3oKfuvu0AC435"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.319.0/LICENSE
```
