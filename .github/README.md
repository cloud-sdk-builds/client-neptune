...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.229.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.229.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w4Wkh2M2MqX3paJ9FwJby2hQkLEOF7+UdfVNEHNU7y3LlnHYwqw3afkU1Em8JY4K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.229.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.229.0/index.min.mjs": "sha384-w4Wkh2M2MqX3paJ9FwJby2hQkLEOF7+UdfVNEHNU7y3LlnHYwqw3afkU1Em8JY4K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.229.0/LICENSE
```
