...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.863.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.863.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-myIzQK2u1kFj2K/w3jQl2QNoc3eIJ/dDcKm9EalcTDLMXKonUQLJAn4+ujFXqjY9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.863.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.863.0/index.min.mjs": "sha384-myIzQK2u1kFj2K/w3jQl2QNoc3eIJ/dDcKm9EalcTDLMXKonUQLJAn4+ujFXqjY9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.863.0/LICENSE
```
