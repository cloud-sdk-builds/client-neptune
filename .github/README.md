...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.577.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.577.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5xUGOOowghBm6jg1oIZ6VLRr6spV+IKPCdGmI9M5Ks4Ozh4npAJoqgn5FyZWbSic
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.577.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.577.0/index.min.mjs": "sha384-5xUGOOowghBm6jg1oIZ6VLRr6spV+IKPCdGmI9M5Ks4Ozh4npAJoqgn5FyZWbSic"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.577.0/LICENSE
```
