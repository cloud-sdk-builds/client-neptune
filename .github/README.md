...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.731.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.731.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wzrnpYgxQT8jwpQ70r5k/18RCqrDlxMM8WjCA5deq8TFGO7TquXov9bQBStdOTe4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.731.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.731.0/index.min.mjs": "sha384-wzrnpYgxQT8jwpQ70r5k/18RCqrDlxMM8WjCA5deq8TFGO7TquXov9bQBStdOTe4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.731.0/LICENSE
```
