...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.823.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.823.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mKprRF9tRiYLxZRMkdURxIIySQDq4bUjqLMD/fah2eLzc4mcoCQp5TZxM9S3NMSf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.823.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.823.0/index.min.mjs": "sha384-mKprRF9tRiYLxZRMkdURxIIySQDq4bUjqLMD/fah2eLzc4mcoCQp5TZxM9S3NMSf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.823.0/LICENSE
```
