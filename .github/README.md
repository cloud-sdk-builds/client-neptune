...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.515.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.515.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B8Y+E6vbInEqoNyr/fR5JhV0TSEm25GND9NMNixYoMpk4AawoE0FlXxs+ffVxsYT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.515.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.515.0/index.min.mjs": "sha384-B8Y+E6vbInEqoNyr/fR5JhV0TSEm25GND9NMNixYoMpk4AawoE0FlXxs+ffVxsYT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.515.0/LICENSE
```
