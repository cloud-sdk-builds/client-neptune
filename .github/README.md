...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.428.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.428.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qiMXEgexy+ADjJyXpgRdnftWK2R4/r57Glln/uXjK5mG0jHZHAtRA3Gg9gRXvDzY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.428.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.428.0/index.min.mjs": "sha384-qiMXEgexy+ADjJyXpgRdnftWK2R4/r57Glln/uXjK5mG0jHZHAtRA3Gg9gRXvDzY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.428.0/LICENSE
```
