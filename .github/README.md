...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.259.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.259.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XLjx7B+LOzJtCONvTyafvXsRXciS2T31Ir/q2M04A4h9TKz6cwjHkiZu/MDu0AN1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.259.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.259.0/index.min.mjs": "sha384-XLjx7B+LOzJtCONvTyafvXsRXciS2T31Ir/q2M04A4h9TKz6cwjHkiZu/MDu0AN1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.259.0/LICENSE
```
