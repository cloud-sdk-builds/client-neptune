...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.470.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.470.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OlKk02fQQjsijNRI6Gd18R99P4MLcfYOwKMevHorIm1rPwa+V/P4NqFRowRK67S0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.470.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.470.0/index.min.mjs": "sha384-OlKk02fQQjsijNRI6Gd18R99P4MLcfYOwKMevHorIm1rPwa+V/P4NqFRowRK67S0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.470.0/LICENSE
```
