...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.525.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.525.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SMHEdlhzsHIm+IocJuKEZMAWX+1ndx2GEsRuZvA0xmyfP7Gy8MVi7hItYaJBBk32
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.525.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.525.0/index.min.mjs": "sha384-SMHEdlhzsHIm+IocJuKEZMAWX+1ndx2GEsRuZvA0xmyfP7Gy8MVi7hItYaJBBk32"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.525.0/LICENSE
```
