...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.213.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.213.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/jcM7+cGSC9BEq2ZKSogyxWKLCnK0F9sCQHCJAeRmCjJiOU54+cpUxU3UKMMBs0s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.213.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.213.0/index.min.mjs": "sha384-/jcM7+cGSC9BEq2ZKSogyxWKLCnK0F9sCQHCJAeRmCjJiOU54+cpUxU3UKMMBs0s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.213.0/LICENSE
```
