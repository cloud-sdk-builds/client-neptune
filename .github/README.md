...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.890.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.890.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u9LjYP4U7Gv5DlcXAs6KR2v1M3WIFoyk5tzAzDmlXs0hdjpQS4onUMu09XXTeWk6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.890.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.890.0/index.min.mjs": "sha384-u9LjYP4U7Gv5DlcXAs6KR2v1M3WIFoyk5tzAzDmlXs0hdjpQS4onUMu09XXTeWk6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.890.0/LICENSE
```
