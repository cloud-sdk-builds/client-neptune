...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.614.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.614.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Lnf77CJBmmcVr9AtqzaB96G/w2e9KU8d9C+FKSMdTA8G2fx4fPV99yBnh0FYQxgc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.614.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.614.0/index.min.mjs": "sha384-Lnf77CJBmmcVr9AtqzaB96G/w2e9KU8d9C+FKSMdTA8G2fx4fPV99yBnh0FYQxgc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.614.0/LICENSE
```
