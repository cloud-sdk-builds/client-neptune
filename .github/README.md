...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.208.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.208.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Fhc2GSzbMq3n6+yStsYKdjrGaIqg66oqbhSM+MGydLCwHUZvFMXW6ZrhwVub+e3X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.208.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.208.0/index.min.mjs": "sha384-Fhc2GSzbMq3n6+yStsYKdjrGaIqg66oqbhSM+MGydLCwHUZvFMXW6ZrhwVub+e3X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.208.0/LICENSE
```
