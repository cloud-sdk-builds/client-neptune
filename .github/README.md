...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.810.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.810.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0bEHKSmNkSHCIKL7X5UOHHUxBpA5ZaaBJZxU/Fw+B0VlBUIswXaTRiYHtZ0hdZmo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.810.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.810.0/index.min.mjs": "sha384-0bEHKSmNkSHCIKL7X5UOHHUxBpA5ZaaBJZxU/Fw+B0VlBUIswXaTRiYHtZ0hdZmo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.810.0/LICENSE
```
