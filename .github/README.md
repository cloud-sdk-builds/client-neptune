...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.72.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.72.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cpeB7szuEjkKPEOfgsE7UERz0hSbu4BjFvcAgJtHWtAUC5tPYI/k4x8/GH6PHXgP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.72.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.72.0/index.min.mjs": "sha384-cpeB7szuEjkKPEOfgsE7UERz0hSbu4BjFvcAgJtHWtAUC5tPYI/k4x8/GH6PHXgP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.72.0/LICENSE
```
