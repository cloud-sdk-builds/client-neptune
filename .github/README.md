...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.2.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.2.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qwNa0YouPwcnEZQ5409mbUSBapAKczRFVGwWwiOhB3LQUVmgrA1mXXP9Cuaa/0Qo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.2.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.2.0/index.min.mjs": "sha384-qwNa0YouPwcnEZQ5409mbUSBapAKczRFVGwWwiOhB3LQUVmgrA1mXXP9Cuaa/0Qo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.2.0/LICENSE
```
