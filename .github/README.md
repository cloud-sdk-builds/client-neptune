...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.971.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.971.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-plWxrvNldBH9p2G/xBoAikzoLNOzbirhCYwLGJ90L/Wh7DiD/NsRMuF/i6hBQIiO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.971.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.971.0/index.min.mjs": "sha384-plWxrvNldBH9p2G/xBoAikzoLNOzbirhCYwLGJ90L/Wh7DiD/NsRMuF/i6hBQIiO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.971.0/LICENSE
```
