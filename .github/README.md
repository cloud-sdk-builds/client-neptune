...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rpzQVmfCDN0TNUQ1PAvzqxHbUBvTJzXmZxet3PfcgbcWmKOlmkA376hFTT5nQqnV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.882.0/index.min.mjs": "sha384-rpzQVmfCDN0TNUQ1PAvzqxHbUBvTJzXmZxet3PfcgbcWmKOlmkA376hFTT5nQqnV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.882.0/LICENSE
```
