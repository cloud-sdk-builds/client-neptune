...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.142.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.142.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KWV3jkZRpLJwHA+v7xwH3ggPICrRKLwcwIhfQwoSzfQ3pH76oGx3oDTuF2ERauKO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.142.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.142.0/index.min.mjs": "sha384-KWV3jkZRpLJwHA+v7xwH3ggPICrRKLwcwIhfQwoSzfQ3pH76oGx3oDTuF2ERauKO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.142.0/LICENSE
```
