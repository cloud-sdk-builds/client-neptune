...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.613.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.613.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hXzJ580BnHemnaEr3Nvg3O+XbX+sPFe6VGjvlaXdeOiR3pHPFXlmQhv/6VpJEoKh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.613.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.613.0/index.min.mjs": "sha384-hXzJ580BnHemnaEr3Nvg3O+XbX+sPFe6VGjvlaXdeOiR3pHPFXlmQhv/6VpJEoKh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.613.0/LICENSE
```
