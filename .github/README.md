...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.468.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.468.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tzb99IvHMp9gsO4xIMkNDKjHz+rL+BLPwQPDMRzF6qvTBZEoMNq8Zu1kBv7QIcpZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.468.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.468.0/index.min.mjs": "sha384-tzb99IvHMp9gsO4xIMkNDKjHz+rL+BLPwQPDMRzF6qvTBZEoMNq8Zu1kBv7QIcpZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.468.0/LICENSE
```
