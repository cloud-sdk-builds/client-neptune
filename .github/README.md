...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.118.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.118.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Cq82CAqdEDifbo+TZlZW7ukutNfQz2ZAwSa3JvqYrJTomdGzweFNxwmyQAa/hT+K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.118.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.118.1/index.min.mjs": "sha384-Cq82CAqdEDifbo+TZlZW7ukutNfQz2ZAwSa3JvqYrJTomdGzweFNxwmyQAa/hT+K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.118.1/LICENSE
```
