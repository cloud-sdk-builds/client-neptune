...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.201.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.201.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YHso2tcCiD+FaoxS6pzfyEjbI5AMIfIJK0LQoJlwNLFPv8bjSp+6Kv+qMMis8mMQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.201.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.201.0/index.min.mjs": "sha384-YHso2tcCiD+FaoxS6pzfyEjbI5AMIfIJK0LQoJlwNLFPv8bjSp+6Kv+qMMis8mMQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.201.0/LICENSE
```
