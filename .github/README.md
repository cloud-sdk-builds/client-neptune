...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.53.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.53.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-myH4hxgcbehuRfkH/+RjiG0NFLCx9TysCM0pPFj5hfgb1mpS8N7fdhZ95PxQaKB9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.53.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.53.0/index.min.mjs": "sha384-myH4hxgcbehuRfkH/+RjiG0NFLCx9TysCM0pPFj5hfgb1mpS8N7fdhZ95PxQaKB9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.53.0/LICENSE
```
