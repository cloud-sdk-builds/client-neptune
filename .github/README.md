...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.288.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.288.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-adtPOzf+HKEnodLMqLViSAEtvEeQnCcd8pTF8zX9ixZesPYST/BSCNUq3GavhuXG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.288.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.288.0/index.min.mjs": "sha384-adtPOzf+HKEnodLMqLViSAEtvEeQnCcd8pTF8zX9ixZesPYST/BSCNUq3GavhuXG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.288.0/LICENSE
```
