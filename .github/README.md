...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.574.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.574.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a4w/HWtJtjqNEtm1EQ+fuyK0+bSIQVGUL67FX4pb0+BmaruwY2iZ8q9VCx62fj+c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.574.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.574.0/index.min.mjs": "sha384-a4w/HWtJtjqNEtm1EQ+fuyK0+bSIQVGUL67FX4pb0+BmaruwY2iZ8q9VCx62fj+c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.574.0/LICENSE
```
