...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.679.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.679.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M776Whxe1o3fokj68QKk5L+ckSAi5b9O9kVGwLsnHamBnmPd6eoLf8Ld9RuGUiOJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.679.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.679.0/index.min.mjs": "sha384-M776Whxe1o3fokj68QKk5L+ckSAi5b9O9kVGwLsnHamBnmPd6eoLf8Ld9RuGUiOJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.679.0/LICENSE
```
