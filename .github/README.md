...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.385.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.385.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Dvk4MZt7x1NjCgiDG6JNSE2DQzegHCIPBulX6sag531OEAu+hURUPaZScsBK8oyc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.385.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.385.0/index.min.mjs": "sha384-Dvk4MZt7x1NjCgiDG6JNSE2DQzegHCIPBulX6sag531OEAu+hURUPaZScsBK8oyc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.385.0/LICENSE
```
