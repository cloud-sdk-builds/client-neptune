...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.350.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.350.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Tqk5+jUIFGI0VUfQicVyLlzi6JV83FH0WxEdR/X1S+kNnShD4H128RjdHe/xgGIX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.350.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.350.0/index.min.mjs": "sha384-Tqk5+jUIFGI0VUfQicVyLlzi6JV83FH0WxEdR/X1S+kNnShD4H128RjdHe/xgGIX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.350.0/LICENSE
```
