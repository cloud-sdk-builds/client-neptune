...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.965.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.965.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jK74i8pYOtE8uThmRJTyNQ2Ok6tAWRZZbzewl9dy8dNfwceLg/QyFZErtdRuMd7m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.965.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.965.0/index.min.mjs": "sha384-jK74i8pYOtE8uThmRJTyNQ2Ok6tAWRZZbzewl9dy8dNfwceLg/QyFZErtdRuMd7m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.965.0/LICENSE
```
