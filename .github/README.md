...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.171.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.171.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bnal+Wqx/DqLCQASlrbY68rsgSXLgCPa3ScNr5/FZGn7+8O4342UFYoj2MdCc+3r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.171.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.171.0/index.min.mjs": "sha384-bnal+Wqx/DqLCQASlrbY68rsgSXLgCPa3ScNr5/FZGn7+8O4342UFYoj2MdCc+3r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.171.0/LICENSE
```
