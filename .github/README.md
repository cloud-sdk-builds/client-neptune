...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.8.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.8.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R65PdP4TbWAspHHY4t9ZqAsbffHzKHnPpvJgaioUaLXHsAg5g/w2jmiZ27D+P2Ki
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.8.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.8.0/index.min.mjs": "sha384-R65PdP4TbWAspHHY4t9ZqAsbffHzKHnPpvJgaioUaLXHsAg5g/w2jmiZ27D+P2Ki"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.8.0/LICENSE
```
