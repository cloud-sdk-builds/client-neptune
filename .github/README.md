...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.922.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.922.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uEFt1FSXTLmvZMgsGVSTbkFEcX31dVChkdX0Et9sDRDxzDVpGrBt0ZmO5WFLiqyP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.922.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.922.0/index.min.mjs": "sha384-uEFt1FSXTLmvZMgsGVSTbkFEcX31dVChkdX0Et9sDRDxzDVpGrBt0ZmO5WFLiqyP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.922.0/LICENSE
```
