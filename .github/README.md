...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.600.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.600.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xyUtuSuE6GGHo4syjDwBRaOJDsjAg5ePJqV+XRuN+a/SN+f7QMvazH+tYIf+pFnR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.600.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.600.0/index.min.mjs": "sha384-xyUtuSuE6GGHo4syjDwBRaOJDsjAg5ePJqV+XRuN+a/SN+f7QMvazH+tYIf+pFnR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.600.0/LICENSE
```
