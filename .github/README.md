...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.572.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.572.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bKZO/6Cf1dDuTR58+cjLMuooXZakjVVm2MZRgIOYLaI97rmbDmTu0OqeR74r313M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.572.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.572.0/index.min.mjs": "sha384-bKZO/6Cf1dDuTR58+cjLMuooXZakjVVm2MZRgIOYLaI97rmbDmTu0OqeR74r313M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.572.0/LICENSE
```
