...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.181.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.181.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Mbj/iStHSaD3mk84ZGxfrCM+9cw0JEmMMFNqwMrUrdrKC8JRNyL53sWFEoMxrlUr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.181.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.181.0/index.min.mjs": "sha384-Mbj/iStHSaD3mk84ZGxfrCM+9cw0JEmMMFNqwMrUrdrKC8JRNyL53sWFEoMxrlUr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.181.0/LICENSE
```
