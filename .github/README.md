...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.821.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.821.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lpc1TobqWV2RxmwY1gGqyoJvCTGK7ahQBIQPT0Wvb1/Y5spoUiYsnboickSydNsg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.821.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.821.0/index.min.mjs": "sha384-lpc1TobqWV2RxmwY1gGqyoJvCTGK7ahQBIQPT0Wvb1/Y5spoUiYsnboickSydNsg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.821.0/LICENSE
```
