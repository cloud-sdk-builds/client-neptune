...
[`@aws-sdk/client-neptune`](https://www.npmjs.com/package/@aws-sdk/client-neptune/v/3.999.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.999.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+oXjcc+J1C7dewyo+gvOULB3twkttZV0gsLhEzDWTaCymQMNYd4Vq8OG9I2WURvh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-neptune": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.999.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-neptune@3.999.0/index.min.mjs": "sha384-+oXjcc+J1C7dewyo+gvOULB3twkttZV0gsLhEzDWTaCymQMNYd4Vq8OG9I2WURvh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-neptune/blob/refs/tags/3.999.0/LICENSE
```
